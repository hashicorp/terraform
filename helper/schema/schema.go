...
type Schema struct {
	...
	// a proper set can be built. It should take into account all properties
	// inside the set - changes in properties not included in the hash will not
	// be detected.
	//
	// NOTE: This should only be used for backwards compatibility.
