	...
	for _, file := range files {
		if strings.Contains(file.Name(), "terraform_0.12.0-bundle") {
			...
			expectedFiles := map[string]struct{}{
				"terraform":                                   struct{}{},
				testProviderBinaryPath("null", "2.1.0"):       struct{}{},
				testProviderBinaryPath("aws", "2.26.0"):       struct{}{},
				testProviderBinaryPath("kubernetes", "1.8.0"): struct{}{},
				testProviderBinaryPath("kubernetes", "1.8.1"): struct{}{},
				testProviderBinaryPath("kubernetes", "1.9.0"): struct{}{},
			}
