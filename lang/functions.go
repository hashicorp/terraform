...
func (s *Scope) Functions() map[string]function.Function {
	...
	if s.funcs == nil {
		...
		s.funcs = map[string]function.Function{
			...
			"base64sha384":     funcs.Base64Sha384Func,
			...
			"filebase64sha384": funcs.MakeFileBase64Sha384Func(s.BaseDir),
			...
			"filesha384":       funcs.MakeFileSha384Func(s.BaseDir),
