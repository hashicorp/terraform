 ...
 * **New Resource:** `azurerm_traffic_manager_endpoint` [GH-7826]
 * **New Resource:** `azurerm_traffic_manager_profile` [GH-7826]
 ...
 * provider/azurerm: Wait for `azurerm_storage_account` to be available [GH-7329]
