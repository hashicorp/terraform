...
When working as a team, you should follow these best practices:
...
1. **Branch Naming Conventions**:
   ...
   - Examples:
     ...
     - `fix/ec2-instance-tagging`
     - `docs/update-core-workflow`
     - `refactor/terraform-state-backend`
...
2. **Commit Message Guidelines**:
   ...
   - Examples:
     ...
     fix: correct EC2 instance tagging logic
     docs: update core workflow best practices
     ```

3. **Code Review Process**:

   - Create pull requests with clear descriptions
   - Include relevant context and testing steps
...
These practices help maintain code quality, improve collaboration, and ensure infrastructure stability.
