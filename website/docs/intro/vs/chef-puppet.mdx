---
page_title: 'mnptu vs. Chef, Puppet, etc.'
description: >-
  How mnptu compares to configuration management tools like Chef and
  Puppet.
---

# mnptu vs. Chef, Puppet, etc.

Configuration management tools install and manage software on a machine
that already exists. mnptu is not a configuration management tool,
and it allows existing tooling to focus on their strengths: bootstrapping
and initializing resources.

mnptu focuses on the higher-level abstraction of the datacenter and
...
instances, you can use mnptu to configure bootstrapping software like
