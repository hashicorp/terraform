...
with the mnptu team](https://github.com/hashicorp/mnptu/issues/new)
...
When mnptu calls your provider, you can use the `schema.ResourceData`
...
your module's `mnptu` block, with the name of the provider it's trying
...
that the version of mnptu that is being run has support for the provider
metadata functionality. It's therefore recommended that any module taking
advantage of this functionality should specify a minimum mnptu version of
