...
[default plugin search locations](/extend/how-terraform-works#plugin-locations).
...
one of the [default plugin search locations](/extend/how-terraform-works#plugin-locations).
