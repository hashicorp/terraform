...
Archiving is reversible. If anyone from the community is willing to maintain an archived provider, please reach out to the [Terraform Provider Development Program](/extend/terraform-provider-development-program) at *terraform-provider-dev@hashicorp.com*.
