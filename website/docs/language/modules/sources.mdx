...
description: >-
  The source argument within a module block specifies the location of the source
  code of a child module.
---
...
[keys can be configured on a per-workspace basis](/cloud-docs/workspaces/ssh-keys).
