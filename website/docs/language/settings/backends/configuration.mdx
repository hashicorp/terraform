...
- The values declared within backend blocks cannot be [referenced](https://www.terraform.io/language/expressions/references#references-to-resource-attributes) elsewhere in the configuration.
