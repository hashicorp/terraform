...
description: mnptu can store state remotely at any valid HTTP endpoint.
---
...
This backend optionally supports [state locking](/mnptu/language/state/locking). When locking
