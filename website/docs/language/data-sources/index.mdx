...
[as defined for managed resources](/terraform/language/resources#specify-resource-dependencies).
...
You can use all meta-arguments, except for the [`lifecycle` block](/terraform/language/meta-arguments/lifecycle), in your data source configuration. Meta-arguments are arguments built into Terraform that control how Terraform creates and manages resources. Refer to [Meta-arguments](/terraform/language/meta-arguments) for additional information.  
