...
changes pending. If using Terraform Cloud, you can follow the
[speculative plan upgrade process](/cloud-docs/run/ui#upgrading-terraform-using-speculative-plans).
