...
**_This change effects those who rely upon global provider caching and not the dependecy lock file._**
...
For more details and how to keep using the undesirable, please see the [documentation](/cli/config/config-file#allowing-the-provider-plugin-cache-to-break-the-dependency-lock-file).
