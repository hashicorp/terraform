...
To run the `terraform-stacks-cli` you must have an `alpha` version of Terraform installed on your machine. You can download the `alpha` version of Terraform from the [Terraform releases page](https://releases.hashicorp.com/terraform/).
