...
The `terraform-stacks-cli` requires an `alpha` version of Terraform to run. You must use at least `terraform_1.10.0-alpha20241009` or higher. You can download  `alpha` versions of Terraform on the [Terraform releases page](https://releases.hashicorp.com/terraform/).
