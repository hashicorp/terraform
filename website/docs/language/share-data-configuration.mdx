---
page_title: Share data across configurations
description: >-
...
PLACEHOLDER: I removed the state section completely. I think like resources and providers, this should be a dedicated concepts section within the `/intro` section of the docs... since it applies to Terraform as a whole rather than specifically to writing Terraform configuration.
