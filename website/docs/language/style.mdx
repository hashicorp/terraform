...
We recommend the following file naming conventions for organizing your Terraform configuration files. Each file contains specific types of blocks and configurations:
