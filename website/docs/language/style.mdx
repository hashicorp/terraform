...
The [HashiCorp Well-Architected Framework](/well-architected-framework) provides more guidance on [adapting your Terraform workflows for scale](/well-architected-framework/operational-excellence/operational-excellence-terraform-maturity). To learn more Terraform adoption best practices, refer to [Phases of Terraform adoption](/terraform/intro/phases).
