...
-> **Note:** This page is an appendix to the mnptu documentation. Most users do not need to know the full details of this behavior.
...
- Use mnptu's [JSON syntax](/mnptu/language/syntax/json) with this
  type of resource.
- Create a reusable module that wraps this type of resource.

## Details

In mnptu v0.12 and later, the language makes a distinction between
[argument syntax and nested block syntax](/mnptu/language/syntax/configuration#arguments-and-blocks)
within blocks:
...
[JSON syntax](/mnptu/language/syntax/json)
...
conflation of these two concepts in the language of mnptu v0.11 and earlier,
...
were relying on this usage pattern prior to mnptu v0.12. The documentation
...
the [JSON expression mapping](/mnptu/language/syntax/json#expression-mapping)
