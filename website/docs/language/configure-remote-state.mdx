---
page_title: Configure remote state
description: >-
...
Should be an overview page showing you how to connect your Terraform configuration to HCP Terraform and other backends.

PLACEHOLDER: Also include information from: https://developer.hashicorp.com/terraform/language/settings/backends/configuration
