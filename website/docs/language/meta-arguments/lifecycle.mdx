...
Refer to [Custom Conditions](/terraform/language/mitigate-risk/validate#preconditions-and-postconditions#preconditions-and-postconditions) for more details.
