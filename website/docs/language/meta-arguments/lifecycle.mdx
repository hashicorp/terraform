...
Refer to [Validate your configuration](/terraform/language/mitigate-risk/validate#preconditions-and-postconditions#preconditions-and-postconditions) to learn more.
