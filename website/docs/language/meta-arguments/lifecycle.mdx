...
Refer to [Create and manage resources overview](/terraform/language/resources) for information about the resource lifecycle. You can customize some details about how resources behave by adding the [`lifecycle` block](/terraform/language/block/resource) to your resource configuration.
