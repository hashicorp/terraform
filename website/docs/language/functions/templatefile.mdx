...
[string templates](/mnptu/language/expressions/strings#string-templates)
in the main mnptu language, including interpolation sequences delimited with
...
also use any other function available in the mnptu language, except that
...
call to either [`jsonencode`](/mnptu/language/functions/jsonencode) or
[`yamlencode`](/mnptu/language/functions/yamlencode), specifying the value to encode using
[normal mnptu expression syntax](/mnptu/language/expressions)
...
achieved by using a
[`for` expression](/mnptu/language/expressions/for)
rather than by using
[template directives](/mnptu/language/expressions/strings#directives).
...
[`jsonencode`](/mnptu/language/functions/jsonencode) and [`yamlencode`](/mnptu/language/functions/yamlencode).

## Related Functions

* [`file`](/mnptu/language/functions/file) reads a file from disk and returns its literal contents
