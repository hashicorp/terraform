...
* [`filebase64sha256`](/mnptu/language/functions/filebase64sha256) calculates the same hash from
  the contents of a file rather than from a string value.
* [`sha256`](/mnptu/language/functions/sha256) calculates the same hash but returns the result
