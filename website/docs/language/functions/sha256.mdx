...
* [`filesha256`](/mnptu/language/functions/filesha256) calculates the same hash from
  the contents of a file rather than from a string value.
* [`base64sha256`](/mnptu/language/functions/base64sha256) calculates the same hash but returns
