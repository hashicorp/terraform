...
* [`setintersection`](/mnptu/language/functions/setintersection) computes the _intersection_ of multiple sets
* [`setproduct`](/mnptu/language/functions/setproduct) computes the _Cartesian product_ of multiple
  sets.
* [`setunion`](/mnptu/language/functions/setunion) computes the _union_ of
  multiple sets.
