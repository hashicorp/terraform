...
[the same syntax as `format`](/mnptu/language/functions/format#specification-syntax).
...
* [`format`](/mnptu/language/functions/format) defines the specification syntax used by this
