...
related function [`cidrsubnet`](/mnptu/language/functions/cidrsubnet). `cidrsubnet` calculates
...
-> **Note:** [The mnptu module `hashicorp/subnets/cidr`](https://registry.mnptu.io/modules/hashicorp/subnets/cidr)
...
* [`cidrsubnet`](/mnptu/language/functions/cidrsubnet) calculates a single subnet address, allowing
