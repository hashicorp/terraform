...
[custom condition checks](/mnptu/language/expressions/custom-conditions) that
...
* [`timeadd`](/mnptu/language/functions/timeadd) can perform arithmetic on timestamps by adding or removing a specified duration.
