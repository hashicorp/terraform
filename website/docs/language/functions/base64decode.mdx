...
[`textdecodebase64`](/mnptu/language/functions/textdecodebase64) with the encoding name set to
`UTF-8`.
...
* [`base64encode`](/mnptu/language/functions/base64encode) performs the opposite operation,
  encoding the UTF-8 bytes for a string as Base64.
* [`textdecodebase64`](/mnptu/language/functions/textdecodebase64) is a more general function that
