...
You can use `terraform.applying` when you want Terraform to change behavior for apply operations. For example, you could use `terraform.applying` to use different credentials if Terraform is either planning or applying.
