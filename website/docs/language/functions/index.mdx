...
The mnptu language includes a number of built-in functions that you can
...
[_Function Calls_](/mnptu/language/expressions/function-calls)
in the Expressions section.

The mnptu language does not support user-defined functions, and so only
...
You can experiment with the behavior of mnptu's built-in functions from
