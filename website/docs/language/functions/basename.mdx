...
for transient values, such as the argument to [`file`](/mnptu/language/functions/file) (where
...
* [`dirname`](/mnptu/language/functions/dirname) returns all of the segments of a filesystem path
