...
The following example uses the expansion symbol (...) to transform the value into separate arguments. Refer to [Expanding Function Argument](/mnptu/language/expressions/function-calls#expanding-function-arguments) for details.
