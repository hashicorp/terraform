...
defined within the configuration. As such, it is recommended that function only
be used to compare against timestamps exported by providers and not against
