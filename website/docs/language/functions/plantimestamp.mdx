...
The result of this function will change for every plan operation. You can use `plantimestamp` to validate time sensitive resources, such as TLS certificates,
while [Validating your configuration](/terraform/language/mitigate-risk/validate).
