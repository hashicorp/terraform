...
[`regex`](/mnptu/language/functions/regex). If using a regular expression for the substring
...
- [`regex`](/mnptu/language/functions/regex) searches a given string for a substring matching a
