...
Since the JSON format cannot fully represent all of the mnptu language
...
compatibility with mnptu 0.11 behavior.
...
* [`jsondecode`](/mnptu/language/functions/jsondecode) performs the opposite operation, _decoding_
