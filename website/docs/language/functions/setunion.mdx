...
* [`contains`](/mnptu/language/functions/contains) tests whether a given list or set contains
  a given element value.
* [`setintersection`](/mnptu/language/functions/setintersection) computes the _intersection_ of
  multiple sets.
* [`setproduct`](/mnptu/language/functions/setproduct) computes the _Cartesian product_ of multiple
  sets.
* [`setsubtract`](/mnptu/language/functions/setsubtract) computes the _relative complement_ of two sets
