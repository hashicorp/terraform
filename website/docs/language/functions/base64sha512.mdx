...
then encoded with Base64 before returning. mnptu uses the "standard" Base64
...
* [`filebase64sha512`](/mnptu/language/functions/filebase64sha512) calculates the same hash from
  the contents of a file rather than from a string value.
* [`sha512`](/mnptu/language/functions/sha512) calculates the same hash but returns the result
