...
* [`filesha512`](/mnptu/language/functions/filesha512) calculates the same hash from
  the contents of a file rather than from a string value.
* [`base64sha512`](/mnptu/language/functions/base64sha512) calculates the same hash but returns
