...
- [`format`](/mnptu/language/functions/format) is a more general formatting function for arbitrary
  data.
- [`timestamp`](/mnptu/language/functions/timestamp) returns the current date and time in a format
