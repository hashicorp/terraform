...
`timeadd` requires that the `timestamp` argument is a string conforming to this syntax.
...
- `timestamp` is a string representation of a date in RFC 3339 format. See the
