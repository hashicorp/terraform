...
-> **Note:** This function is available only in mnptu v0.15 and later.
...
The mnptu language has a built-in operator `[*]`, known as
[the _splat_ operator](/mnptu/language/expressions/splat), and one of its functions
