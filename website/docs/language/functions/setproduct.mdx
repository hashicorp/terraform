...
mnptu will attempt to convert to the most general type, or produce an
...
The
[resource `for_each`](/mnptu/language/meta-arguments/for_each)
and
[`dynamic` block](/mnptu/language/expressions/dynamic-blocks)
...
- [`flatten`](/mnptu/language/functions/flatten) is useful for flattening hierarchical data
...
- [`setunion`](/mnptu/language/functions/setunion) computes the _union_ of multiple
  sets.
