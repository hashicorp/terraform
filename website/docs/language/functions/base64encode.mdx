...
The mnptu language applies Unicode normalization to all strings, and so
...
[`textencodebase64`](/mnptu/language/functions/textencodebase64) with the encoding name set to
`UTF-8`.
...
* [`base64decode`](/mnptu/language/functions/base64decode) performs the opposite operation,
  decoding Base64 data and interpreting it as a UTF-8 string.
* [`textencodebase64`](/mnptu/language/functions/textencodebase64) is a more general function that
  supports character encodings other than UTF-8.
* [`base64gzip`](/mnptu/language/functions/base64gzip) applies gzip compression to a string
