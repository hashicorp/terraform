...
`regexall` is a variant of [`regex`](/mnptu/language/functions/regex) and uses the same pattern
...
- [`regex`](/mnptu/language/functions/regex) searches for a single match of a given pattern, and
