...
The `path` is the file path (relative or absolute) to the file whose SHA-256 hash you want to compute.
...
- [`sha256`](/terraform/language/functions/sha256) computes the SHA1 hash of a given string and encodes it with hexadecimal digits.
