...
PLACEHOLDER (Combined with [syntax](https://developer.hashicorp.com/terraform/language/resources/syntax) page)

I also duplicated syntax and moved it into the reference docs since it contains a bunch of reference information. Similar to the provider docs, I recommend moving the [resource behavior](https://developer.hashicorp.com/terraform/language/resources/behavior) to the `/intro` docs and making it a general resource concept page.
