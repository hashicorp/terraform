...
sidebar_title: References to Values
...
If you use [`dynamic` blocks](dynamic-blocks) to dynamically generate
...
Terraform will still record sensitive values in the [state](/language/state/index),
