...
description: >-
  Learn recommended formatting conventions for the mnptu language and a
  command to automatically enforce them.
---

# Style Conventions

The mnptu parser allows you some flexibility in how you lay out the
elements in your configuration files, but the mnptu language also has some
...
-> **Note**: You can enforce these conventions automatically by running [`mnptu fmt`](/mnptu/cli/commands/fmt).
...
* For blocks that contain both arguments and "meta-arguments" (as defined by
  the mnptu language semantics), list meta-arguments first
