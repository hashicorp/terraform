...
* [`variable`](/language/values/variables.html#declaring-an-input-variable),
  [`output`](/language/values/outputs.html#declaring-an-output-value), and
  [`locals`](/language/values/locals.html#declaring-a-local-value) blocks
  for declaring the various kinds of named values in a module.
* [`terraform`](/language/settings/) blocks, including the nested
  [`required_version`](/language/settings/index.html#specifying-a-required-terraform-version)
  and
  [`required_providers`](/language/providers/requirements.html#requiring-providers)
  arguments, and nested
  [`backend`](/language/settings/backends/configuration.html#using-a-backend-block)
...
references to
[`terraform.workspace`](/language/expressions/references.html#terraform-workspace),
...
[local filesystem directories](/cli/config/config-file.html#filesystem_mirror)
(filesystem mirrors) and from
[network mirrors](/cli/config/config-file.html#network_mirror)
...
methods, including
[the Implied Local Mirror Directories](/cli/config/config-file.html#implied-local-mirror-directories).
