...
-> Ephemeral variables, outputs, and resources are in public beta and available in Terraform v1.1.0 and later. The workflows of ephemeral values are subject to change.
