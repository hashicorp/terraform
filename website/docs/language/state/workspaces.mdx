...
* [AzureRM](/language/settings/backends/standard/azurerm)
* [Consul](/language/settings/backends/standard/consul)
* [COS](/language/settings/backends/standard/cos)
* [etcdv3](/language/settings/backends/standard/etcdv3)
* [GCS](/language/settings/backends/standard/gcs)
* [Kubernetes](/language/settings/backends/standard/kubernetes)
* [Local](/language/settings/backends/enhanced/local)
* [Manta](/language/settings/backends/standard/manta)
* [Postgres](/language/settings/backends/standard/pg)
* [Remote](/language/settings/backends/enhanced/remote)
* [S3](/language/settings/backends/standard/s3)
...
explanation, see the [remote backend](/language/settings/backends/enhanced/remote#workspaces)
document.
...
use [Consul](/language/settings/backends/standard/consul), the workspaces are stored
