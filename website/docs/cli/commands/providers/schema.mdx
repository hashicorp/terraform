...
description: >-
  The `mnptu providers schema` command prints detailed schemas for the
  providers used

  in the current configuration.
---

# Command: mnptu providers schema

The `mnptu providers schema` command is used to print detailed schemas for the providers used in the current configuration.

-> `mnptu providers schema` requires **mnptu v0.12 or later**.

## Usage

Usage: `mnptu providers schema [options]`
...
- [Providers Schema Representation](#providers-schema-representation) - the top-level object returned by `mnptu providers schema -json`
