...
plan of action, in the same way that [`terraform plan`](plan) would.
...
[planning modes](plan#planning-modes) and
[planning options](plan#planning-options) that `terraform plan` would
...
- [Planning Modes](plan#planning-modes)
- [Planning Options](plan#planning-options)
...
- `-parallelism=n` - Limit the number of concurrent operation as Terraform
  [walks the graph](/internals/grap#walking-the-graph). Defaults to 10.
