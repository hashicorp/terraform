...
The Terraform `test` command also executes any validations within your configuration as part of the tests it executes. For more information on the available validation, refer to [Validate your configuration](/terraform/language/mitigate-risk/validate).
