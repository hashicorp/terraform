...
description: >-
  Terraform uses environment variables to configure various aspects of its
  behavior.
---
...
For more details on `.terraformignore`, please see [Excluding Files from Upload with .terraformignore](/language/settings/backends/enhanced/remote#excluding-files-from-upload-with-terraformignore).
