...
Notice how the top visually looks a lot better? By repeating multiple
`variable` sections, it builds up the `variable` array. When possible, use
sections since they're visually clearer and more readable.
