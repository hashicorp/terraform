---
layout: "aws"
page_title: "AWS: aws_ami_description"
sidebar_current: "docs-aws-resource-ami-description"
description: |-
  Get information on a Amazon Machine Image (AMI).
---

# aws\_ami\_description

AWS AMI description resource - use to get AMI data, similar to
`describe-images` in the CLI. Use to get the ID of a registered AMI for use
in other resources.
