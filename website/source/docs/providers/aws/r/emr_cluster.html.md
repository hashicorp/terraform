...
* `security_configuration` - (Optional) The security configuration name to attach to the EMR cluster, the security configuration cannot be created through Terraform. Only valid for EMR clusters with `release_label` 4.8.0 or greater
