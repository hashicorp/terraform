...
## Example Usage (Managed Disks With Custom Image)
...
* `id` - (Optional) Specifies the Azure ID of a valid [custom image](https://azure.microsoft.com/en-us/documentation/articles/virtual-machines-linux-cli-deploy-templates/#create-a-custom-vm-image). Cannot be used with `publisher`, `offer`, `sku` or `version`.
* `publisher` - (Optional) Specifies the publisher of the image used to create the virtual machine. Changing this forces a new resource to be created. Cannot be used with `id`.
* `offer` - (Optional) Specifies the offer of the image used to create the virtual machine. Changing this forces a new resource to be created. Cannot be used with `id`.
* `sku` - (Optional) Specifies the SKU of the image used to create the virtual machine. Changing this forces a new resource to be created. Cannot be used with `id`.
* `version` - (Optional) Specifies the version of the image used to create the virtual machine. Changing this forces a new resource to be created. Cannot be used with `id`.
