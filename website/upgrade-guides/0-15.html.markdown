...
The hiding of the value is only for the main UI, and so the sensitive value
will still be recorded in the state. If you declared thus output value in order
