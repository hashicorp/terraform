...
func TestBuiltinEvalContextProviderInput(t *testing.T) {
	...
	providerAddr := addrs.LocalProviderConfig{Type: "foo"}
...
func TestBuildingEvalContextInitProvider(t *testing.T) {
	...
	providerAddrDefault := addrs.LocalProviderConfig{Type: "test"}
	providerAddrAlias := addrs.LocalProviderConfig{Type: "test", Alias: "foo"}
