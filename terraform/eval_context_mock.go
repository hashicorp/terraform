...
type MockEvalContext struct {
	...
	InitProviderAddr     addrs.LocalProviderConfig
	...
	CloseProviderAddr     addrs.LocalProviderConfig
	CloseProviderProvider providers.Interface

	ProviderInputCalled bool
	ProviderInputAddr   addrs.LocalProviderConfig
	ProviderInputValues map[string]cty.Value

	SetProviderInputCalled bool
	SetProviderInputAddr   addrs.LocalProviderConfig
	SetProviderInputValues map[string]cty.Value

	ConfigureProviderCalled bool
	ConfigureProviderAddr   addrs.LocalProviderConfig
...
func (c *MockEvalContext) InitProvider(t string, addr addrs.LocalProviderConfig) (providers.Interface, error) {
...
func (c *MockEvalContext) CloseProvider(addr addrs.LocalProviderConfig) error {
	c.CloseProviderCalled = true
	c.CloseProviderAddr = addr
	return nil
}

func (c *MockEvalContext) ConfigureProvider(addr addrs.LocalProviderConfig, cfg cty.Value) tfdiags.Diagnostics {
...
func (c *MockEvalContext) ProviderInput(addr addrs.LocalProviderConfig) map[string]cty.Value {
	c.ProviderInputCalled = true
	c.ProviderInputAddr = addr
	return c.ProviderInputValues
}

func (c *MockEvalContext) SetProviderInput(addr addrs.LocalProviderConfig, vals map[string]cty.Value) {
