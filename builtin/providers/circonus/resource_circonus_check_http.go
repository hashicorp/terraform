...
var _CheckHTTPDescriptions = _AttrDescrs{
	...
	_CheckHTTPCAChainAttr:      "A path to a file containing all the certificate authorities that should be loaded to validate the remote certificate (for SSL checks)",
	...
	_CheckHTTPCiphersAttr:      "A list of ciphers to be used in the SSL protocol (for SSL checks)",
	...
	_CheckHTTPKeyFileAttr:      "A path to a file containing key to be used in conjunction with the cilent certificate (for SSL checks)",
