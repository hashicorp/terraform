	...
	Elem: &schema.Resource{
		Schema: _CastSchemaToTF(map[_SchemaAttr]*schema.Schema{
			_CheckJSONAuthMethodAttr: &schema.Schema{
				...
				Optional:     true,
				Computed:     true,
				ValidateFunc: validateRegexp(_CheckJSONAuthMethodAttr, `^(?:Basic|Digest|Auto)$`),
			},
			_CheckJSONAuthPasswordAttr: &schema.Schema{
				...
				Computed:     true,
				Sensitive:    true,
				ValidateFunc: validateRegexp(_CheckJSONAuthPasswordAttr, `^.*`),
			},
			_CheckJSONAuthUserAttr: &schema.Schema{
				Type:         schema.TypeString,
				Optional:     true,
				Computed:     true,
				ValidateFunc: validateRegexp(_CheckJSONAuthUserAttr, `[^:]+`),
			},
			_CheckJSONCAChainAttr: &schema.Schema{
				Type:         schema.TypeString,
				Optional:     true,
				Computed:     true,
				ValidateFunc: validateRegexp(_CheckJSONCAChainAttr, `.+`),
			},
			_CheckJSONCertFileAttr: &schema.Schema{
				Type:         schema.TypeString,
				Optional:     true,
				Computed:     true,
				ValidateFunc: validateRegexp(_CheckJSONCertFileAttr, `.+`),
			},
			_CheckJSONCiphersAttr: &schema.Schema{
				Type:         schema.TypeString,
				Optional:     true,
				Computed:     true,
				ValidateFunc: validateRegexp(_CheckJSONCiphersAttr, `.+`),
			},
			...
			_CheckJSONKeyFileAttr: &schema.Schema{
				...
				Optional:     true,
				Computed:     true,
				ValidateFunc: validateRegexp(_CheckJSONKeyFileAttr, `.+`),
			},
			_CheckJSONMethodAttr: &schema.Schema{
				Type:         schema.TypeString,
				Optional:     true,
				Computed:     true,
				ValidateFunc: validateRegexp(_CheckJSONMethodAttr, `\S+`),
			},
			_CheckJSONPayloadAttr: &schema.Schema{
				Type:         schema.TypeString,
				Optional:     true,
				Computed:     true,
				ValidateFunc: validateRegexp(_CheckJSONPayloadAttr, `\S+`),
			},
