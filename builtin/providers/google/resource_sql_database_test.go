...
func testAccCheckGoogleSqlDatabaseEquals(n string,
	...
	return func(s *terraform.State) error {
		...
		if database_name != database.Name {
			return fmt.Errorf("Error name mistmatch, (%s, %s)", database_name, database.Name)
		}

		if instance_name != database.Instance {
			return fmt.Errorf("Error instance_name mistmatch, (%s, %s)", instance_name, database.Instance)
		}
