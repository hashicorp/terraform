		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsLambdaEventSourceMappingExists("aws_lambda_function.lambda_function_test", &conf),
...
func testAccCheckAwsLambdaEventSourceMappingExists(n string, function *lambda.GetFunctionOutput) resource.TestCheckFunc {
	// Wait for IAM role
...
func testAccCheckAWSLambdaEventSourceMappingAttributes(function *lambda.GetFunctionOutput) resource.TestCheckFunc {
	return func(s *terraform.State) error {
...
resource "aws_lambda_event_source_mapping" "test_event_source_mapping" {
    event_source_arn = "${aws_dynamodb_table.basic_dynamodb_table.latest_stream_arn}"
