...
func TestAccAWSCloudwatchLogsLogGroup_basic(t *testing.T) {
	var conf lambda.GetFunctionOutput

	resource.Test(t, resource.TestCase{
		PreCheck:     func() { testAccPreCheck(t) },
		Providers:    testAccProviders,
		CheckDestroy: testAccCheckCloudwatchLogsLogGroupDestroy,
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccAWSCloudwatchLogsLogGroupConfig,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAwsCloudwatchLogsLogGroupExists("aws_cloudwatch_logs_subscription_filter.test_lambdafunction_logfilter", &conf),
					testAccCheckAWSCloudwatchLogsLogGroupAttributes(&conf),
				),
			},
		},
	})
...
func testAccCheckCloudwatchLogsLogGroupDestroy(s *terraform.State) error {
...
func testAccCheckAwsCloudwatchLogsLogGroupExists(n string, function *lambda.GetFunctionOutput) resource.TestCheckFunc {
	// Wait for IAM role
...
func testAccCheckAWSCloudwatchLogsLogGroupAttributes(function *lambda.GetFunctionOutput) resource.TestCheckFunc {
	return func(s *terraform.State) error {
...
const testAccAWSCloudwatchLogsLogGroupConfig = `
