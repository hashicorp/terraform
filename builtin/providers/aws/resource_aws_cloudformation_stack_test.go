		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("aws_cloudformation_stack.full", "outputs.First", "1"),
					resource.TestCheckResourceAttr("aws_cloudformation_stack.full", "outputs.Second", "2"),
