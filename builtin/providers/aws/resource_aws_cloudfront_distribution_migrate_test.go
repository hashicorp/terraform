	...
	cases := map[string]struct {
		...
		"v0_1_single_cache_behavior": {
			...
			Attributes: map[string]string{
				...
				"default_cache_behavior.1784951082.allowed_methods.#":                                                  "2",
				"default_cache_behavior.1784951082.allowed_methods.0":                                                  "GET",
				"default_cache_behavior.1784951082.allowed_methods.1":                                                  "HEAD",
				"default_cache_behavior.1784951082.cached_methods.#":                                                   "2",
				"default_cache_behavior.1784951082.cached_methods.0":                                                   "GET",
				"default_cache_behavior.1784951082.cached_methods.1":                                                   "HEAD",
				"default_cache_behavior.1784951082.compress":                                                           "false",
				"default_cache_behavior.1784951082.default_ttl":                                                        "3600",
				"default_cache_behavior.1784951082.forwarded_values.#":                                                 "1",
				"default_cache_behavior.1784951082.forwarded_values.2759845635.cookies.#":                              "1",
				"default_cache_behavior.1784951082.forwarded_values.2759845635.cookies.2625240281.forward":             "none",
				"default_cache_behavior.1784951082.forwarded_values.2759845635.cookies.2625240281.whitelisted_names.#": "0",
				"default_cache_behavior.1784951082.forwarded_values.2759845635.headers.#":                              "0",
				"default_cache_behavior.1784951082.forwarded_values.2759845635.query_string":                           "false",
				"default_cache_behavior.1784951082.max_ttl":                                                            "86400",
				"default_cache_behavior.1784951082.min_ttl":                                                            "0",
				"default_cache_behavior.1784951082.smooth_streaming":                                                   "",
				"default_cache_behavior.1784951082.target_origin_id":                                                   "myS3Origin",
				"default_cache_behavior.1784951082.trusted_signers.#":                                                  "0",
				"default_cache_behavior.1784951082.viewer_protocol_policy":                                             "allow-all",
			},
			Expected: map[string]string{
				"cache_behavior.#":                                                                            "1",
				...
				"default_cache_behavior.0.forwarded_values.2759845635.cookies.#":                              "1",
				"default_cache_behavior.0.forwarded_values.2759845635.cookies.2625240281.forward":             "none",
				"default_cache_behavior.0.forwarded_values.2759845635.cookies.2625240281.whitelisted_names.#": "0",
				"default_cache_behavior.0.forwarded_values.2759845635.headers.#":                              "0",
				"default_cache_behavior.0.forwarded_values.2759845635.query_string":                           "false",
				"default_cache_behavior.0.max_ttl":                                                            "86400",
				"default_cache_behavior.0.min_ttl":                                                            "0",
				"default_cache_behavior.0.smooth_streaming":                                                   "",
				"default_cache_behavior.0.target_origin_id":                                                   "myS3Origin",
