...
func resourceAwsLaunchConfigurationCreate(d *schema.ResourceData, meta interface{}) error {
	...
	log.Printf(
		"[DEBUG] autoscaling create launch configuration: %s", awsutil.StringValue(createLaunchConfigurationOpts))
...
func resourceAwsLaunchConfigurationRead(d *schema.ResourceData, meta interface{}) error {
	...
	log.Printf("[DEBUG] launch configuration describe configuration: %s", awsutil.StringValue(describeOpts))
