...
func resourceAsmVirtualNetworkCreate(d *schema.ResourceData, meta interface{}) error {
	ac := meta.(*AzureClient)
	mc := ac.asmClient.mgmtClient
	vnetClient := ac.asmClient.vnetClient
	...
	ac.asmClient.vnetMutex.Lock()
	defer ac.asmClient.vnetMutex.Unlock()
...
func resourceAsmVirtualNetworkRead(d *schema.ResourceData, meta interface{}) error {
	ac := meta.(*AzureClient)
	vnetClient := ac.asmClient.vnetClient
	secGroupClient := ac.asmClient.secGroupClient
...
func resourceAsmVirtualNetworkUpdate(d *schema.ResourceData, meta interface{}) error {
	ac := meta.(*AzureClient)
	mc := ac.asmClient.mgmtClient
	vnetClient := ac.asmClient.vnetClient
...
func resourceAsmVirtualNetworkDelete(d *schema.ResourceData, meta interface{}) error {
	ac := meta.(*AzureClient)
	mc := ac.asmClient.mgmtClient
	vnetClient := ac.asmClient.vnetClient
