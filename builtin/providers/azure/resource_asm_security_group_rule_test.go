...
func TestAccAsmSecurityGroupRuleBasic(t *testing.T) {
...
func TestAccAsmSecurityGroupRuleAdvanced(t *testing.T) {
	name := "azure_security_group_rule.foo"
...
func TestAccAsmSecurityGroupRuleUpdate(t *testing.T) {
	name := "azure_security_group_rule.foo"
