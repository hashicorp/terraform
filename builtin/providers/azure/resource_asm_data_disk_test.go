...
func TestAccAsmDataDisk_basic(t *testing.T) {
...
func TestAccAsmDataDisk_update(t *testing.T) {
	var disk virtualmachinedisk.DataDiskResponse
	name := fmt.Sprintf("terraform-test%d", genRandInt())
...
func testAccCheckAzureDataDiskExists(
	...
	return func(s *terraform.State) error {
		...
		vmDiskClient := testAccProvider.Meta().(*AzureClient).asmClient.vmDiskClient
