...
func resourceAsmInstanceCreate(d *schema.ResourceData, meta interface{}) (err error) {
	...
	vmClient := azureClient.asmClient.vmClient
...
func resourceAsmInstanceRead(d *schema.ResourceData, meta interface{}) error {
	azureClient := meta.(*AzureClient)
	hostedServiceClient := azureClient.asmClient.hostedServiceClient
	vmClient := azureClient.asmClient.vmClient
...
func resourceAsmInstanceUpdate(d *schema.ResourceData, meta interface{}) error {
	azureClient := meta.(*AzureClient)
	mc := azureClient.asmClient.mgmtClient
	vmClient := azureClient.asmClient.vmClient
...
func resourceAsmInstanceDelete(d *schema.ResourceData, meta interface{}) error {
	azureClient := meta.(*AzureClient)
	mc := azureClient.asmClient.mgmtClient
	vmClient := azureClient.asmClient.vmClient
...
func retrieveImageDetails(
	...
	azureClient := meta.(*AzureClient)
	vmImageClient := azureClient.asmClient.vmImageClient
	osImageClient := azureClient.asmClient.osImageClient
