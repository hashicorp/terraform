...
func TestAccAsmInstance_basic(t *testing.T) {
...
func TestAccAsmInstance_separateHostedService(t *testing.T) {
	var dpmt virtualmachine.DeploymentResponse
...
func TestAccAsmInstance_advanced(t *testing.T) {
	var dpmt virtualmachine.DeploymentResponse
...
func TestAccAsmInstance_update(t *testing.T) {
	var dpmt virtualmachine.DeploymentResponse
...
func testAccCheckAzureInstanceExists(
	...
	return func(s *terraform.State) error {
		...
		vmClient := testAccProvider.Meta().(*AzureClient).asmClient.vmClient
...
func testAccCheckAzureInstanceDestroyed(hostedServiceName string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		hostedServiceClient := testAccProvider.Meta().(*AzureClient).asmClient.hostedServiceClient
