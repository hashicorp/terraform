...
// resourceAsmSqlDatabaseService returns the *schema.Resource
// associated to an SQL Database Service on Azure.
func resourceAsmSqlDatabaseService() *schema.Resource {
	return &schema.Resource{
		Create: resourceAsmSqlDatabaseServiceCreate,
		Read:   resourceAsmSqlDatabaseServiceRead,
		Update: resourceAsmSqlDatabaseServiceUpdate,
		Exists: resourceAsmSqlDatabaseServiceExists,
		Delete: resourceAsmSqlDatabaseServiceDelete,
...
// resourceAsmSqlDatabaseServiceCreate does all the necessary API calls to
// create an SQL Database Service on Azure.
func resourceAsmSqlDatabaseServiceCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceAsmSqlDatabaseServiceRead(d, meta)
}

// resourceAsmSqlDatabaseServiceRead does all the necessary API calls to
// read the state of the SQL Database Service off Azure.
func resourceAsmSqlDatabaseServiceRead(d *schema.ResourceData, meta interface{}) error {
	sqlClient := meta.(*AzureClient).asmClient.sqlClient
...
// resourceAsmSqlDatabaseServiceUpdate does all the necessary API calls to
// update the state of the SQL Database Service off Azure.
func resourceAsmSqlDatabaseServiceUpdate(d *schema.ResourceData, meta interface{}) error {
	azureClient := meta.(*AzureClient)
	mgmtClient := azureClient.asmClient.mgmtClient
	sqlClient := azureClient.asmClient.sqlClient
	serverName := d.Get("database_server_name").(string)
...
// resourceAsmSqlDatabaseServiceExists does all the necessary API calls to
// check for the existence of the SQL Database Service off Azure.
func resourceAsmSqlDatabaseServiceExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	sqlClient := meta.(*AzureClient).asmClient.sqlClient
...
// resourceAsmSqlDatabaseServiceDelete does all the necessary API calls to
// delete the SQL Database Service off Azure.
func resourceAsmSqlDatabaseServiceDelete(d *schema.ResourceData, meta interface{}) error {
	sqlClient := meta.(*AzureClient).asmClient.sqlClient
