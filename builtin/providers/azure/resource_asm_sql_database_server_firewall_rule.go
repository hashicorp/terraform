...
// resourceAsmSqlDatabaseServerFirewallRule returns the *schema.Resource
// associated to a firewall rule of a database server in Azure.
func resourceAsmSqlDatabaseServerFirewallRule() *schema.Resource {
	return &schema.Resource{
		Create: resourceAsmSqlDatabaseServerFirewallRuleCreate,
		Read:   resourceAsmSqlDatabaseServerFirewallRuleRead,
		Update: resourceAsmSqlDatabaseServerFirewallRuleUpdate,
		Delete: resourceAsmSqlDatabaseServerFirewallRuleDelete,
...
// resourceAsmSqlDatabaseServerFirewallRuleCreate does all the necessary API
// calls to create the SQL Database Server Firewall Rule on Azure.
func resourceAsmSqlDatabaseServerFirewallRuleCreate(d *schema.ResourceData, meta interface{}) error {
...
// resourceAsmSqlDatabaseServerFirewallRuleRead does all the necessary API
// calls to read the state of the SQL Database Server Firewall Rule on Azure.
func resourceAsmSqlDatabaseServerFirewallRuleRead(d *schema.ResourceData, meta interface{}) error {
	sqlClient := meta.(*AzureClient).asmClient.sqlClient
...
// resourceAsmSqlDatabaseServerFirewallRuleUpdate does all the necessary API
// calls to update the state of the SQL Database Server Firewall Rule on Azure.
func resourceAsmSqlDatabaseServerFirewallRuleUpdate(d *schema.ResourceData, meta interface{}) error {
	sqlClient := meta.(*AzureClient).asmClient.sqlClient
...
// resourceAsmSqlDatabaseServerFirewallRuleDelete does all the necessary API
// calls to delete the SQL Database Server Firewall Rule on Azure.
func resourceAsmSqlDatabaseServerFirewallRuleDelete(d *schema.ResourceData, meta interface{}) error {
	sqlClient := meta.(*AzureClient).asmClient.sqlClient
