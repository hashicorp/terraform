...
// resourceAsmSecurityGroupRuleCreate does all the necessary API calls to
// create a new network security group rule on Azure.
func resourceAsmSecurityGroupRuleCreate(d *schema.ResourceData, meta interface{}) error {
	...
	azureClient.asmClient.secGroupMutex.Lock()
	defer azureClient.asmClient.secGroupMutex.Unlock()
...
// resourceAsmSecurityGroupRuleRead does all the necessary API calls to
// read the state of a network security group ruke off Azure.
func resourceAsmSecurityGroupRuleRead(d *schema.ResourceData, meta interface{}) error {
	azureClient := meta.(*AzureClient)
	secGroupClient := azureClient.asmClient.secGroupClient
...
// resourceAsmSecurityGroupRuleUpdate does all the necessary API calls to
// update the state of a network security group rule off Azure.
func resourceAsmSecurityGroupRuleUpdate(d *schema.ResourceData, meta interface{}) error {
	azureClient := meta.(*AzureClient)
	mgmtClient := azureClient.asmClient.mgmtClient
	secGroupClient := azureClient.asmClient.secGroupClient
...
// resourceAsmSecurityGroupRuleDelete does all the necessary API calls to
// delete a network security group rule off Azure.
func resourceAsmSecurityGroupRuleDelete(d *schema.ResourceData, meta interface{}) error {
	azureClient := meta.(*AzureClient)
	mgmtClient := azureClient.asmClient.mgmtClient
	secGroupClient := azureClient.asmClient.secGroupClient
