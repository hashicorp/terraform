...
func TestAccAsmSqlDatabaseServiceBasic(t *testing.T) {
...
func TestAccAsmSqlDatabaseServiceAdvanced(t *testing.T) {
	name := "azure_sql_database_service.foo"
...
func TestAccAsmSqlDatabaseServiceUpdate(t *testing.T) {
	name := "azure_sql_database_service.foo"
