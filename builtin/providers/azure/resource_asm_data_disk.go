...
func resourceAsmDataDisk() *schema.Resource {
	return &schema.Resource{
		Create: resourceAsmDataDiskCreate,
		Read:   resourceAsmDataDiskRead,
		Update: resourceAsmDataDiskUpdate,
		Delete: resourceAsmDataDiskDelete,
...
func resourceAsmDataDiskCreate(d *schema.ResourceData, meta interface{}) error {
	mc := meta.(*AzureClient).asmClient.mgmtClient
	vmDiskClient := meta.(*AzureClient).asmClient.vmDiskClient
	...
	return resourceAsmDataDiskRead(d, meta)
}

func resourceAsmDataDiskRead(d *schema.ResourceData, meta interface{}) error {
	vmDiskClient := meta.(*AzureClient).asmClient.vmDiskClient
...
func resourceAsmDataDiskUpdate(d *schema.ResourceData, meta interface{}) error {
	mc := meta.(*AzureClient).asmClient.mgmtClient
	vmDiskClient := meta.(*AzureClient).asmClient.vmDiskClient
...
func resourceAsmDataDiskDelete(d *schema.ResourceData, meta interface{}) error {
	mc := meta.(*AzureClient).asmClient.mgmtClient
	vmDiskClient := meta.(*AzureClient).asmClient.vmDiskClient
