...
func TestAccAsmAffinityGroupBasic(t *testing.T) {
...
func TestAccAsmAffinityGroupUpdate(t *testing.T) {
	name := "azure_affinity_group.foo"
...
func testAccCheckAzureAffinityGroupExists(name string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		affinityGroupClient := testAccProvider.Meta().(*AzureClient).asmClient.affinityGroupClient
