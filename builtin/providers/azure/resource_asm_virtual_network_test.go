...
func TestAccAsmVirtualNetwork_basic(t *testing.T) {
...
func TestAccAsmVirtualNetwork_advanced(t *testing.T) {
	var network virtualnetwork.VirtualNetworkSite
...
func TestAccAsmVirtualNetwork_update(t *testing.T) {
	var network virtualnetwork.VirtualNetworkSite
...
func testAccCheckAzureVirtualNetworkExists(
	...
	return func(s *terraform.State) error {
		...
		vnetClient := testAccProvider.Meta().(*AzureClient).asmClient.vnetClient
