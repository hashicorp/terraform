...
func TestAccAsmSqlDatabaseServerFirewallRuleBasic(t *testing.T) {
...
func TestAccAsmSqlDatabaseServerFirewallRuleAdvanced(t *testing.T) {
...
func TestAccAsmSqlDatabaseServerFirewallRuleUpdate(t *testing.T) {
	name1 := "azure_sql_database_server_firewall_rule.foo"
	name2 := "azure_sql_database_server_firewall_rule.bar"
...
func testAccAzureDatabaseServerFirewallRuleExists(name string, servers []string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		sqlClient := testAccProvider.Meta().(*AzureClient).asmClient.sqlClient
