...
func TestAccAzureRMAppGateway_basic_changeCert(t *testing.T) {
	ri := acctest.RandInt()
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccAzureRMAppGateway_basic_changeCert(ri),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMAppGatewayExists("azurerm_app_gateway.test"),
...
func testAccAzureRMAppGateway_basic_changeCert(rInt int) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestrg-%d"
  location = "West US 2"
...
func testAccAzureRMAppGateway_basic_authenticationCert(rInt int) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestrg-%d"
  location = "West US 2"
