		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMAppGatewayExists("azurerm_app_gateway.test"),
					testCheckAzureRMAppGatewaySslCertificateAssigned("azurerm_app_gateway.test", "ssl-1"),
...
func TestAccAzureRMAppGateway_basic_changeSslCert(t *testing.T) {
	ri := acctest.RandInt()
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccAzureRMAppGateway_basic_changeSslCert(ri),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMAppGatewayExists("azurerm_app_gateway.test"),
					testCheckAzureRMAppGatewaySslCertificateAssigned("azurerm_app_gateway.test", "ssl-2"),
					resource.TestCheckResourceAttr("azurerm_app_gateway.test", "id", gwID),
				),
			},
		},
...
func TestAccAzureRMAppGateway_basic_authCert(t *testing.T) {
	ri := acctest.RandInt()
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMAppGateway_basic_authCert(ri),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMAppGatewayExists("azurerm_app_gateway.test"),
					testCheckAzureRMAppGatewaySslCertificateAssigned("azurerm_app_gateway.test", "ssl-1"),
					testCheckAzureRMAppGatewayAuthenticationCertificateAssigned("azurerm_app_gateway.test", "auth-1"),
					resource.TestCheckResourceAttr("azurerm_app_gateway.test", "id", gwID),
				),
			},
		},
...
func TestAccAzureRMAppGateway_basic_changeAuthCert(t *testing.T) {
	ri := acctest.RandInt()
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccAzureRMAppGateway_basic_changeAuthCert(ri),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMAppGatewayExists("azurerm_app_gateway.test"),
					testCheckAzureRMAppGatewaySslCertificateAssigned("azurerm_app_gateway.test", "ssl-1"),
					testCheckAzureRMAppGatewayAuthenticationCertificateAssigned("azurerm_app_gateway.test", "auth-2"),
					resource.TestCheckResourceAttr("azurerm_app_gateway.test", "id", gwID),
				),
			},
		},
...
func TestAccAzureRMAppGateway_waf(t *testing.T) {
	ri := acctest.RandInt()
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMAppGateway_waf(ri),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMAppGatewayExists("azurerm_app_gateway.test"),
					testCheckAzureRMAppGatewaySslCertificateAssigned("azurerm_app_gateway.test", "ssl-1"),
					resource.TestCheckResourceAttr("azurerm_app_gateway.test", "id", gwID),
...
func testCheckAzureRMAppGatewayExists(name string) resource.TestCheckFunc {
...
func testCheckAzureRMAppGatewaySslCertificateAssigned(name string, certName string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		rs, ok := s.RootModule().Resources[name]
		if !ok {
			return fmt.Errorf("Not found: %s", name)
...
func testCheckAzureRMAppGatewayAuthenticationCertificateAssigned(name string, certName string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		rs, ok := s.RootModule().Resources[name]
		if !ok {
			return fmt.Errorf("Not found: %s", name)
...
func testAccAzureRMAppGateway_basic_changeSslCert(rInt int) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestrg-%d"
  location = "West US 2"
...
func testAccAzureRMAppGateway_basic_authCert(rInt int) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestrg-%d"
  location = "West US 2"
...
func testAccAzureRMAppGateway_basic_changeAuthCert(rInt int) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestrg-%d"
  location = "West US 2"
...
func testAccAzureRMAppGateway_waf(rInt int) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestrg-%d"
  location = "West US 2"
