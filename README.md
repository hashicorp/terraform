...
- Website: [Terraform Website](https://developer.hashicorp.com/terraform)
...
For more information, refer to the [What is Terraform?](https://developer.hashicorp.com/terraform/intro) page on the Terraform website.
...
If you're new to Terraform and want to get started creating infrastructure, please check out our [Getting Started guides](https://developer.hashicorp.com/terraform/tutorials#getting-started) on HashiCorp's learning platform. There are also [additional guides](https://developer.hashicorp.com/terraform/tutorials#operations-and-development) to continue your learning.
