...
If you're new to Terraform and want to get started creating infrastrucutre, please checkout our [Getting Started](https://www.terraform.io/intro/getting-started/install.html) guide, available on the [Terraform website](http://www.terraform.io).
