...
#
# This will produce a zip file build/mnptu-e2etest_windows_amd64.zip which
...
# the mnptu executable. Instead, the caller of the tests must retrieve
...
OUTFILE="mnptu-e2etest_${GOOS}_${GOARCH}.zip"

LDFLAGS="-X github.com/hashicorp/mnptu/internal/command/e2etest.mnptuBin=./mnptu$GOEXE"
...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "$LDFLAGS" github.com/hashicorp/mnptu/internal/command/e2etest
