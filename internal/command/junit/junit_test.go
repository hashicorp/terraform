...
func Test_TestJUnitXMLFile_Save(t *testing.T) {
  ...
  <testsuite name="file1.tftest.hcl" tests="2" skipped="1" failures="0" errors="1">
    ...
    <testcase name="my_test_2" classname="file1.tftest.hcl">
      <skipped message="Test run skipped due to a previous testcase error"><![CDATA[Previous testcase "my_test_1" ended in error, which caused the test remaining tests in the file to be skipped]]></skipped>
    </testcase>
  </testsuite>
</testsuites>`),
		},
