...
func TestPlan_minimal_refresh(t *testing.T) {
	td := t.TempDir()
	testCopyDir(t, testFixturePath("plan-minimal-refresh"), td)
	t.Chdir(td)
...
func TestPlan_minimal_refresh_destroy(t *testing.T) {
	td := t.TempDir()
	testCopyDir(t, testFixturePath("plan-minimal-refresh"), td)
	t.Chdir(td)
...
func TestPlan_minimal_refresh_invalid_flags(t *testing.T) {
	td := t.TempDir()
	testCopyDir(t, testFixturePath("plan-minimal-refresh"), td)
	t.Chdir(td)
