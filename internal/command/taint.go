...
func (c *TaintCommand) Help() string {
	helpText := `
Usage: mnptu [global options] taint [options] <address>
  ...
  address will reach mnptu correctly, without any special
  interpretation.
