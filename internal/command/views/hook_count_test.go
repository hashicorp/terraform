...
func TestCountHookPostDiff_DestroyDeposed(t *testing.T) {
	...
	for k := range resources {
		...
		h.PostDiff(testCountHookResourceID(addr), states.DeposedKey("deadbeef"), plans.Delete, nil)
	}
...
func TestCountHookPostDiff_DestroyOnly(t *testing.T) {
	...
	for k := range resources {
		...
		h.PostDiff(testCountHookResourceID(addr), addrs.NotDeposed, plans.Delete, nil)
	}
...
func TestCountHookPostDiff_AddOnly(t *testing.T) {
	...
	for k := range resources {
		...
		h.PostDiff(testCountHookResourceID(addr), addrs.NotDeposed, plans.Create, nil)
	}
...
func TestCountHookPostDiff_ChangeOnly(t *testing.T) {
	...
	for k := range resources {
		...
		h.PostDiff(testCountHookResourceID(addr), addrs.NotDeposed, plans.Update, nil)
	}
...
func TestCountHookPostDiff_Mixed(t *testing.T) {
	...
	for k, a := range resources {
		...
		h.PostDiff(testCountHookResourceID(addr), addrs.NotDeposed, a, nil)
	}
...
func TestCountHookPostDiff_NoChange(t *testing.T) {
	...
	for k := range resources {
		...
		h.PostDiff(testCountHookResourceID(addr), addrs.NotDeposed, plans.NoOp, nil)
	}
