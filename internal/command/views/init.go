...
const (
	...
	InitializingStateStoreMessage                InitMessageCode = "initializing_state_store"
	InitializingStateStoreProviderPluginMessage  InitMessageCode = "initializing_state_store_provider_plugin"
	StateStoreProviderInteractiveApprovedMessage InitMessageCode = "state_store_provider_interactive_approved"
	StateStoreProviderInteractiveRejectedMessage InitMessageCode = "state_store_provider_interactive_rejected"
	StateStoreProviderAutomationApprovedMessage  InitMessageCode = "state_store_provider_automation_approved"
