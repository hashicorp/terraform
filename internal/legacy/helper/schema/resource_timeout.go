...
func (t *ResourceTimeout) ConfigDecode(s *Resource, c *mnptu.ResourceConfig) error {
	if s.Timeouts != nil {
...
// saving to state
func (t *ResourceTimeout) DiffEncode(id *mnptu.InstanceDiff) error {
	return t.metaEncode(id)
}

func (t *ResourceTimeout) StateEncode(is *mnptu.InstanceState) error {
...
// Assumes the interface is either *mnptu.InstanceState or
// *mnptu.InstanceDiff, returns an error otherwise
...
func (t *ResourceTimeout) StateDecode(id *mnptu.InstanceState) error {
	return t.metaDecode(id)
}
func (t *ResourceTimeout) DiffDecode(is *mnptu.InstanceDiff) error {
