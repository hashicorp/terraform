...
const file_tfplugin5_proto_rawDesc = "" +
	...
	"\ridentity_data\x18\x01 \x01(\v2\x17.tfplugin5.DynamicValueR\fidentityData\"\x9b\x05\n" +
	"\fActionSchema\x12)\n" +
	...
	"actionType\x12W\n" +
	"\x10linked_resources\x18\x02 \x03(\v2,.tfplugin5.PlanAction.Request.LinkedResourceR\x0flinkedResources\x12/\n" +
	"\x06config\x18\x03 \x01(\v2\x17.tfplugin5.DynamicValueR\x06config\x12N\n" +
	"\x13client_capabilities\x18\x04 \x01(\v2\x1d.tfplugin5.ClientCapabilitiesR\x12clientCapabilities\x1a\x81\x02\n" +
	"\x0eLinkedResource\x128\n" +
	"\vprior_state\x18\x01 \x01(\v2\x17.tfplugin5.DynamicValueR\n" +
	"priorState\x12<\n" +
	"\rplanned_state\x18\x02 \x01(\v2\x17.tfplugin5.DynamicValueR\fplannedState\x12/\n" +
	"\x06config\x18\x03 \x01(\v2\x17.tfplugin5.DynamicValueR\x06config\x12F\n" +
	"\x0eprior_identity\x18\x04 \x01(\v2\x1f.tfplugin5.ResourceIdentityDataR\rpriorIdentity\x1a\xeb\x02\n" +
	"\bResponse\x12X\n" +
	"\x10linked_resources\x18\x01 \x03(\v2-.tfplugin5.PlanAction.Response.LinkedResourceR\x0flinkedResources\x127\n" +
	"\vdiagnostics\x18\x02 \x03(\v2\x15.tfplugin5.DiagnosticR\vdiagnostics\x12/\n" +
	"\bdeferred\x18\x03 \x01(\v2\x13.tfplugin5.DeferredR\bdeferred\x1a\x9a\x01\n" +
	"\x0eLinkedResource\x12<\n" +
	"\rplanned_state\x18\x01 \x01(\v2\x17.tfplugin5.DynamicValueR\fplannedState\x12J\n" +
	"\x10planned_identity\x18\x02 \x01(\v2\x1f.tfplugin5.ResourceIdentityDataR\x0fplannedIdentity\"\xc8\b\n" +
	"\fInvokeAction\x1a\x8e\x04\n" +
	"\aRequest\x12\x1f\n" +
	"\vaction_type\x18\x01 \x01(\tR\n" +
	"actionType\x12Y\n" +
	"\x10linked_resources\x18\x02 \x03(\v2..tfplugin5.InvokeAction.Request.LinkedResourceR\x0flinkedResources\x12/\n" +
	"\x06config\x18\x03 \x01(\v2\x17.tfplugin5.DynamicValueR\x06config\x12N\n" +
	"\x13client_capabilities\x18\x04 \x01(\v2\x1d.tfplugin5.ClientCapabilitiesR\x12clientCapabilities\x1a\x85\x02\n" +
	"\x0eLinkedResource\x128\n" +
	"\vprior_state\x18\x01 \x01(\v2\x17.tfplugin5.DynamicValueR\n" +
	"priorState\x12<\n" +
	"\rplanned_state\x18\x02 \x01(\v2\x17.tfplugin5.DynamicValueR\fplannedState\x12/\n" +
	"\x06config\x18\x03 \x01(\v2\x17.tfplugin5.DynamicValueR\x06config\x12J\n" +
	"\x10planned_identity\x18\x04 \x01(\v2\x1f.tfplugin5.ResourceIdentityDataR\x0fplannedIdentity\x1a\xa6\x04\n" +
	"\x05Event\x12D\n" +
	...
	"\tCompleted\x12a\n" +
	"\x10linked_resources\x18\x01 \x03(\v26.tfplugin5.InvokeAction.Event.Completed.LinkedResourceR\x0flinkedResources\x127\n" +
	"\vdiagnostics\x18\x02 \x03(\v2\x15.tfplugin5.DiagnosticR\vdiagnostics\x1a\xb5\x01\n" +
	"\x0eLinkedResource\x124\n" +
	"\tnew_state\x18\x01 \x01(\v2\x17.tfplugin5.DynamicValueR\bnewState\x12B\n" +
	"\fnew_identity\x18\x02 \x01(\v2\x1f.tfplugin5.ResourceIdentityDataR\vnewIdentity\x12)\n" +
	...
	"\ttype_name\x18\x01 \x01(\tR\btypeName\x12/\n" +
	"\x06config\x18\x02 \x01(\v2\x17.tfplugin5.DynamicValueR\x06config*%\n" +
	"\n" +
	"StringKind\x12\t\n" +
...
var file_tfplugin5_proto_depIdxs = []int32{
	...
	17,  // 165: tfplugin5.InvokeAction.Request.client_capabilities:type_name -> tfplugin5.ClientCapabilities
	140, // 166: tfplugin5.InvokeAction.Event.progress:type_name -> tfplugin5.InvokeAction.Event.Progress
	141, // 167: tfplugin5.InvokeAction.Event.completed:type_name -> tfplugin5.InvokeAction.Event.Completed
	5,   // 168: tfplugin5.InvokeAction.Request.LinkedResource.prior_state:type_name -> tfplugin5.DynamicValue
	5,   // 169: tfplugin5.InvokeAction.Request.LinkedResource.planned_state:type_name -> tfplugin5.DynamicValue
	5,   // 170: tfplugin5.InvokeAction.Request.LinkedResource.config:type_name -> tfplugin5.DynamicValue
	12,  // 171: tfplugin5.InvokeAction.Request.LinkedResource.planned_identity:type_name -> tfplugin5.ResourceIdentityData
	142, // 172: tfplugin5.InvokeAction.Event.Completed.linked_resources:type_name -> tfplugin5.InvokeAction.Event.Completed.LinkedResource
	6,   // 173: tfplugin5.InvokeAction.Event.Completed.diagnostics:type_name -> tfplugin5.Diagnostic
	5,   // 174: tfplugin5.InvokeAction.Event.Completed.LinkedResource.new_state:type_name -> tfplugin5.DynamicValue
	12,  // 175: tfplugin5.InvokeAction.Event.Completed.LinkedResource.new_identity:type_name -> tfplugin5.ResourceIdentityData
	5,   // 176: tfplugin5.ValidateActionConfig.Request.config:type_name -> tfplugin5.DynamicValue
	49,  // 177: tfplugin5.ValidateActionConfig.Request.linked_resources:type_name -> tfplugin5.LinkedResourceConfig
	6,   // 178: tfplugin5.ValidateActionConfig.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	64,  // 179: tfplugin5.Provider.GetMetadata:input_type -> tfplugin5.GetMetadata.Request
	72,  // 180: tfplugin5.Provider.GetSchema:input_type -> tfplugin5.GetProviderSchema.Request
	80,  // 181: tfplugin5.Provider.PrepareProviderConfig:input_type -> tfplugin5.PrepareProviderConfig.Request
	89,  // 182: tfplugin5.Provider.ValidateResourceTypeConfig:input_type -> tfplugin5.ValidateResourceTypeConfig.Request
	91,  // 183: tfplugin5.Provider.ValidateDataSourceConfig:input_type -> tfplugin5.ValidateDataSourceConfig.Request
	82,  // 184: tfplugin5.Provider.UpgradeResourceState:input_type -> tfplugin5.UpgradeResourceState.Request
	84,  // 185: tfplugin5.Provider.GetResourceIdentitySchemas:input_type -> tfplugin5.GetResourceIdentitySchemas.Request
	87,  // 186: tfplugin5.Provider.UpgradeResourceIdentity:input_type -> tfplugin5.UpgradeResourceIdentity.Request
	95,  // 187: tfplugin5.Provider.Configure:input_type -> tfplugin5.Configure.Request
	97,  // 188: tfplugin5.Provider.ReadResource:input_type -> tfplugin5.ReadResource.Request
	99,  // 189: tfplugin5.Provider.PlanResourceChange:input_type -> tfplugin5.PlanResourceChange.Request
	101, // 190: tfplugin5.Provider.ApplyResourceChange:input_type -> tfplugin5.ApplyResourceChange.Request
	103, // 191: tfplugin5.Provider.ImportResourceState:input_type -> tfplugin5.ImportResourceState.Request
	108, // 192: tfplugin5.Provider.MoveResourceState:input_type -> tfplugin5.MoveResourceState.Request
	110, // 193: tfplugin5.Provider.ReadDataSource:input_type -> tfplugin5.ReadDataSource.Request
	106, // 194: tfplugin5.Provider.GenerateResourceConfig:input_type -> tfplugin5.GenerateResourceConfig.Request
	93,  // 195: tfplugin5.Provider.ValidateEphemeralResourceConfig:input_type -> tfplugin5.ValidateEphemeralResourceConfig.Request
	118, // 196: tfplugin5.Provider.OpenEphemeralResource:input_type -> tfplugin5.OpenEphemeralResource.Request
	120, // 197: tfplugin5.Provider.RenewEphemeralResource:input_type -> tfplugin5.RenewEphemeralResource.Request
	122, // 198: tfplugin5.Provider.CloseEphemeralResource:input_type -> tfplugin5.CloseEphemeralResource.Request
	129, // 199: tfplugin5.Provider.ListResource:input_type -> tfplugin5.ListResource.Request
	131, // 200: tfplugin5.Provider.ValidateListResourceConfig:input_type -> tfplugin5.ValidateListResourceConfig.Request
	124, // 201: tfplugin5.Provider.GetFunctions:input_type -> tfplugin5.GetFunctions.Request
	127, // 202: tfplugin5.Provider.CallFunction:input_type -> tfplugin5.CallFunction.Request
	133, // 203: tfplugin5.Provider.PlanAction:input_type -> tfplugin5.PlanAction.Request
	137, // 204: tfplugin5.Provider.InvokeAction:input_type -> tfplugin5.InvokeAction.Request
	143, // 205: tfplugin5.Provider.ValidateActionConfig:input_type -> tfplugin5.ValidateActionConfig.Request
	51,  // 206: tfplugin5.Provider.Stop:input_type -> tfplugin5.Stop.Request
	112, // 207: tfplugin5.Provisioner.GetSchema:input_type -> tfplugin5.GetProvisionerSchema.Request
	114, // 208: tfplugin5.Provisioner.ValidateProvisionerConfig:input_type -> tfplugin5.ValidateProvisionerConfig.Request
	116, // 209: tfplugin5.Provisioner.ProvisionResource:input_type -> tfplugin5.ProvisionResource.Request
	51,  // 210: tfplugin5.Provisioner.Stop:input_type -> tfplugin5.Stop.Request
	65,  // 211: tfplugin5.Provider.GetMetadata:output_type -> tfplugin5.GetMetadata.Response
	73,  // 212: tfplugin5.Provider.GetSchema:output_type -> tfplugin5.GetProviderSchema.Response
	81,  // 213: tfplugin5.Provider.PrepareProviderConfig:output_type -> tfplugin5.PrepareProviderConfig.Response
	90,  // 214: tfplugin5.Provider.ValidateResourceTypeConfig:output_type -> tfplugin5.ValidateResourceTypeConfig.Response
	92,  // 215: tfplugin5.Provider.ValidateDataSourceConfig:output_type -> tfplugin5.ValidateDataSourceConfig.Response
	83,  // 216: tfplugin5.Provider.UpgradeResourceState:output_type -> tfplugin5.UpgradeResourceState.Response
	85,  // 217: tfplugin5.Provider.GetResourceIdentitySchemas:output_type -> tfplugin5.GetResourceIdentitySchemas.Response
	88,  // 218: tfplugin5.Provider.UpgradeResourceIdentity:output_type -> tfplugin5.UpgradeResourceIdentity.Response
	96,  // 219: tfplugin5.Provider.Configure:output_type -> tfplugin5.Configure.Response
	98,  // 220: tfplugin5.Provider.ReadResource:output_type -> tfplugin5.ReadResource.Response
	100, // 221: tfplugin5.Provider.PlanResourceChange:output_type -> tfplugin5.PlanResourceChange.Response
	102, // 222: tfplugin5.Provider.ApplyResourceChange:output_type -> tfplugin5.ApplyResourceChange.Response
	105, // 223: tfplugin5.Provider.ImportResourceState:output_type -> tfplugin5.ImportResourceState.Response
	109, // 224: tfplugin5.Provider.MoveResourceState:output_type -> tfplugin5.MoveResourceState.Response
	111, // 225: tfplugin5.Provider.ReadDataSource:output_type -> tfplugin5.ReadDataSource.Response
	107, // 226: tfplugin5.Provider.GenerateResourceConfig:output_type -> tfplugin5.GenerateResourceConfig.Response
	94,  // 227: tfplugin5.Provider.ValidateEphemeralResourceConfig:output_type -> tfplugin5.ValidateEphemeralResourceConfig.Response
	119, // 228: tfplugin5.Provider.OpenEphemeralResource:output_type -> tfplugin5.OpenEphemeralResource.Response
	121, // 229: tfplugin5.Provider.RenewEphemeralResource:output_type -> tfplugin5.RenewEphemeralResource.Response
	123, // 230: tfplugin5.Provider.CloseEphemeralResource:output_type -> tfplugin5.CloseEphemeralResource.Response
	130, // 231: tfplugin5.Provider.ListResource:output_type -> tfplugin5.ListResource.Event
	132, // 232: tfplugin5.Provider.ValidateListResourceConfig:output_type -> tfplugin5.ValidateListResourceConfig.Response
	125, // 233: tfplugin5.Provider.GetFunctions:output_type -> tfplugin5.GetFunctions.Response
	128, // 234: tfplugin5.Provider.CallFunction:output_type -> tfplugin5.CallFunction.Response
	134, // 235: tfplugin5.Provider.PlanAction:output_type -> tfplugin5.PlanAction.Response
	138, // 236: tfplugin5.Provider.InvokeAction:output_type -> tfplugin5.InvokeAction.Event
	144, // 237: tfplugin5.Provider.ValidateActionConfig:output_type -> tfplugin5.ValidateActionConfig.Response
	52,  // 238: tfplugin5.Provider.Stop:output_type -> tfplugin5.Stop.Response
	113, // 239: tfplugin5.Provisioner.GetSchema:output_type -> tfplugin5.GetProvisionerSchema.Response
	115, // 240: tfplugin5.Provisioner.ValidateProvisionerConfig:output_type -> tfplugin5.ValidateProvisionerConfig.Response
	117, // 241: tfplugin5.Provisioner.ProvisionResource:output_type -> tfplugin5.ProvisionResource.Response
	52,  // 242: tfplugin5.Provisioner.Stop:output_type -> tfplugin5.Stop.Response
	211, // [211:243] is the sub-list for method output_type
	179, // [179:211] is the sub-list for method input_type
