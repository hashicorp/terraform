...
func (x *ImportResourceState_Request) GetConfig() *DynamicValue {
	if x != nil {
		return x.Config
	}
	return nil
...
type ImportResourceState_Response struct {
	...
	// Importing multiple resources in a single request is deprecated.
	// While the repeated field is maintained for backwards compatibility,
	// only a single instance is expected to be returned.
...
var file_tfplugin5_proto_rawDesc = []byte{
	...
	0x9e, 0x03, 0x0a, 0x13, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x1a, 0x67, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65,
...
var file_tfplugin5_proto_depIdxs = []int32{
	...
	3,  // 48: tfplugin5.ImportResourceState.Request.config:type_name -> tfplugin5.DynamicValue
	3,  // 49: tfplugin5.ImportResourceState.ImportedResource.state:type_name -> tfplugin5.DynamicValue
	52, // 50: tfplugin5.ImportResourceState.Response.imported_resources:type_name -> tfplugin5.ImportResourceState.ImportedResource
	4,  // 51: tfplugin5.ImportResourceState.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	3,  // 52: tfplugin5.ReadDataSource.Request.config:type_name -> tfplugin5.DynamicValue
	3,  // 53: tfplugin5.ReadDataSource.Request.provider_meta:type_name -> tfplugin5.DynamicValue
	3,  // 54: tfplugin5.ReadDataSource.Response.state:type_name -> tfplugin5.DynamicValue
	4,  // 55: tfplugin5.ReadDataSource.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	8,  // 56: tfplugin5.GetProvisionerSchema.Response.provisioner:type_name -> tfplugin5.Schema
	4,  // 57: tfplugin5.GetProvisionerSchema.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	3,  // 58: tfplugin5.ValidateProvisionerConfig.Request.config:type_name -> tfplugin5.DynamicValue
	4,  // 59: tfplugin5.ValidateProvisionerConfig.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	3,  // 60: tfplugin5.ProvisionResource.Request.config:type_name -> tfplugin5.DynamicValue
	3,  // 61: tfplugin5.ProvisionResource.Request.connection:type_name -> tfplugin5.DynamicValue
	4,  // 62: tfplugin5.ProvisionResource.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	30, // 63: tfplugin5.Provider.GetSchema:input_type -> tfplugin5.GetProviderSchema.Request
	35, // 64: tfplugin5.Provider.PrepareProviderConfig:input_type -> tfplugin5.PrepareProviderConfig.Request
	39, // 65: tfplugin5.Provider.ValidateResourceTypeConfig:input_type -> tfplugin5.ValidateResourceTypeConfig.Request
	41, // 66: tfplugin5.Provider.ValidateDataSourceConfig:input_type -> tfplugin5.ValidateDataSourceConfig.Request
	37, // 67: tfplugin5.Provider.UpgradeResourceState:input_type -> tfplugin5.UpgradeResourceState.Request
	43, // 68: tfplugin5.Provider.Configure:input_type -> tfplugin5.Configure.Request
	45, // 69: tfplugin5.Provider.ReadResource:input_type -> tfplugin5.ReadResource.Request
	47, // 70: tfplugin5.Provider.PlanResourceChange:input_type -> tfplugin5.PlanResourceChange.Request
	49, // 71: tfplugin5.Provider.ApplyResourceChange:input_type -> tfplugin5.ApplyResourceChange.Request
	51, // 72: tfplugin5.Provider.ImportResourceState:input_type -> tfplugin5.ImportResourceState.Request
	54, // 73: tfplugin5.Provider.ReadDataSource:input_type -> tfplugin5.ReadDataSource.Request
	24, // 74: tfplugin5.Provider.Stop:input_type -> tfplugin5.Stop.Request
	56, // 75: tfplugin5.Provisioner.GetSchema:input_type -> tfplugin5.GetProvisionerSchema.Request
	58, // 76: tfplugin5.Provisioner.ValidateProvisionerConfig:input_type -> tfplugin5.ValidateProvisionerConfig.Request
	60, // 77: tfplugin5.Provisioner.ProvisionResource:input_type -> tfplugin5.ProvisionResource.Request
	24, // 78: tfplugin5.Provisioner.Stop:input_type -> tfplugin5.Stop.Request
	31, // 79: tfplugin5.Provider.GetSchema:output_type -> tfplugin5.GetProviderSchema.Response
	36, // 80: tfplugin5.Provider.PrepareProviderConfig:output_type -> tfplugin5.PrepareProviderConfig.Response
	40, // 81: tfplugin5.Provider.ValidateResourceTypeConfig:output_type -> tfplugin5.ValidateResourceTypeConfig.Response
	42, // 82: tfplugin5.Provider.ValidateDataSourceConfig:output_type -> tfplugin5.ValidateDataSourceConfig.Response
	38, // 83: tfplugin5.Provider.UpgradeResourceState:output_type -> tfplugin5.UpgradeResourceState.Response
	44, // 84: tfplugin5.Provider.Configure:output_type -> tfplugin5.Configure.Response
	46, // 85: tfplugin5.Provider.ReadResource:output_type -> tfplugin5.ReadResource.Response
	48, // 86: tfplugin5.Provider.PlanResourceChange:output_type -> tfplugin5.PlanResourceChange.Response
	50, // 87: tfplugin5.Provider.ApplyResourceChange:output_type -> tfplugin5.ApplyResourceChange.Response
	53, // 88: tfplugin5.Provider.ImportResourceState:output_type -> tfplugin5.ImportResourceState.Response
	55, // 89: tfplugin5.Provider.ReadDataSource:output_type -> tfplugin5.ReadDataSource.Response
	25, // 90: tfplugin5.Provider.Stop:output_type -> tfplugin5.Stop.Response
	57, // 91: tfplugin5.Provisioner.GetSchema:output_type -> tfplugin5.GetProvisionerSchema.Response
	59, // 92: tfplugin5.Provisioner.ValidateProvisionerConfig:output_type -> tfplugin5.ValidateProvisionerConfig.Response
	61, // 93: tfplugin5.Provisioner.ProvisionResource:output_type -> tfplugin5.ProvisionResource.Response
	25, // 94: tfplugin5.Provisioner.Stop:output_type -> tfplugin5.Stop.Response
