...
type ActionSchema struct {
	...
	// Block is the top level configuration block for this schema.
	Block *Schema_Block `protobuf:"bytes,2,opt,name=block,proto3" json:"block,omitempty"`
	// LinkedResource is a list of resource that can be updated by the action.
	LinkedResources []*ActionSchema_LinkedResource `protobuf:"bytes,3,rep,name=linked_resources,json=linkedResources,proto3" json:"linked_resources,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ActionSchema) GetVersion() int64 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *ActionSchema) GetBlock() *Schema_Block {
	if x != nil {
		return x.Block
	}
	return nil
...
func (x *ActionSchema) GetLinkedResources() []*ActionSchema_LinkedResource {
	if x != nil {
...
func (x *ActionSchema_LinkedResource) GetAttribute() *AttributePath {
	if x != nil {
		return x.Attribute
	}
	return nil
...
func (x *ActionSchema_LinkedResource) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (*ActionSchema_LinkedResource_LinkedAttributes) Descriptor() ([]byte, []int) {
	return file_tfplugin5_proto_rawDescGZIP(), []int{12, 0, 0}
}
...
type GetProviderSchema_Response struct {
	...
	ActionSchemas            map[string]*ActionSchema `protobuf:"bytes,9,rep,name=action_schemas,json=actionSchemas,proto3" json:"action_schemas,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *PlanAction_Request) GetTypeName() string {
	if x != nil {
		return x.TypeName
	}
	return ""
...
type PlanAction_Response struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	Diagnostics []*Diagnostic          `protobuf:"bytes,1,rep,name=diagnostics,proto3" json:"diagnostics,omitempty"`
	// new_config is the passed in config with any changes made by the action.
	// The action schema contains links to the resources that are changed by the action and will
...
func (x *PlanAction_Response) GetNewConfig() *DynamicValue {
	if x != nil {
		return x.NewConfig
	}
	return nil
...
type InvokeAction_Request struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TypeName      string                 `protobuf:"bytes,1,opt,name=type_name,json=typeName,proto3" json:"type_name,omitempty"`
	PlannedConfig *DynamicValue          `protobuf:"bytes,2,opt,name=planned_config,json=plannedConfig,proto3" json:"planned_config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *InvokeAction_Request) GetTypeName() string {
	if x != nil {
		return x.TypeName
	}
	return ""
...
func (x *InvokeAction_Request) GetPlannedConfig() *DynamicValue {
	if x != nil {
		return x.PlannedConfig
	}
	return nil
}
...
func (x *InvokeAction_Event) GetEvent() isInvokeAction_Event_Event {
	if x != nil {
		return x.Event
	}
	return nil
...
func (x *InvokeAction_Event) GetStarted() *InvokeAction_Event_Started {
	if x != nil {
		if x, ok := x.Event.(*InvokeAction_Event_Started_); ok {
			return x.Started
		}
	}
	return nil
...
func (x *InvokeAction_Event) GetFinished() *InvokeAction_Event_Finished {
	if x != nil {
		if x, ok := x.Event.(*InvokeAction_Event_Finished_); ok {
			return x.Finished
		}
	}
	return nil
...
func (x *InvokeAction_Event) GetProgress() *InvokeAction_Event_Progress {
	if x != nil {
		if x, ok := x.Event.(*InvokeAction_Event_Progress_); ok {
			return x.Progress
		}
	}
	return nil
...
type isInvokeAction_Event_Event interface {
	isInvokeAction_Event_Event()
}

type InvokeAction_Event_Started_ struct {
	Started *InvokeAction_Event_Started `protobuf:"bytes,1,opt,name=started,proto3,oneof"`
}

type InvokeAction_Event_Finished_ struct {
...
type InvokeAction_Event_Progress_ struct {
	Progress *InvokeAction_Event_Progress `protobuf:"bytes,3,opt,name=progress,proto3,oneof"`
}
...
func (*InvokeAction_Event_Progress_) isInvokeAction_Event_Event() {}
...
func (x *InvokeAction_Event_Started) Reset() {
	*x = InvokeAction_Event_Started{}
	mi := &file_tfplugin5_proto_msgTypes[117]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InvokeAction_Event_Started) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InvokeAction_Event_Started) ProtoMessage() {}

func (x *InvokeAction_Event_Started) ProtoReflect() protoreflect.Message {
	mi := &file_tfplugin5_proto_msgTypes[117]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InvokeAction_Event_Started.ProtoReflect.Descriptor instead.
func (*InvokeAction_Event_Started) Descriptor() ([]byte, []int) {
	return file_tfplugin5_proto_rawDescGZIP(), []int{39, 1, 0}
}

func (x *InvokeAction_Event_Started) GetCancellationToken() string {
	if x != nil {
...
type InvokeAction_Event_Finished struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The action schema contains links to the resources that are changed by the action and
	// will change as a result of this.
	NewConfig     *DynamicValue `protobuf:"bytes,1,opt,name=new_config,json=newConfig,proto3" json:"new_config,omitempty"`
...
func (x *InvokeAction_Event_Finished) Reset() {
	*x = InvokeAction_Event_Finished{}
	mi := &file_tfplugin5_proto_msgTypes[118]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InvokeAction_Event_Finished) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InvokeAction_Event_Finished) ProtoMessage() {}

func (x *InvokeAction_Event_Finished) ProtoReflect() protoreflect.Message {
	mi := &file_tfplugin5_proto_msgTypes[118]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InvokeAction_Event_Finished.ProtoReflect.Descriptor instead.
func (*InvokeAction_Event_Finished) Descriptor() ([]byte, []int) {
	return file_tfplugin5_proto_rawDescGZIP(), []int{39, 1, 1}
}
...
func (x *InvokeAction_Event_Finished) GetCancelled() bool {
	if x != nil {
		return x.Cancelled
	}
	return false
...
func (*InvokeAction_Event_Progress) Descriptor() ([]byte, []int) {
	return file_tfplugin5_proto_rawDescGZIP(), []int{39, 1, 2}
}
...
func (x *InvokeAction_Event_Progress) GetStderr() []string {
	if x != nil {
		return x.Stderr
	}
	return nil
...
type CancelAction_Request struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	TypeName          string                 `protobuf:"bytes,1,opt,name=type_name,json=typeName,proto3" json:"type_name,omitempty"`
	CancellationToken string                 `protobuf:"bytes,2,opt,name=cancellation_token,json=cancellationToken,proto3" json:"cancellation_token,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *CancelAction_Request) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use CancelAction_Request.ProtoReflect.Descriptor instead.
func (*CancelAction_Request) Descriptor() ([]byte, []int) {
	return file_tfplugin5_proto_rawDescGZIP(), []int{40, 0}
}

func (x *CancelAction_Request) GetTypeName() string {
	if x != nil {
		return x.TypeName
	}
	return ""
...
func (x *CancelAction_Request) GetCancellationToken() string {
	if x != nil {
		return x.CancellationToken
	}
	return ""
...
type CancelAction_Response struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Diagnostics   []*Diagnostic          `protobuf:"bytes,1,rep,name=diagnostics,proto3" json:"diagnostics,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *CancelAction_Response) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use CancelAction_Response.ProtoReflect.Descriptor instead.
func (*CancelAction_Response) Descriptor() ([]byte, []int) {
	return file_tfplugin5_proto_rawDescGZIP(), []int{40, 1}
}

func (x *CancelAction_Response) GetDiagnostics() []*Diagnostic {
	if x != nil {
		return x.Diagnostics
	}
	return nil
...
var file_tfplugin5_proto_rawDesc = string([]byte{
	...
	,
	...
	,
	...
	0x61, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x22, 0xa2, 0x01, 0x0a, 0x08, 0x44, 0x65,
	...
	0x42, 0x53, 0x45, 0x4e, 0x54, 0x5f, 0x50, 0x52, 0x45, 0x52, 0x45, 0x51, 0x10, 0x03, 0x22, 0xa3,
	0x05, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x1a, 0x09,
	0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0xca, 0x03, 0x0a, 0x08, 0x52, 0x65,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x30, 0x0a, 0x11, 0x45, 0x70, 0x68, 0x65, 0x6d, 0x65,
	0x72, 0x61, 0x6c, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1b, 0x0a, 0x09, 0x74,
	0x79, 0x70, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x74, 0x79, 0x70, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0x26, 0x0a, 0x10, 0x46, 0x75, 0x6e, 0x63,
	...
	0x4e, 0x61, 0x6d, 0x65, 0x22, 0xe7, 0x09, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x76,
	0x69, 0x64, 0x65, 0x72, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x1a, 0x09, 0x0a, 0x07, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0xc6, 0x09, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x73, 0x12, 0x52, 0x0a, 0x09, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69,
	...
	0x43, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x47, 0x65, 0x74, 0x50,
	...
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x73, 0x12, 0x5f,
	0x0a, 0x0e, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x73,
	0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x38, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69,
	0x6e, 0x35, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x53, 0x63,
	0x68, 0x65, 0x6d, 0x61, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x41, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79,
	0x52, 0x0d, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x73, 0x12,
	...
	0x02, 0x38, 0x01, 0x1a, 0x59, 0x0a, 0x12, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x63, 0x68,
	...
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x74, 0x66, 0x70,
	0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x63, 0x68,
	0x65, 0x6d, 0x61, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xdb,
	...
	,
	...
	0x65, 0x0a, 0x14, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x53, 0x63, 0x68, 0x65, 0x6d,
	...
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa7, 0x02, 0x0a, 0x17, 0x55, 0x70, 0x67, 0x72, 0x61,
	0x64, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69,
	0x74, 0x79, 0x1a, 0x78, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x12, 0x36, 0x0a, 0x0c, 0x72, 0x61, 0x77, 0x5f, 0x69, 0x64, 0x65, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x74, 0x66, 0x70,
	0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x52, 0x61, 0x77, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52,
	...
	0x22, 0x8b, 0x02, 0x0a, 0x1a, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73,
	...
	0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x73, 0x22, 0xbf, 0x01, 0x0a, 0x1f, 0x56, 0x61,
	...
	0x64, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x73, 0x22, 0x8a, 0x02, 0x0a, 0x09,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x65, 0x1a, 0xb7, 0x01, 0x0a, 0x07, 0x52, 0x65,
	...
	0x66, 0x69, 0x67, 0x12, 0x4e, 0x0a, 0x13, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x63, 0x61,
	...
	0x69, 0x65, 0x73, 0x1a, 0x43, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x37, 0x0a, 0x0b, 0x64, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35,
	0x2e, 0x44, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x52, 0x0b, 0x64, 0x69, 0x61,
	0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x73, 0x22, 0xf4, 0x04, 0x0a, 0x0c, 0x52, 0x65, 0x61,
	0x64, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x1a, 0xd8, 0x02, 0x0a, 0x07, 0x52, 0x65,
	...
	0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e,
	...
	0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x12, 0x4a, 0x0a, 0x10, 0x63, 0x75, 0x72, 0x72,
	0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x06, 0x20, 0x01,
	...
	0x61, 0x74, 0x61, 0x52, 0x0f, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x65, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x1a, 0x88, 0x02, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x64, 0x52, 0x08, 0x64, 0x65, 0x66, 0x65, 0x72, 0x72, 0x65, 0x64, 0x12, 0x42, 0x0a, 0x0c, 0x6e,
	...
	0x87, 0x07, 0x0a, 0x12, 0x50, 0x6c, 0x61, 0x6e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x1a, 0xd3, 0x03, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x35, 0x2e, 0x44, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x10,
	...
	,
	...
	0x63, 0x79, 0x54, 0x79, 0x70, 0x65, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x12, 0x2f, 0x0a, 0x08,
	0x64, 0x65, 0x66, 0x65, 0x72, 0x72, 0x65, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13,
	0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x44, 0x65, 0x66, 0x65, 0x72,
	0x72, 0x65, 0x64, 0x52, 0x08, 0x64, 0x65, 0x66, 0x65, 0x72, 0x72, 0x65, 0x64, 0x12, 0x4a, 0x0a,
	...
	0x64, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0xa2, 0x05, 0x0a, 0x13, 0x41, 0x70,
	0x70, 0x6c, 0x79, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67,
	0x65, 0x1a, 0x82, 0x03, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a,
	0x09, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	...
	0x61, 0x6e, 0x6e, 0x65, 0x64, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x12, 0x3c, 0x0a, 0x0d,
	...
	0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x4d, 0x65, 0x74, 0x61, 0x12, 0x4a, 0x0a, 0x10, 0x70, 0x6c,
	...
	0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x1a, 0x85, 0x02, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x08, 0x6e, 0x65, 0x77, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x72, 0x69,
	...
	0x63, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75,
	0x67, 0x69, 0x6e, 0x35, 0x2e, 0x44, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x52,
	...
	0x65, 0x6d, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x6c, 0x65, 0x67, 0x61, 0x63, 0x79,
	0x54, 0x79, 0x70, 0x65, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x12, 0x42, 0x0a, 0x0c, 0x6e, 0x65,
	0x77, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	...
	0x61, 0x52, 0x0b, 0x6e, 0x65, 0x77, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0xea,
	0x04, 0x0a, 0x13, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x1a, 0xc3, 0x01, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x79, 0x70, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12,
	...
	0x0b, 0x32, 0x1f, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x52, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x44, 0x61,
	0x74, 0x61, 0x52, 0x08, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x1a, 0xb5, 0x01, 0x0a,
	...
	0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x12, 0x3b, 0x0a, 0x08, 0x69, 0x64, 0x65, 0x6e, 0x74,
	...
	0x74, 0x69, 0x74, 0x79, 0x1a, 0xd4, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x5e, 0x0a, 0x12, 0x69, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x5f, 0x72, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e,
	0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x49, 0x6d,
	0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x11,
	0x69, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	,
	...
	,
	...
	0x74, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x12, 0x48, 0x0a, 0x0f, 0x74, 0x61, 0x72, 0x67,
	0x65, 0x74, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x1f, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x52, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x44, 0x61,
	0x74, 0x61, 0x52, 0x0e, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69,
	0x74, 0x79, 0x22, 0x9e, 0x03, 0x0a, 0x0e, 0x52, 0x65, 0x61, 0x64, 0x44, 0x61, 0x74, 0x61, 0x53,
	...
	0x69, 0x63, 0x73, 0x22, 0x81, 0x02, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x46, 0x75, 0x6e, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x09, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0xe5, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4d, 0x0a, 0x09,
	0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x2f, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x47, 0x65, 0x74, 0x46,
	...
	0x52, 0x09, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x37, 0x0a, 0x0b, 0x64,
	...
	,
	...
	,
	...
	0x73, 0x73, 0x1a, 0x71, 0x0a, 0x07, 0x53, 0x74, 0x61, 0x72, 0x74, 0x65, 0x64, 0x12, 0x2d, 0x0a,
	0x12, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x6f,
	0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x63, 0x61, 0x6e, 0x63, 0x65,
	0x6c, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x37, 0x0a, 0x0b,
	...
	,
	...
	,
	...
	0x4e, 0x10, 0x01, 0x32, 0xaf, 0x13, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72,
	0x12, 0x4e, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12,
	0x1e, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x47, 0x65, 0x74, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x1f, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x47, 0x65, 0x74, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x58, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x24, 0x2e,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x29, 0x2e,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x75, 0x0a, 0x18, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74,
	0x65, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x12, 0x2b, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x56, 0x61,
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2c,
	...
	0x35, 0x2e, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x65,
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x73, 0x2e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x2e, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x72, 0x0a, 0x17, 0x55, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x52,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12,
	0x2a, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x55, 0x70, 0x67, 0x72,
	0x61, 0x64, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x65, 0x6e, 0x74,
	0x69, 0x74, 0x79, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2b, 0x2e, 0x74, 0x66,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x48, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x75, 0x72, 0x65, 0x12, 0x1c, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e,
	0x35, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x65, 0x2e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e,
	...
	0x63, 0x65, 0x12, 0x1f, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x52,
	0x65, 0x61, 0x64, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e,
	...
	0x73, 0x74, 0x1a, 0x26, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x50,
	...
	0x70, 0x6c, 0x79, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67,
	0x65, 0x12, 0x26, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x41, 0x70,
	0x70, 0x6c, 0x79, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67,
	0x65, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x27, 0x2e, 0x74, 0x66, 0x70, 0x6c,
	0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x52, 0x65, 0x73, 0x6f, 0x75,
	...
	0x74, 0x1a, 0x27, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x49, 0x6d,
	...
	0x24, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x4d, 0x6f, 0x76, 0x65,
	...
	0x74, 0x1a, 0x22, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x35, 0x2e, 0x52, 0x65,
	0x61, 0x64, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x8a, 0x01, 0x0a, 0x1f, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61,
	0x74, 0x65, 0x45, 0x70, 0x68, 0x65, 0x6d, 0x65, 0x72, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x32, 0x2e, 0x74, 0x66, 0x70, 0x6c,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x33, 0x2e,
	...
	0x73, 0x65, 0x12, 0x6c, 0x0a, 0x15, 0x4f, 0x70, 0x65, 0x6e, 0x45, 0x70, 0x68, 0x65, 0x6d, 0x65,
	0x72, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x28, 0x2e, 0x74, 0x66,
	...
	0x12, 0x6f, 0x0a, 0x16, 0x52, 0x65, 0x6e, 0x65, 0x77, 0x45, 0x70, 0x68, 0x65, 0x6d, 0x65, 0x72,
	...
	0x35, 0x2e, 0x52, 0x65, 0x6e, 0x65, 0x77, 0x45, 0x70, 0x68, 0x65, 0x6d, 0x65, 0x72, 0x61, 0x6c,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x6f, 0x0a, 0x16, 0x43, 0x6c, 0x6f, 0x73, 0x65, 0x45, 0x70, 0x68, 0x65, 0x6d, 0x65,
	0x72, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x29, 0x2e, 0x74, 0x66,
	...
	,
	...
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x30, 0x01, 0x12, 0x51, 0x0a, 0x0c, 0x43, 0x61, 0x6e, 0x63, 0x65,
	0x6c, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1f, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67,
	0x69, 0x6e, 0x35, 0x2e, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75,
	0x67, 0x69, 0x6e, 0x35, 0x2e, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x41, 0x63, 0x74, 0x69, 0x6f,
...
var file_tfplugin5_proto_msgTypes = make([]protoimpl.MessageInfo, 122)
var file_tfplugin5_proto_goTypes = []any{
	...
	(*MoveResourceState)(nil),                            // 32: tfplugin5.MoveResourceState
	(*ReadDataSource)(nil),                               // 33: tfplugin5.ReadDataSource
	(*GetProvisionerSchema)(nil),                         // 34: tfplugin5.GetProvisionerSchema
	(*ValidateProvisionerConfig)(nil),                    // 35: tfplugin5.ValidateProvisionerConfig
	(*ProvisionResource)(nil),                            // 36: tfplugin5.ProvisionResource
	...
	(*GetFunctions)(nil),                                 // 40: tfplugin5.GetFunctions
	(*CallFunction)(nil),                                 // 41: tfplugin5.CallFunction
	(*PlanAction)(nil),                                   // 42: tfplugin5.PlanAction
	(*InvokeAction)(nil),                                 // 43: tfplugin5.InvokeAction
	(*CancelAction)(nil),                                 // 44: tfplugin5.CancelAction
	(*AttributePath_Step)(nil),                           // 45: tfplugin5.AttributePath.Step
	(*Stop_Request)(nil),                                 // 46: tfplugin5.Stop.Request
	(*Stop_Response)(nil),                                // 47: tfplugin5.Stop.Response
	nil,                                                  // 48: tfplugin5.RawState.FlatmapEntry
	(*ResourceIdentitySchema_IdentityAttribute)(nil),     // 49: tfplugin5.ResourceIdentitySchema.IdentityAttribute
	(*Schema_Block)(nil),                                 // 50: tfplugin5.Schema.Block
	(*Schema_Attribute)(nil),                             // 51: tfplugin5.Schema.Attribute
	(*Schema_NestedBlock)(nil),                           // 52: tfplugin5.Schema.NestedBlock
	(*Function_Parameter)(nil),                           // 53: tfplugin5.Function.Parameter
	(*Function_Return)(nil),                              // 54: tfplugin5.Function.Return
	(*ActionSchema_LinkedResource)(nil),                  // 55: tfplugin5.ActionSchema.LinkedResource
	(*ActionSchema_LinkedResource_LinkedAttributes)(nil), // 56: tfplugin5.ActionSchema.LinkedResource.LinkedAttributes
	(*GetMetadata_Request)(nil),                          // 57: tfplugin5.GetMetadata.Request
	(*GetMetadata_Response)(nil),                         // 58: tfplugin5.GetMetadata.Response
	(*GetMetadata_EphemeralMetadata)(nil),                // 59: tfplugin5.GetMetadata.EphemeralMetadata
	...
	(*GetProviderSchema_Request)(nil),                    // 63: tfplugin5.GetProviderSchema.Request
	(*GetProviderSchema_Response)(nil),                   // 64: tfplugin5.GetProviderSchema.Response
	nil,                                                  // 65: tfplugin5.GetProviderSchema.Response.ResourceSchemasEntry
	nil,                                                  // 66: tfplugin5.GetProviderSchema.Response.DataSourceSchemasEntry
	nil,                                                  // 67: tfplugin5.GetProviderSchema.Response.FunctionsEntry
	nil,                                                  // 68: tfplugin5.GetProviderSchema.Response.EphemeralResourceSchemasEntry
	nil,                                                  // 69: tfplugin5.GetProviderSchema.Response.ActionSchemasEntry
	(*PrepareProviderConfig_Request)(nil),                // 70: tfplugin5.PrepareProviderConfig.Request
	(*PrepareProviderConfig_Response)(nil),               // 71: tfplugin5.PrepareProviderConfig.Response
	(*UpgradeResourceState_Request)(nil),                 // 72: tfplugin5.UpgradeResourceState.Request
	(*UpgradeResourceState_Response)(nil),                // 73: tfplugin5.UpgradeResourceState.Response
	(*GetResourceIdentitySchemas_Request)(nil),           // 74: tfplugin5.GetResourceIdentitySchemas.Request
	(*GetResourceIdentitySchemas_Response)(nil),          // 75: tfplugin5.GetResourceIdentitySchemas.Response
	nil,                                      // 76: tfplugin5.GetResourceIdentitySchemas.Response.IdentitySchemasEntry
	(*UpgradeResourceIdentity_Request)(nil),  // 77: tfplugin5.UpgradeResourceIdentity.Request
	(*UpgradeResourceIdentity_Response)(nil), // 78: tfplugin5.UpgradeResourceIdentity.Response
	(*ValidateResourceTypeConfig_Request)(nil),       // 79: tfplugin5.ValidateResourceTypeConfig.Request
	(*ValidateResourceTypeConfig_Response)(nil),      // 80: tfplugin5.ValidateResourceTypeConfig.Response
	(*ValidateDataSourceConfig_Request)(nil),         // 81: tfplugin5.ValidateDataSourceConfig.Request
	(*ValidateDataSourceConfig_Response)(nil),        // 82: tfplugin5.ValidateDataSourceConfig.Response
	(*ValidateEphemeralResourceConfig_Request)(nil),  // 83: tfplugin5.ValidateEphemeralResourceConfig.Request
	(*ValidateEphemeralResourceConfig_Response)(nil), // 84: tfplugin5.ValidateEphemeralResourceConfig.Response
	(*Configure_Request)(nil),                        // 85: tfplugin5.Configure.Request
	(*Configure_Response)(nil),                       // 86: tfplugin5.Configure.Response
	(*ReadResource_Request)(nil),                     // 87: tfplugin5.ReadResource.Request
	(*ReadResource_Response)(nil),                    // 88: tfplugin5.ReadResource.Response
	(*PlanResourceChange_Request)(nil),               // 89: tfplugin5.PlanResourceChange.Request
	(*PlanResourceChange_Response)(nil),              // 90: tfplugin5.PlanResourceChange.Response
	(*ApplyResourceChange_Request)(nil),              // 91: tfplugin5.ApplyResourceChange.Request
	(*ApplyResourceChange_Response)(nil),             // 92: tfplugin5.ApplyResourceChange.Response
	(*ImportResourceState_Request)(nil),              // 93: tfplugin5.ImportResourceState.Request
	(*ImportResourceState_ImportedResource)(nil),     // 94: tfplugin5.ImportResourceState.ImportedResource
	(*ImportResourceState_Response)(nil),             // 95: tfplugin5.ImportResourceState.Response
	(*MoveResourceState_Request)(nil),                // 96: tfplugin5.MoveResourceState.Request
	(*MoveResourceState_Response)(nil),               // 97: tfplugin5.MoveResourceState.Response
	(*ReadDataSource_Request)(nil),                   // 98: tfplugin5.ReadDataSource.Request
	(*ReadDataSource_Response)(nil),                  // 99: tfplugin5.ReadDataSource.Response
	(*GetProvisionerSchema_Request)(nil),             // 100: tfplugin5.GetProvisionerSchema.Request
	(*GetProvisionerSchema_Response)(nil),            // 101: tfplugin5.GetProvisionerSchema.Response
	(*ValidateProvisionerConfig_Request)(nil),        // 102: tfplugin5.ValidateProvisionerConfig.Request
	(*ValidateProvisionerConfig_Response)(nil),       // 103: tfplugin5.ValidateProvisionerConfig.Response
	(*ProvisionResource_Request)(nil),                // 104: tfplugin5.ProvisionResource.Request
	(*ProvisionResource_Response)(nil),               // 105: tfplugin5.ProvisionResource.Response
	(*OpenEphemeralResource_Request)(nil),            // 106: tfplugin5.OpenEphemeralResource.Request
	(*OpenEphemeralResource_Response)(nil),           // 107: tfplugin5.OpenEphemeralResource.Response
	(*RenewEphemeralResource_Request)(nil),           // 108: tfplugin5.RenewEphemeralResource.Request
	(*RenewEphemeralResource_Response)(nil),          // 109: tfplugin5.RenewEphemeralResource.Response
	(*CloseEphemeralResource_Request)(nil),           // 110: tfplugin5.CloseEphemeralResource.Request
	(*CloseEphemeralResource_Response)(nil),          // 111: tfplugin5.CloseEphemeralResource.Response
	(*GetFunctions_Request)(nil),                     // 112: tfplugin5.GetFunctions.Request
	(*GetFunctions_Response)(nil),                    // 113: tfplugin5.GetFunctions.Response
	nil,                                              // 114: tfplugin5.GetFunctions.Response.FunctionsEntry
	(*CallFunction_Request)(nil),                     // 115: tfplugin5.CallFunction.Request
	(*CallFunction_Response)(nil),                    // 116: tfplugin5.CallFunction.Response
	(*PlanAction_Request)(nil),                       // 117: tfplugin5.PlanAction.Request
	(*PlanAction_Response)(nil),                      // 118: tfplugin5.PlanAction.Response
	(*InvokeAction_Request)(nil),                     // 119: tfplugin5.InvokeAction.Request
	(*InvokeAction_Event)(nil),                       // 120: tfplugin5.InvokeAction.Event
	(*InvokeAction_Event_Started)(nil),               // 121: tfplugin5.InvokeAction.Event.Started
	(*InvokeAction_Event_Finished)(nil),              // 122: tfplugin5.InvokeAction.Event.Finished
	(*InvokeAction_Event_Progress)(nil),              // 123: tfplugin5.InvokeAction.Event.Progress
	(*CancelAction_Request)(nil),                     // 124: tfplugin5.CancelAction.Request
	(*CancelAction_Response)(nil),                    // 125: tfplugin5.CancelAction.Response
...
var file_tfplugin5_proto_depIdxs = []int32{
	...
	45,  // 2: tfplugin5.AttributePath.steps:type_name -> tfplugin5.AttributePath.Step
	48,  // 3: tfplugin5.RawState.flatmap:type_name -> tfplugin5.RawState.FlatmapEntry
	49,  // 4: tfplugin5.ResourceIdentitySchema.identity_attributes:type_name -> tfplugin5.ResourceIdentitySchema.IdentityAttribute
	4,   // 5: tfplugin5.ResourceIdentityData.identity_data:type_name -> tfplugin5.DynamicValue
	50,  // 6: tfplugin5.Schema.block:type_name -> tfplugin5.Schema.Block
	53,  // 7: tfplugin5.Function.parameters:type_name -> tfplugin5.Function.Parameter
	53,  // 8: tfplugin5.Function.variadic_parameter:type_name -> tfplugin5.Function.Parameter
	54,  // 9: tfplugin5.Function.return:type_name -> tfplugin5.Function.Return
	0,   // 10: tfplugin5.Function.description_kind:type_name -> tfplugin5.StringKind
	50,  // 11: tfplugin5.ActionSchema.block:type_name -> tfplugin5.Schema.Block
	55,  // 12: tfplugin5.ActionSchema.linked_resources:type_name -> tfplugin5.ActionSchema.LinkedResource
	3,   // 13: tfplugin5.Deferred.reason:type_name -> tfplugin5.Deferred.Reason
	51,  // 14: tfplugin5.Schema.Block.attributes:type_name -> tfplugin5.Schema.Attribute
	52,  // 15: tfplugin5.Schema.Block.block_types:type_name -> tfplugin5.Schema.NestedBlock
	0,   // 16: tfplugin5.Schema.Block.description_kind:type_name -> tfplugin5.StringKind
	0,   // 17: tfplugin5.Schema.Attribute.description_kind:type_name -> tfplugin5.StringKind
	50,  // 18: tfplugin5.Schema.NestedBlock.block:type_name -> tfplugin5.Schema.Block
	2,   // 19: tfplugin5.Schema.NestedBlock.nesting:type_name -> tfplugin5.Schema.NestedBlock.NestingMode
	0,   // 20: tfplugin5.Function.Parameter.description_kind:type_name -> tfplugin5.StringKind
	7,   // 21: tfplugin5.ActionSchema.LinkedResource.attribute:type_name -> tfplugin5.AttributePath
	56,  // 22: tfplugin5.ActionSchema.LinkedResource.linked_attributes:type_name -> tfplugin5.ActionSchema.LinkedResource.LinkedAttributes
	7,   // 23: tfplugin5.ActionSchema.LinkedResource.LinkedAttributes.attribute:type_name -> tfplugin5.AttributePath
	13,  // 24: tfplugin5.GetMetadata.Response.server_capabilities:type_name -> tfplugin5.ServerCapabilities
	5,   // 25: tfplugin5.GetMetadata.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	61,  // 26: tfplugin5.GetMetadata.Response.data_sources:type_name -> tfplugin5.GetMetadata.DataSourceMetadata
	62,  // 27: tfplugin5.GetMetadata.Response.resources:type_name -> tfplugin5.GetMetadata.ResourceMetadata
	60,  // 28: tfplugin5.GetMetadata.Response.functions:type_name -> tfplugin5.GetMetadata.FunctionMetadata
	59,  // 29: tfplugin5.GetMetadata.Response.ephemeral_resources:type_name -> tfplugin5.GetMetadata.EphemeralMetadata
	12,  // 30: tfplugin5.GetProviderSchema.Response.provider:type_name -> tfplugin5.Schema
	65,  // 31: tfplugin5.GetProviderSchema.Response.resource_schemas:type_name -> tfplugin5.GetProviderSchema.Response.ResourceSchemasEntry
	66,  // 32: tfplugin5.GetProviderSchema.Response.data_source_schemas:type_name -> tfplugin5.GetProviderSchema.Response.DataSourceSchemasEntry
	67,  // 33: tfplugin5.GetProviderSchema.Response.functions:type_name -> tfplugin5.GetProviderSchema.Response.FunctionsEntry
	68,  // 34: tfplugin5.GetProviderSchema.Response.ephemeral_resource_schemas:type_name -> tfplugin5.GetProviderSchema.Response.EphemeralResourceSchemasEntry
	69,  // 35: tfplugin5.GetProviderSchema.Response.action_schemas:type_name -> tfplugin5.GetProviderSchema.Response.ActionSchemasEntry
	5,   // 36: tfplugin5.GetProviderSchema.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	12,  // 37: tfplugin5.GetProviderSchema.Response.provider_meta:type_name -> tfplugin5.Schema
	13,  // 38: tfplugin5.GetProviderSchema.Response.server_capabilities:type_name -> tfplugin5.ServerCapabilities
	12,  // 39: tfplugin5.GetProviderSchema.Response.ResourceSchemasEntry.value:type_name -> tfplugin5.Schema
	12,  // 40: tfplugin5.GetProviderSchema.Response.DataSourceSchemasEntry.value:type_name -> tfplugin5.Schema
	15,  // 41: tfplugin5.GetProviderSchema.Response.FunctionsEntry.value:type_name -> tfplugin5.Function
	12,  // 42: tfplugin5.GetProviderSchema.Response.EphemeralResourceSchemasEntry.value:type_name -> tfplugin5.Schema
	...
	76,  // 50: tfplugin5.GetResourceIdentitySchemas.Response.identity_schemas:type_name -> tfplugin5.GetResourceIdentitySchemas.Response.IdentitySchemasEntry
	...
	14,  // 57: tfplugin5.ValidateResourceTypeConfig.Request.client_capabilities:type_name -> tfplugin5.ClientCapabilities
	...
	14,  // 64: tfplugin5.Configure.Request.client_capabilities:type_name -> tfplugin5.ClientCapabilities
	...
	14,  // 68: tfplugin5.ReadResource.Request.client_capabilities:type_name -> tfplugin5.ClientCapabilities
	...
	14,  // 78: tfplugin5.PlanResourceChange.Request.client_capabilities:type_name -> tfplugin5.ClientCapabilities
	...
	14,  // 93: tfplugin5.ImportResourceState.Request.client_capabilities:type_name -> tfplugin5.ClientCapabilities
	...
	94,  // 97: tfplugin5.ImportResourceState.Response.imported_resources:type_name -> tfplugin5.ImportResourceState.ImportedResource
	...
	9,   // 100: tfplugin5.MoveResourceState.Request.source_state:type_name -> tfplugin5.RawState
	9,   // 101: tfplugin5.MoveResourceState.Request.source_identity:type_name -> tfplugin5.RawState
	4,   // 102: tfplugin5.MoveResourceState.Response.target_state:type_name -> tfplugin5.DynamicValue
	5,   // 103: tfplugin5.MoveResourceState.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	11,  // 104: tfplugin5.MoveResourceState.Response.target_identity:type_name -> tfplugin5.ResourceIdentityData
	4,   // 105: tfplugin5.ReadDataSource.Request.config:type_name -> tfplugin5.DynamicValue
	4,   // 106: tfplugin5.ReadDataSource.Request.provider_meta:type_name -> tfplugin5.DynamicValue
	14,  // 107: tfplugin5.ReadDataSource.Request.client_capabilities:type_name -> tfplugin5.ClientCapabilities
	4,   // 108: tfplugin5.ReadDataSource.Response.state:type_name -> tfplugin5.DynamicValue
	5,   // 109: tfplugin5.ReadDataSource.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	17,  // 110: tfplugin5.ReadDataSource.Response.deferred:type_name -> tfplugin5.Deferred
	12,  // 111: tfplugin5.GetProvisionerSchema.Response.provisioner:type_name -> tfplugin5.Schema
	5,   // 112: tfplugin5.GetProvisionerSchema.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	4,   // 113: tfplugin5.ValidateProvisionerConfig.Request.config:type_name -> tfplugin5.DynamicValue
	5,   // 114: tfplugin5.ValidateProvisionerConfig.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	4,   // 115: tfplugin5.ProvisionResource.Request.config:type_name -> tfplugin5.DynamicValue
	4,   // 116: tfplugin5.ProvisionResource.Request.connection:type_name -> tfplugin5.DynamicValue
	5,   // 117: tfplugin5.ProvisionResource.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	...
	126, // 121: tfplugin5.OpenEphemeralResource.Response.renew_at:type_name -> google.protobuf.Timestamp
	...
	126, // 125: tfplugin5.RenewEphemeralResource.Response.renew_at:type_name -> google.protobuf.Timestamp
	5,   // 126: tfplugin5.CloseEphemeralResource.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	114, // 127: tfplugin5.GetFunctions.Response.functions:type_name -> tfplugin5.GetFunctions.Response.FunctionsEntry
	5,   // 128: tfplugin5.GetFunctions.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	15,  // 129: tfplugin5.GetFunctions.Response.FunctionsEntry.value:type_name -> tfplugin5.Function
	4,   // 130: tfplugin5.CallFunction.Request.arguments:type_name -> tfplugin5.DynamicValue
	4,   // 131: tfplugin5.CallFunction.Response.result:type_name -> tfplugin5.DynamicValue
	6,   // 132: tfplugin5.CallFunction.Response.error:type_name -> tfplugin5.FunctionError
	4,   // 133: tfplugin5.PlanAction.Request.config:type_name -> tfplugin5.DynamicValue
	5,   // 134: tfplugin5.PlanAction.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	4,   // 135: tfplugin5.PlanAction.Response.new_config:type_name -> tfplugin5.DynamicValue
	4,   // 136: tfplugin5.InvokeAction.Request.planned_config:type_name -> tfplugin5.DynamicValue
	121, // 137: tfplugin5.InvokeAction.Event.started:type_name -> tfplugin5.InvokeAction.Event.Started
	122, // 138: tfplugin5.InvokeAction.Event.finished:type_name -> tfplugin5.InvokeAction.Event.Finished
	123, // 139: tfplugin5.InvokeAction.Event.progress:type_name -> tfplugin5.InvokeAction.Event.Progress
	5,   // 140: tfplugin5.InvokeAction.Event.Started.diagnostics:type_name -> tfplugin5.Diagnostic
	4,   // 141: tfplugin5.InvokeAction.Event.Finished.new_config:type_name -> tfplugin5.DynamicValue
	5,   // 142: tfplugin5.InvokeAction.Event.Finished.diagnostics:type_name -> tfplugin5.Diagnostic
	5,   // 143: tfplugin5.InvokeAction.Event.Progress.diagnostics:type_name -> tfplugin5.Diagnostic
	5,   // 144: tfplugin5.CancelAction.Response.diagnostics:type_name -> tfplugin5.Diagnostic
	57,  // 145: tfplugin5.Provider.GetMetadata:input_type -> tfplugin5.GetMetadata.Request
	63,  // 146: tfplugin5.Provider.GetSchema:input_type -> tfplugin5.GetProviderSchema.Request
	70,  // 147: tfplugin5.Provider.PrepareProviderConfig:input_type -> tfplugin5.PrepareProviderConfig.Request
	79,  // 148: tfplugin5.Provider.ValidateResourceTypeConfig:input_type -> tfplugin5.ValidateResourceTypeConfig.Request
	81,  // 149: tfplugin5.Provider.ValidateDataSourceConfig:input_type -> tfplugin5.ValidateDataSourceConfig.Request
	72,  // 150: tfplugin5.Provider.UpgradeResourceState:input_type -> tfplugin5.UpgradeResourceState.Request
	74,  // 151: tfplugin5.Provider.GetResourceIdentitySchemas:input_type -> tfplugin5.GetResourceIdentitySchemas.Request
	77,  // 152: tfplugin5.Provider.UpgradeResourceIdentity:input_type -> tfplugin5.UpgradeResourceIdentity.Request
	85,  // 153: tfplugin5.Provider.Configure:input_type -> tfplugin5.Configure.Request
	87,  // 154: tfplugin5.Provider.ReadResource:input_type -> tfplugin5.ReadResource.Request
	89,  // 155: tfplugin5.Provider.PlanResourceChange:input_type -> tfplugin5.PlanResourceChange.Request
	91,  // 156: tfplugin5.Provider.ApplyResourceChange:input_type -> tfplugin5.ApplyResourceChange.Request
	93,  // 157: tfplugin5.Provider.ImportResourceState:input_type -> tfplugin5.ImportResourceState.Request
	96,  // 158: tfplugin5.Provider.MoveResourceState:input_type -> tfplugin5.MoveResourceState.Request
	98,  // 159: tfplugin5.Provider.ReadDataSource:input_type -> tfplugin5.ReadDataSource.Request
	83,  // 160: tfplugin5.Provider.ValidateEphemeralResourceConfig:input_type -> tfplugin5.ValidateEphemeralResourceConfig.Request
	106, // 161: tfplugin5.Provider.OpenEphemeralResource:input_type -> tfplugin5.OpenEphemeralResource.Request
	108, // 162: tfplugin5.Provider.RenewEphemeralResource:input_type -> tfplugin5.RenewEphemeralResource.Request
	110, // 163: tfplugin5.Provider.CloseEphemeralResource:input_type -> tfplugin5.CloseEphemeralResource.Request
	112, // 164: tfplugin5.Provider.GetFunctions:input_type -> tfplugin5.GetFunctions.Request
	115, // 165: tfplugin5.Provider.CallFunction:input_type -> tfplugin5.CallFunction.Request
	117, // 166: tfplugin5.Provider.PlanAction:input_type -> tfplugin5.PlanAction.Request
	119, // 167: tfplugin5.Provider.InvokeAction:input_type -> tfplugin5.InvokeAction.Request
	124, // 168: tfplugin5.Provider.CancelAction:input_type -> tfplugin5.CancelAction.Request
	46,  // 169: tfplugin5.Provider.Stop:input_type -> tfplugin5.Stop.Request
	100, // 170: tfplugin5.Provisioner.GetSchema:input_type -> tfplugin5.GetProvisionerSchema.Request
	102, // 171: tfplugin5.Provisioner.ValidateProvisionerConfig:input_type -> tfplugin5.ValidateProvisionerConfig.Request
	104, // 172: tfplugin5.Provisioner.ProvisionResource:input_type -> tfplugin5.ProvisionResource.Request
	46,  // 173: tfplugin5.Provisioner.Stop:input_type -> tfplugin5.Stop.Request
	58,  // 174: tfplugin5.Provider.GetMetadata:output_type -> tfplugin5.GetMetadata.Response
	64,  // 175: tfplugin5.Provider.GetSchema:output_type -> tfplugin5.GetProviderSchema.Response
	71,  // 176: tfplugin5.Provider.PrepareProviderConfig:output_type -> tfplugin5.PrepareProviderConfig.Response
	80,  // 177: tfplugin5.Provider.ValidateResourceTypeConfig:output_type -> tfplugin5.ValidateResourceTypeConfig.Response
	82,  // 178: tfplugin5.Provider.ValidateDataSourceConfig:output_type -> tfplugin5.ValidateDataSourceConfig.Response
	73,  // 179: tfplugin5.Provider.UpgradeResourceState:output_type -> tfplugin5.UpgradeResourceState.Response
	75,  // 180: tfplugin5.Provider.GetResourceIdentitySchemas:output_type -> tfplugin5.GetResourceIdentitySchemas.Response
	78,  // 181: tfplugin5.Provider.UpgradeResourceIdentity:output_type -> tfplugin5.UpgradeResourceIdentity.Response
	86,  // 182: tfplugin5.Provider.Configure:output_type -> tfplugin5.Configure.Response
	88,  // 183: tfplugin5.Provider.ReadResource:output_type -> tfplugin5.ReadResource.Response
	90,  // 184: tfplugin5.Provider.PlanResourceChange:output_type -> tfplugin5.PlanResourceChange.Response
	92,  // 185: tfplugin5.Provider.ApplyResourceChange:output_type -> tfplugin5.ApplyResourceChange.Response
	95,  // 186: tfplugin5.Provider.ImportResourceState:output_type -> tfplugin5.ImportResourceState.Response
	97,  // 187: tfplugin5.Provider.MoveResourceState:output_type -> tfplugin5.MoveResourceState.Response
	99,  // 188: tfplugin5.Provider.ReadDataSource:output_type -> tfplugin5.ReadDataSource.Response
	84,  // 189: tfplugin5.Provider.ValidateEphemeralResourceConfig:output_type -> tfplugin5.ValidateEphemeralResourceConfig.Response
	107, // 190: tfplugin5.Provider.OpenEphemeralResource:output_type -> tfplugin5.OpenEphemeralResource.Response
	109, // 191: tfplugin5.Provider.RenewEphemeralResource:output_type -> tfplugin5.RenewEphemeralResource.Response
	111, // 192: tfplugin5.Provider.CloseEphemeralResource:output_type -> tfplugin5.CloseEphemeralResource.Response
	113, // 193: tfplugin5.Provider.GetFunctions:output_type -> tfplugin5.GetFunctions.Response
	116, // 194: tfplugin5.Provider.CallFunction:output_type -> tfplugin5.CallFunction.Response
	118, // 195: tfplugin5.Provider.PlanAction:output_type -> tfplugin5.PlanAction.Response
	120, // 196: tfplugin5.Provider.InvokeAction:output_type -> tfplugin5.InvokeAction.Event
	125, // 197: tfplugin5.Provider.CancelAction:output_type -> tfplugin5.CancelAction.Response
	47,  // 198: tfplugin5.Provider.Stop:output_type -> tfplugin5.Stop.Response
	101, // 199: tfplugin5.Provisioner.GetSchema:output_type -> tfplugin5.GetProvisionerSchema.Response
	103, // 200: tfplugin5.Provisioner.ValidateProvisionerConfig:output_type -> tfplugin5.ValidateProvisionerConfig.Response
	105, // 201: tfplugin5.Provisioner.ProvisionResource:output_type -> tfplugin5.ProvisionResource.Response
	47,  // 202: tfplugin5.Provisioner.Stop:output_type -> tfplugin5.Stop.Response
	174, // [174:203] is the sub-list for method output_type
	145, // [145:174] is the sub-list for method input_type
...
func file_tfplugin5_proto_init() {
	...
	file_tfplugin5_proto_msgTypes[41].OneofWrappers = []any{
	...
	file_tfplugin5_proto_msgTypes[104].OneofWrappers = []any{}
	file_tfplugin5_proto_msgTypes[105].OneofWrappers = []any{}
...
type ProviderClient interface {
	...
	CancelAction(ctx context.Context, in *CancelAction_Request, opts ...grpc.CallOption) (*CancelAction_Response, error)
	// ////// Graceful Shutdown
...
func (c *providerClient) InvokeAction(ctx context.Context, in *InvokeAction_Request, opts ...grpc.CallOption) (Provider_InvokeActionClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Provider_serviceDesc.Streams[0], "/tfplugin5.Provider/InvokeAction", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *providerClient) CancelAction(ctx context.Context, in *CancelAction_Request, opts ...grpc.CallOption) (*CancelAction_Response, error) {
	out := new(CancelAction_Response)
	err := c.cc.Invoke(ctx, "/tfplugin5.Provider/CancelAction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProviderServer interface {
	...
	CancelAction(context.Context, *CancelAction_Request) (*CancelAction_Response, error)
	// ////// Graceful Shutdown
...
func (*UnimplementedProviderServer) CancelAction(context.Context, *CancelAction_Request) (*CancelAction_Response, error) {
...
func _Provider_CancelAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CancelAction_Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProviderServer).CancelAction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tfplugin5.Provider/CancelAction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProviderServer).CancelAction(ctx, req.(*CancelAction_Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Provider_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Provider_CancelAction_Handler,
		},
		{
			MethodName: "Stop",
