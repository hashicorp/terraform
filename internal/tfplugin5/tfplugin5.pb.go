...
type GetProviderSchema_Response struct {
	...
	Capabilities      *GetProviderSchema_Capabilities `protobuf:"bytes,6,opt,name=capabilities,proto3" json:"capabilities,omitempty"`
}
...
func (x *GetProviderSchema_Response) GetCapabilities() *GetProviderSchema_Capabilities {
	if x != nil {
...
type GetProviderSchema_Capabilities struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetProviderSchema_Capabilities) Reset() {
	*x = GetProviderSchema_Capabilities{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetProviderSchema_Capabilities) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetProviderSchema_Capabilities) ProtoMessage() {}

func (x *GetProviderSchema_Capabilities) ProtoReflect() protoreflect.Message {
	mi := &file_tfplugin5_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetProviderSchema_Capabilities.ProtoReflect.Descriptor instead.
func (*GetProviderSchema_Capabilities) Descriptor() ([]byte, []int) {
	return file_tfplugin5_proto_rawDescGZIP(), []int{6, 2}
}

func (x *GetProviderSchema_Capabilities) GetPlanDestroy() bool {
	if x != nil {
...
var file_tfplugin5_proto_rawDesc = []byte{
	...
	0x04, 0x12, 0x09, 0x0a, 0x05, 0x47, 0x52, 0x4f, 0x55, 0x50, 0x10, 0x05, 0x22, 0xd2, 0x05, 0x0a,
	0x11, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x53, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x1a, 0x09, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0xfe, 0x04,
	...
	0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e,
	0x35, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x53, 0x63, 0x68,
	0x65, 0x6d, 0x61, 0x2e, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73,
	0x52, 0x0c, 0x63, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x1a, 0x55,
	...
	0x65, 0x6d, 0x61, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x31,
	0x0a, 0x0c, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x12, 0x21,
	0x0a, 0x0c, 0x70, 0x6c, 0x61, 0x6e, 0x5f, 0x64, 0x65, 0x73, 0x74, 0x72, 0x6f, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x70, 0x6c, 0x61, 0x6e, 0x44, 0x65, 0x73, 0x74, 0x72, 0x6f,
	0x79, 0x22, 0xdb, 0x01, 0x0a, 0x15, 0x50, 0x72, 0x65, 0x70, 0x61, 0x72, 0x65, 0x50, 0x72, 0x6f,
...
var file_tfplugin5_proto_goTypes = []interface{}{
	...
	(*GetProviderSchema_Capabilities)(nil),       // 32: tfplugin5.GetProviderSchema.Capabilities
...
var file_tfplugin5_proto_depIdxs = []int32{
	...
	32, // 16: tfplugin5.GetProviderSchema.Response.capabilities:type_name -> tfplugin5.GetProviderSchema.Capabilities
...
func file_tfplugin5_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tfplugin5_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetProviderSchema_Capabilities); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
