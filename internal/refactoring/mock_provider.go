...
func (provider *mockProvider) ValidateListResourceConfig(request providers.ValidateListResourceConfigRequest) providers.ValidateListResourceConfigResponse {
	panic("not implemented in mock")
}
