...
func (s *Scope) Functions() map[string]function.Function {
	...
	if s.funcs == nil {
		...
		s.funcs = map[string]function.Function{
			...
			"base32decode":     funcs.Base32DecodeFunc,
			"base32encode":     funcs.Base32EncodeFunc,
			...
			"sum":              funcs.SumFunc,
			"textdecodebase32": funcs.TextDecodeBase32Func,
			"textencodebase32": funcs.TextEncodeBase32Func,
