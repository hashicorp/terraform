...
func (s *Scope) Functions() map[string]function.Function {
	...
	if s.funcs == nil {
		...
		coreFuncs := map[string]function.Function{
			...
			"directoryexists":  funcs.MakeDirectoryExistsFunc(s.BaseDir),
			"directoryset":     funcs.MakeDirectorySetFunc(s.BaseDir),
...
func baseFunctions(baseDir string) map[string]function.Function {
	...
	fs := map[string]function.Function{
		...
		"directoryexists":  funcs.MakeDirectoryExistsFunc(baseDir),
		"directoryset":     funcs.MakeDirectorySetFunc(baseDir),
