...
// Package configs contains types that represent mnptu configurations and
// the different elements thereof.
//
// The functionality in this package can be used for some static analyses of
// mnptu configurations, but this package generally exposes representations
...
// diagnostics can be converted into mnptu-flavored diagnostics, if needed,
