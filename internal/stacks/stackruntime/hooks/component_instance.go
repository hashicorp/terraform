...
func (s ComponentInstanceStatus) ForProtobuf() rawstacks1.StackChangeProgress_ComponentInstanceStatus_Status {
	switch s {
	case ComponentInstancePending:
		return rawstacks1.StackChangeProgress_ComponentInstanceStatus_PENDING
	case ComponentInstancePlanning:
		return rawstacks1.StackChangeProgress_ComponentInstanceStatus_PLANNING
	case ComponentInstancePlanned:
		return rawstacks1.StackChangeProgress_ComponentInstanceStatus_PLANNED
	case ComponentInstanceApplying:
		return rawstacks1.StackChangeProgress_ComponentInstanceStatus_APPLYING
	case ComponentInstanceApplied:
		return rawstacks1.StackChangeProgress_ComponentInstanceStatus_APPLIED
	case ComponentInstanceErrored:
		return rawstacks1.StackChangeProgress_ComponentInstanceStatus_ERRORED
	default:
		return rawstacks1.StackChangeProgress_ComponentInstanceStatus_INVALID
	}
}
