...
type StateResourceInstanceObjectV1 struct {
	...
	WriteOnlyPaths      []*planproto.Path                    `protobuf:"bytes,9,rep,name=write_only_paths,json=writeOnlyPaths,proto3" json:"write_only_paths,omitempty"`
...
func (x *StateResourceInstanceObjectV1) GetWriteOnlyPaths() []*planproto.Path {
	if x != nil {
...
type DynamicValue struct {
	...
	SensitivePaths []*planproto.Path       `protobuf:"bytes,2,rep,name=sensitive_paths,json=sensitivePaths,proto3" json:"sensitive_paths,omitempty"`
	WriteOnlyPaths []*planproto.Path       `protobuf:"bytes,3,rep,name=write_only_paths,json=writeOnlyPaths,proto3" json:"write_only_paths,omitempty"`
}
...
func (x *DynamicValue) GetWriteOnlyPaths() []*planproto.Path {
	if x != nil {
		return x.WriteOnlyPaths
	}
	return nil
...
var file_tfstackdata1_proto_rawDesc = []byte{
	...
	0x04, 0x0a, 0x1d, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x65, 0x50, 0x61, 0x74, 0x68, 0x73, 0x12, 0x36, 0x0a, 0x10, 0x77, 0x72, 0x69, 0x74, 0x65, 0x5f,
	0x6f, 0x6e, 0x6c, 0x79, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x0c, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x50, 0x61, 0x74, 0x68, 0x52, 0x0e,
	0x77, 0x72, 0x69, 0x74, 0x65, 0x4f, 0x6e, 0x6c, 0x79, 0x50, 0x61, 0x74, 0x68, 0x73, 0x12, 0x25,
	...
	0x22, 0xa9, 0x01, 0x0a, 0x0c, 0x44, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x56, 0x61, 0x6c, 0x75,
	...
	0x61, 0x74, 0x68, 0x73, 0x12, 0x36, 0x0a, 0x10, 0x77, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x6f, 0x6e,
	0x6c, 0x79, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c,
	0x2e, 0x74, 0x66, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x50, 0x61, 0x74, 0x68, 0x52, 0x0e, 0x77, 0x72,
	0x69, 0x74, 0x65, 0x4f, 0x6e, 0x6c, 0x79, 0x50, 0x61, 0x74, 0x68, 0x73, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_tfstackdata1_proto_depIdxs = []int32{
	...
	28, // 16: tfstackdata1.StateResourceInstanceObjectV1.write_only_paths:type_name -> tfplan.Path
	0,  // 17: tfstackdata1.StateResourceInstanceObjectV1.status:type_name -> tfstackdata1.StateResourceInstanceObjectV1.Status
	29, // 18: tfstackdata1.DynamicValue.value:type_name -> tfplan.DynamicValue
	28, // 19: tfstackdata1.DynamicValue.sensitive_paths:type_name -> tfplan.Path
	28, // 20: tfstackdata1.DynamicValue.write_only_paths:type_name -> tfplan.Path
	16, // 21: tfstackdata1.PlanComponentInstance.PlannedInputValuesEntry.value:type_name -> tfstackdata1.DynamicValue
	16, // 22: tfstackdata1.PlanComponentInstance.PlannedOutputValuesEntry.value:type_name -> tfstackdata1.DynamicValue
	16, // 23: tfstackdata1.StateComponentInstanceV1.OutputValuesEntry.value:type_name -> tfstackdata1.DynamicValue
	16, // 24: tfstackdata1.StateComponentInstanceV1.InputVariablesEntry.value:type_name -> tfstackdata1.DynamicValue
