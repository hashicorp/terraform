...
// deferred.
type PlanDeferredResourceInstanceChange_Deferred_Reason int32

const (
	PlanDeferredResourceInstanceChange_Deferred_INVALID                 PlanDeferredResourceInstanceChange_Deferred_Reason = 0
	PlanDeferredResourceInstanceChange_Deferred_INSTANCE_COUNT_UNKNOWN  PlanDeferredResourceInstanceChange_Deferred_Reason = 1
	PlanDeferredResourceInstanceChange_Deferred_RESOURCE_CONFIG_UNKNOWN PlanDeferredResourceInstanceChange_Deferred_Reason = 2
	PlanDeferredResourceInstanceChange_Deferred_PROVIDER_CONFIG_UNKNOWN PlanDeferredResourceInstanceChange_Deferred_Reason = 3
	PlanDeferredResourceInstanceChange_Deferred_ABSENT_PREREQ           PlanDeferredResourceInstanceChange_Deferred_Reason = 4
	PlanDeferredResourceInstanceChange_Deferred_DEFERRED_PREREQ         PlanDeferredResourceInstanceChange_Deferred_Reason = 5
)

// Enum value maps for PlanDeferredResourceInstanceChange_Deferred_Reason.
var (
	PlanDeferredResourceInstanceChange_Deferred_Reason_name = map[int32]string{
		0: "INVALID",
	...
	PlanDeferredResourceInstanceChange_Deferred_Reason_value = map[string]int32{
		"INVALID":                 0,
...
func (x PlanDeferredResourceInstanceChange_Deferred_Reason) Enum() *PlanDeferredResourceInstanceChange_Deferred_Reason {
	p := new(PlanDeferredResourceInstanceChange_Deferred_Reason)
	*p = x
	return p
}

func (x PlanDeferredResourceInstanceChange_Deferred_Reason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PlanDeferredResourceInstanceChange_Deferred_Reason) Descriptor() protoreflect.EnumDescriptor {
	return file_tfstackdata1_proto_enumTypes[0].Descriptor()
}

func (PlanDeferredResourceInstanceChange_Deferred_Reason) Type() protoreflect.EnumType {
	return &file_tfstackdata1_proto_enumTypes[0]
}

func (x PlanDeferredResourceInstanceChange_Deferred_Reason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PlanDeferredResourceInstanceChange_Deferred_Reason.Descriptor instead.
func (PlanDeferredResourceInstanceChange_Deferred_Reason) EnumDescriptor() ([]byte, []int) {
	return file_tfstackdata1_proto_rawDescGZIP(), []int{5, 0, 0}
}
...
func (StateResourceInstanceObjectV1_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_tfstackdata1_proto_enumTypes[1].Descriptor()
}

func (StateResourceInstanceObjectV1_Status) Type() protoreflect.EnumType {
	return &file_tfstackdata1_proto_enumTypes[1]
}
...
type PlanDeferredResourceInstanceChange struct {
	...
	Deferred *PlanDeferredResourceInstanceChange_Deferred `protobuf:"bytes,1,opt,name=deferred,proto3" json:"deferred,omitempty"`
...
func (x *PlanDeferredResourceInstanceChange) GetDeferred() *PlanDeferredResourceInstanceChange_Deferred {
	if x != nil {
		return x.Deferred
	}
	return nil
...
// instance change.
type PlanDeferredResourceInstanceChange_Deferred struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Reason PlanDeferredResourceInstanceChange_Deferred_Reason `protobuf:"varint,1,opt,name=reason,proto3,enum=tfstackdata1.PlanDeferredResourceInstanceChange_Deferred_Reason" json:"reason,omitempty"`
}

func (x *PlanDeferredResourceInstanceChange_Deferred) Reset() {
	*x = PlanDeferredResourceInstanceChange_Deferred{}
	if protoimpl.UnsafeEnabled {
...
func (x *PlanDeferredResourceInstanceChange_Deferred) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PlanDeferredResourceInstanceChange_Deferred) ProtoMessage() {}

func (x *PlanDeferredResourceInstanceChange_Deferred) ProtoReflect() protoreflect.Message {
	mi := &file_tfstackdata1_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PlanDeferredResourceInstanceChange_Deferred.ProtoReflect.Descriptor instead.
func (*PlanDeferredResourceInstanceChange_Deferred) Descriptor() ([]byte, []int) {
	return file_tfstackdata1_proto_rawDescGZIP(), []int{5, 0}
}

func (x *PlanDeferredResourceInstanceChange_Deferred) GetReason() PlanDeferredResourceInstanceChange_Deferred_Reason {
	if x != nil {
		return x.Reason
	}
	return PlanDeferredResourceInstanceChange_Deferred_INVALID
}
...
var file_tfstackdata1_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xd7, 0x03, 0x0a, 0x1d, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52,
	...
	0x10, 0x01, 0x12, 0x0b, 0x0a, 0x07, 0x44, 0x41, 0x4d, 0x41, 0x47, 0x45, 0x44, 0x10, 0x02, 0x22,
	0x71, 0x0a, 0x0c, 0x44, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12,
	...
	0x65, 0x6e, 0x73, 0x69, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x73, 0x18, 0x02,
...
var file_tfstackdata1_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_tfstackdata1_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_tfstackdata1_proto_goTypes = []interface{}{
	(PlanDeferredResourceInstanceChange_Deferred_Reason)(0), // 0: tfstackdata1.PlanDeferredResourceInstanceChange.Deferred.Reason
	(StateResourceInstanceObjectV1_Status)(0),               // 1: tfstackdata1.StateResourceInstanceObjectV1.Status
	(*PlanHeader)(nil),                         // 2: tfstackdata1.PlanHeader
	(*PlanApplyable)(nil),                      // 3: tfstackdata1.PlanApplyable
	(*PlanRootInputValue)(nil),                 // 4: tfstackdata1.PlanRootInputValue
	(*PlanComponentInstance)(nil),              // 5: tfstackdata1.PlanComponentInstance
	(*PlanResourceInstanceChangePlanned)(nil),  // 6: tfstackdata1.PlanResourceInstanceChangePlanned
	(*PlanDeferredResourceInstanceChange)(nil), // 7: tfstackdata1.PlanDeferredResourceInstanceChange
	(*PlanDiscardStateMapKeys)(nil),            // 8: tfstackdata1.PlanDiscardStateMapKeys
	(*StateComponentInstanceV1)(nil),           // 9: tfstackdata1.StateComponentInstanceV1
	(*StateResourceInstanceObjectV1)(nil),      // 10: tfstackdata1.StateResourceInstanceObjectV1
	(*DynamicValue)(nil),                       // 11: tfstackdata1.DynamicValue
	nil,                                        // 12: tfstackdata1.PlanHeader.PrevRunStateRawEntry
	nil,                                        // 13: tfstackdata1.PlanComponentInstance.PlannedInputValuesEntry
	nil,                                        // 14: tfstackdata1.PlanComponentInstance.PlannedOutputValuesEntry
	(*PlanDeferredResourceInstanceChange_Deferred)(nil), // 15: tfstackdata1.PlanDeferredResourceInstanceChange.Deferred
	nil,                                      // 16: tfstackdata1.StateComponentInstanceV1.OutputValuesEntry
	(*planproto.DynamicValue)(nil),           // 17: tfplan.DynamicValue
	(planproto.Action)(0),                    // 18: tfplan.Action
	(*planproto.CheckResults)(nil),           // 19: tfplan.CheckResults
	(*planproto.ResourceInstanceChange)(nil), // 20: tfplan.ResourceInstanceChange
	(*planproto.Path)(nil),                   // 21: tfplan.Path
	(*anypb.Any)(nil),                        // 22: google.protobuf.Any
}
var file_tfstackdata1_proto_depIdxs = []int32{
	12, // 0: tfstackdata1.PlanHeader.prev_run_state_raw:type_name -> tfstackdata1.PlanHeader.PrevRunStateRawEntry
	17, // 1: tfstackdata1.PlanRootInputValue.value:type_name -> tfplan.DynamicValue
	13, // 2: tfstackdata1.PlanComponentInstance.planned_input_values:type_name -> tfstackdata1.PlanComponentInstance.PlannedInputValuesEntry
	18, // 3: tfstackdata1.PlanComponentInstance.planned_action:type_name -> tfplan.Action
	14, // 4: tfstackdata1.PlanComponentInstance.planned_output_values:type_name -> tfstackdata1.PlanComponentInstance.PlannedOutputValuesEntry
	19, // 5: tfstackdata1.PlanComponentInstance.planned_check_results:type_name -> tfplan.CheckResults
	20, // 6: tfstackdata1.PlanResourceInstanceChangePlanned.change:type_name -> tfplan.ResourceInstanceChange
	10, // 7: tfstackdata1.PlanResourceInstanceChangePlanned.prior_state:type_name -> tfstackdata1.StateResourceInstanceObjectV1
	15, // 8: tfstackdata1.PlanDeferredResourceInstanceChange.deferred:type_name -> tfstackdata1.PlanDeferredResourceInstanceChange.Deferred
	6,  // 9: tfstackdata1.PlanDeferredResourceInstanceChange.change:type_name -> tfstackdata1.PlanResourceInstanceChangePlanned
	16, // 10: tfstackdata1.StateComponentInstanceV1.output_values:type_name -> tfstackdata1.StateComponentInstanceV1.OutputValuesEntry
	21, // 11: tfstackdata1.StateResourceInstanceObjectV1.sensitive_paths:type_name -> tfplan.Path
	1,  // 12: tfstackdata1.StateResourceInstanceObjectV1.status:type_name -> tfstackdata1.StateResourceInstanceObjectV1.Status
	17, // 13: tfstackdata1.DynamicValue.value:type_name -> tfplan.DynamicValue
	21, // 14: tfstackdata1.DynamicValue.sensitive_paths:type_name -> tfplan.Path
	22, // 15: tfstackdata1.PlanHeader.PrevRunStateRawEntry.value:type_name -> google.protobuf.Any
	11, // 16: tfstackdata1.PlanComponentInstance.PlannedInputValuesEntry.value:type_name -> tfstackdata1.DynamicValue
	11, // 17: tfstackdata1.PlanComponentInstance.PlannedOutputValuesEntry.value:type_name -> tfstackdata1.DynamicValue
	0,  // 18: tfstackdata1.PlanDeferredResourceInstanceChange.Deferred.reason:type_name -> tfstackdata1.PlanDeferredResourceInstanceChange.Deferred.Reason
	11, // 19: tfstackdata1.StateComponentInstanceV1.OutputValuesEntry.value:type_name -> tfstackdata1.DynamicValue
...
func file_tfstackdata1_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tfstackdata1_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PlanDeferredResourceInstanceChange_Deferred); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
