...
type StateComponentInstanceV1 struct {
	...
	// The component instance's required components, as absolute addresses.
	RequiredComponentAddrs []string `protobuf:"bytes,3,rep,name=required_component_addrs,json=requiredComponentAddrs,proto3" json:"required_component_addrs,omitempty"`
	// The component instance's input values as used in the most recent apply
	// action. These are the values that were used to determine the desired
	// state of the component instance.
	InputValues map[string]*DynamicValue `protobuf:"bytes,2,rep,name=input_values,json=inputValues,proto3" json:"input_values,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *StateComponentInstanceV1) GetRequiredComponentAddrs() []string {
	if x != nil {
		return x.RequiredComponentAddrs
	}
	return nil
}

func (x *StateComponentInstanceV1) GetInputValues() map[string]*DynamicValue {
	if x != nil {
...
var file_tfstackdata1_proto_rawDesc = []byte{
	...
	,
	...
	0x6e, 0x63, 0x65, 0x56, 0x31, 0x2e, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x56, 0x61, 0x6c, 0x75,
	0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0c, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x56,
	0x61, 0x6c, 0x75, 0x65, 0x73, 0x1a, 0x5a, 0x0a, 0x10, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x56, 0x61,
	...
	0x01, 0x1a, 0x5b, 0x0a, 0x11, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65,
...
var file_tfstackdata1_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_tfstackdata1_proto_goTypes = []interface{}{
	...
	nil,                                        // 16: tfstackdata1.StateComponentInstanceV1.InputValuesEntry
	nil,                                        // 17: tfstackdata1.StateComponentInstanceV1.OutputValuesEntry
	(*anypb.Any)(nil),                          // 18: google.protobuf.Any
	(*planproto.ProviderFunctionCallHash)(nil), // 19: tfplan.ProviderFunctionCallHash
	(planproto.Action)(0),                      // 20: tfplan.Action
	(planproto.Mode)(0),                        // 21: tfplan.Mode
	(*planproto.CheckResults)(nil),             // 22: tfplan.CheckResults
	(*planproto.ResourceInstanceChange)(nil),   // 23: tfplan.ResourceInstanceChange
	(*planproto.Deferred)(nil),                 // 24: tfplan.Deferred
	(*planproto.Path)(nil),                     // 25: tfplan.Path
	(*planproto.DynamicValue)(nil),             // 26: tfplan.DynamicValue
}
var file_tfstackdata1_proto_depIdxs = []int32{
	18, // 0: tfstackdata1.PlanPriorStateElem.raw:type_name -> google.protobuf.Any
	13, // 1: tfstackdata1.PlanRootInputValue.value:type_name -> tfstackdata1.DynamicValue
	19, // 2: tfstackdata1.ProviderFunctionResults.provider_function_results:type_name -> tfplan.ProviderFunctionCallHash
	...
	20, // 4: tfstackdata1.PlanComponentInstance.planned_action:type_name -> tfplan.Action
	21, // 5: tfstackdata1.PlanComponentInstance.mode:type_name -> tfplan.Mode
	...
	22, // 7: tfstackdata1.PlanComponentInstance.planned_check_results:type_name -> tfplan.CheckResults
	19, // 8: tfstackdata1.PlanComponentInstance.provider_function_results:type_name -> tfplan.ProviderFunctionCallHash
	23, // 9: tfstackdata1.PlanResourceInstanceChangePlanned.change:type_name -> tfplan.ResourceInstanceChange
	12, // 10: tfstackdata1.PlanResourceInstanceChangePlanned.prior_state:type_name -> tfstackdata1.StateResourceInstanceObjectV1
	24, // 11: tfstackdata1.PlanDeferredResourceInstanceChange.deferred:type_name -> tfplan.Deferred
	8,  // 12: tfstackdata1.PlanDeferredResourceInstanceChange.change:type_name -> tfstackdata1.PlanResourceInstanceChangePlanned
	16, // 13: tfstackdata1.StateComponentInstanceV1.input_values:type_name -> tfstackdata1.StateComponentInstanceV1.InputValuesEntry
	17, // 14: tfstackdata1.StateComponentInstanceV1.output_values:type_name -> tfstackdata1.StateComponentInstanceV1.OutputValuesEntry
	25, // 15: tfstackdata1.StateResourceInstanceObjectV1.sensitive_paths:type_name -> tfplan.Path
	0,  // 16: tfstackdata1.StateResourceInstanceObjectV1.status:type_name -> tfstackdata1.StateResourceInstanceObjectV1.Status
	26, // 17: tfstackdata1.DynamicValue.value:type_name -> tfplan.DynamicValue
	25, // 18: tfstackdata1.DynamicValue.sensitive_paths:type_name -> tfplan.Path
	13, // 19: tfstackdata1.PlanComponentInstance.PlannedInputValuesEntry.value:type_name -> tfstackdata1.DynamicValue
	13, // 20: tfstackdata1.PlanComponentInstance.PlannedOutputValuesEntry.value:type_name -> tfstackdata1.DynamicValue
	13, // 21: tfstackdata1.StateComponentInstanceV1.InputValuesEntry.value:type_name -> tfstackdata1.DynamicValue
	13, // 22: tfstackdata1.StateComponentInstanceV1.OutputValuesEntry.value:type_name -> tfstackdata1.DynamicValue
