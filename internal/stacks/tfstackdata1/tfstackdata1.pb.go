...
var file_tfstackdata1_proto_rawDesc = []byte{
	...
	0x6c, 0x79, 0x22, 0x77, 0x0a, 0x17, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x46, 0x75,
...
var file_tfstackdata1_proto_depIdxs = []int32{
	...
	25, // 14: tfstackdata1.StateResourceInstanceObjectV1.sensitive_paths:type_name -> tfplan.Path
	0,  // 15: tfstackdata1.StateResourceInstanceObjectV1.status:type_name -> tfstackdata1.StateResourceInstanceObjectV1.Status
	18, // 16: tfstackdata1.DynamicValue.value:type_name -> tfplan.DynamicValue
	25, // 17: tfstackdata1.DynamicValue.sensitive_paths:type_name -> tfplan.Path
