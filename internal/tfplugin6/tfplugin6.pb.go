...
var file_tfplugin6_proto_depIdxs = []int32{
	...
	18,  // 169: tfplugin6.InvokeAction.Request.client_capabilities:type_name -> tfplugin6.ClientCapabilities
	147, // 170: tfplugin6.InvokeAction.Event.progress:type_name -> tfplugin6.InvokeAction.Event.Progress
	148, // 171: tfplugin6.InvokeAction.Event.completed:type_name -> tfplugin6.InvokeAction.Event.Completed
	6,   // 172: tfplugin6.InvokeAction.Request.LinkedResource.prior_state:type_name -> tfplugin6.DynamicValue
	6,   // 173: tfplugin6.InvokeAction.Request.LinkedResource.planned_state:type_name -> tfplugin6.DynamicValue
	6,   // 174: tfplugin6.InvokeAction.Request.LinkedResource.config:type_name -> tfplugin6.DynamicValue
	13,  // 175: tfplugin6.InvokeAction.Request.LinkedResource.planned_identity:type_name -> tfplugin6.ResourceIdentityData
	149, // 176: tfplugin6.InvokeAction.Event.Completed.linked_resources:type_name -> tfplugin6.InvokeAction.Event.Completed.LinkedResource
	7,   // 177: tfplugin6.InvokeAction.Event.Completed.diagnostics:type_name -> tfplugin6.Diagnostic
	6,   // 178: tfplugin6.InvokeAction.Event.Completed.LinkedResource.new_state:type_name -> tfplugin6.DynamicValue
	13,  // 179: tfplugin6.InvokeAction.Event.Completed.LinkedResource.new_identity:type_name -> tfplugin6.ResourceIdentityData
	6,   // 180: tfplugin6.ValidateActionConfig.Request.config:type_name -> tfplugin6.DynamicValue
	51,  // 181: tfplugin6.ValidateActionConfig.Request.linked_resources:type_name -> tfplugin6.LinkedResourceConfig
	7,   // 182: tfplugin6.ValidateActionConfig.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	67,  // 183: tfplugin6.Provider.GetMetadata:input_type -> tfplugin6.GetMetadata.Request
	76,  // 184: tfplugin6.Provider.GetProviderSchema:input_type -> tfplugin6.GetProviderSchema.Request
	85,  // 185: tfplugin6.Provider.ValidateProviderConfig:input_type -> tfplugin6.ValidateProviderConfig.Request
	94,  // 186: tfplugin6.Provider.ValidateResourceConfig:input_type -> tfplugin6.ValidateResourceConfig.Request
	96,  // 187: tfplugin6.Provider.ValidateDataResourceConfig:input_type -> tfplugin6.ValidateDataResourceConfig.Request
	87,  // 188: tfplugin6.Provider.UpgradeResourceState:input_type -> tfplugin6.UpgradeResourceState.Request
	89,  // 189: tfplugin6.Provider.GetResourceIdentitySchemas:input_type -> tfplugin6.GetResourceIdentitySchemas.Request
	92,  // 190: tfplugin6.Provider.UpgradeResourceIdentity:input_type -> tfplugin6.UpgradeResourceIdentity.Request
	100, // 191: tfplugin6.Provider.ConfigureProvider:input_type -> tfplugin6.ConfigureProvider.Request
	102, // 192: tfplugin6.Provider.ReadResource:input_type -> tfplugin6.ReadResource.Request
	104, // 193: tfplugin6.Provider.PlanResourceChange:input_type -> tfplugin6.PlanResourceChange.Request
	106, // 194: tfplugin6.Provider.ApplyResourceChange:input_type -> tfplugin6.ApplyResourceChange.Request
	108, // 195: tfplugin6.Provider.ImportResourceState:input_type -> tfplugin6.ImportResourceState.Request
	113, // 196: tfplugin6.Provider.MoveResourceState:input_type -> tfplugin6.MoveResourceState.Request
	115, // 197: tfplugin6.Provider.ReadDataSource:input_type -> tfplugin6.ReadDataSource.Request
	111, // 198: tfplugin6.Provider.GenerateResourceConfig:input_type -> tfplugin6.GenerateResourceConfig.Request
	98,  // 199: tfplugin6.Provider.ValidateEphemeralResourceConfig:input_type -> tfplugin6.ValidateEphemeralResourceConfig.Request
	...
	136, // 209: tfplugin6.Provider.GetStates:input_type -> tfplugin6.GetStates.Request
	138, // 210: tfplugin6.Provider.DeleteState:input_type -> tfplugin6.DeleteState.Request
	140, // 211: tfplugin6.Provider.PlanAction:input_type -> tfplugin6.PlanAction.Request
	144, // 212: tfplugin6.Provider.InvokeAction:input_type -> tfplugin6.InvokeAction.Request
	150, // 213: tfplugin6.Provider.ValidateActionConfig:input_type -> tfplugin6.ValidateActionConfig.Request
	53,  // 214: tfplugin6.Provider.StopProvider:input_type -> tfplugin6.StopProvider.Request
	68,  // 215: tfplugin6.Provider.GetMetadata:output_type -> tfplugin6.GetMetadata.Response
	77,  // 216: tfplugin6.Provider.GetProviderSchema:output_type -> tfplugin6.GetProviderSchema.Response
	86,  // 217: tfplugin6.Provider.ValidateProviderConfig:output_type -> tfplugin6.ValidateProviderConfig.Response
	95,  // 218: tfplugin6.Provider.ValidateResourceConfig:output_type -> tfplugin6.ValidateResourceConfig.Response
	97,  // 219: tfplugin6.Provider.ValidateDataResourceConfig:output_type -> tfplugin6.ValidateDataResourceConfig.Response
	88,  // 220: tfplugin6.Provider.UpgradeResourceState:output_type -> tfplugin6.UpgradeResourceState.Response
	90,  // 221: tfplugin6.Provider.GetResourceIdentitySchemas:output_type -> tfplugin6.GetResourceIdentitySchemas.Response
	93,  // 222: tfplugin6.Provider.UpgradeResourceIdentity:output_type -> tfplugin6.UpgradeResourceIdentity.Response
	101, // 223: tfplugin6.Provider.ConfigureProvider:output_type -> tfplugin6.ConfigureProvider.Response
	103, // 224: tfplugin6.Provider.ReadResource:output_type -> tfplugin6.ReadResource.Response
	105, // 225: tfplugin6.Provider.PlanResourceChange:output_type -> tfplugin6.PlanResourceChange.Response
	107, // 226: tfplugin6.Provider.ApplyResourceChange:output_type -> tfplugin6.ApplyResourceChange.Response
	110, // 227: tfplugin6.Provider.ImportResourceState:output_type -> tfplugin6.ImportResourceState.Response
	114, // 228: tfplugin6.Provider.MoveResourceState:output_type -> tfplugin6.MoveResourceState.Response
	116, // 229: tfplugin6.Provider.ReadDataSource:output_type -> tfplugin6.ReadDataSource.Response
	112, // 230: tfplugin6.Provider.GenerateResourceConfig:output_type -> tfplugin6.GenerateResourceConfig.Response
	99,  // 231: tfplugin6.Provider.ValidateEphemeralResourceConfig:output_type -> tfplugin6.ValidateEphemeralResourceConfig.Response
	118, // 232: tfplugin6.Provider.OpenEphemeralResource:output_type -> tfplugin6.OpenEphemeralResource.Response
	120, // 233: tfplugin6.Provider.RenewEphemeralResource:output_type -> tfplugin6.RenewEphemeralResource.Response
	122, // 234: tfplugin6.Provider.CloseEphemeralResource:output_type -> tfplugin6.CloseEphemeralResource.Response
	129, // 235: tfplugin6.Provider.ListResource:output_type -> tfplugin6.ListResource.Event
	131, // 236: tfplugin6.Provider.ValidateListResourceConfig:output_type -> tfplugin6.ValidateListResourceConfig.Response
	124, // 237: tfplugin6.Provider.GetFunctions:output_type -> tfplugin6.GetFunctions.Response
	127, // 238: tfplugin6.Provider.CallFunction:output_type -> tfplugin6.CallFunction.Response
	133, // 239: tfplugin6.Provider.ValidateStateStoreConfig:output_type -> tfplugin6.ValidateStateStore.Response
	135, // 240: tfplugin6.Provider.ConfigureStateStore:output_type -> tfplugin6.ConfigureStateStore.Response
	137, // 241: tfplugin6.Provider.GetStates:output_type -> tfplugin6.GetStates.Response
	139, // 242: tfplugin6.Provider.DeleteState:output_type -> tfplugin6.DeleteState.Response
	141, // 243: tfplugin6.Provider.PlanAction:output_type -> tfplugin6.PlanAction.Response
	145, // 244: tfplugin6.Provider.InvokeAction:output_type -> tfplugin6.InvokeAction.Event
	151, // 245: tfplugin6.Provider.ValidateActionConfig:output_type -> tfplugin6.ValidateActionConfig.Response
	54,  // 246: tfplugin6.Provider.StopProvider:output_type -> tfplugin6.StopProvider.Response
	215, // [215:247] is the sub-list for method output_type
	183, // [183:215] is the sub-list for method input_type
