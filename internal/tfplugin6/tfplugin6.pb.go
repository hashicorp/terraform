...
var file_tfplugin6_proto_rawDesc = string([]byte{
	...
	0x22, 0xaf, 0x03, 0x0a, 0x0c, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	...
	0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x44, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x56, 0x61, 0x6c,
	0x75, 0x65, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0xc5, 0x02, 0x0a, 0x05, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x12, 0x44, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x48, 0x00,
	0x52, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x37, 0x0a, 0x0a, 0x64, 0x69,
	0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15,
	0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x44, 0x69, 0x61, 0x67, 0x6e,
	0x6f, 0x73, 0x74, 0x69, 0x63, 0x48, 0x00, 0x52, 0x0a, 0x64, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73,
	0x74, 0x69, 0x63, 0x1a, 0xb0, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	,
	...
	0x44, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x32, 0xc1, 0x13, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x76, 0x69,
...
var file_tfplugin6_proto_goTypes = []any{
	...
	(*ListResource_Event)(nil),                       // 107: tfplugin6.ListResource.Event
	(*ListResource_Event_Resource)(nil),              // 108: tfplugin6.ListResource.Event.Resource
...
var file_tfplugin6_proto_depIdxs = []int32{
	...
	108, // 124: tfplugin6.ListResource.Event.resource:type_name -> tfplugin6.ListResource.Event.Resource
	6,   // 125: tfplugin6.ListResource.Event.diagnostic:type_name -> tfplugin6.Diagnostic
	12,  // 126: tfplugin6.ListResource.Event.Resource.identity:type_name -> tfplugin6.ResourceIdentityData
	5,   // 127: tfplugin6.ListResource.Event.Resource.resource_object:type_name -> tfplugin6.DynamicValue
	...
	58,  // 131: tfplugin6.Provider.GetProviderSchema:input_type -> tfplugin6.GetProviderSchema.Request
	65,  // 132: tfplugin6.Provider.ValidateProviderConfig:input_type -> tfplugin6.ValidateProviderConfig.Request
	74,  // 133: tfplugin6.Provider.ValidateResourceConfig:input_type -> tfplugin6.ValidateResourceConfig.Request
	76,  // 134: tfplugin6.Provider.ValidateDataResourceConfig:input_type -> tfplugin6.ValidateDataResourceConfig.Request
	67,  // 135: tfplugin6.Provider.UpgradeResourceState:input_type -> tfplugin6.UpgradeResourceState.Request
	69,  // 136: tfplugin6.Provider.GetResourceIdentitySchemas:input_type -> tfplugin6.GetResourceIdentitySchemas.Request
	72,  // 137: tfplugin6.Provider.UpgradeResourceIdentity:input_type -> tfplugin6.UpgradeResourceIdentity.Request
	80,  // 138: tfplugin6.Provider.ConfigureProvider:input_type -> tfplugin6.ConfigureProvider.Request
	82,  // 139: tfplugin6.Provider.ReadResource:input_type -> tfplugin6.ReadResource.Request
	84,  // 140: tfplugin6.Provider.PlanResourceChange:input_type -> tfplugin6.PlanResourceChange.Request
	86,  // 141: tfplugin6.Provider.ApplyResourceChange:input_type -> tfplugin6.ApplyResourceChange.Request
	88,  // 142: tfplugin6.Provider.ImportResourceState:input_type -> tfplugin6.ImportResourceState.Request
	91,  // 143: tfplugin6.Provider.MoveResourceState:input_type -> tfplugin6.MoveResourceState.Request
	93,  // 144: tfplugin6.Provider.ReadDataSource:input_type -> tfplugin6.ReadDataSource.Request
	78,  // 145: tfplugin6.Provider.ValidateEphemeralResourceConfig:input_type -> tfplugin6.ValidateEphemeralResourceConfig.Request
	95,  // 146: tfplugin6.Provider.OpenEphemeralResource:input_type -> tfplugin6.OpenEphemeralResource.Request
	97,  // 147: tfplugin6.Provider.RenewEphemeralResource:input_type -> tfplugin6.RenewEphemeralResource.Request
	99,  // 148: tfplugin6.Provider.CloseEphemeralResource:input_type -> tfplugin6.CloseEphemeralResource.Request
	106, // 149: tfplugin6.Provider.ListResource:input_type -> tfplugin6.ListResource.Request
	109, // 150: tfplugin6.Provider.ValidateListResourceConfig:input_type -> tfplugin6.ValidateListResourceConfig.Request
	101, // 151: tfplugin6.Provider.GetFunctions:input_type -> tfplugin6.GetFunctions.Request
	104, // 152: tfplugin6.Provider.CallFunction:input_type -> tfplugin6.CallFunction.Request
	...
	59,  // 155: tfplugin6.Provider.GetProviderSchema:output_type -> tfplugin6.GetProviderSchema.Response
	66,  // 156: tfplugin6.Provider.ValidateProviderConfig:output_type -> tfplugin6.ValidateProviderConfig.Response
	75,  // 157: tfplugin6.Provider.ValidateResourceConfig:output_type -> tfplugin6.ValidateResourceConfig.Response
	77,  // 158: tfplugin6.Provider.ValidateDataResourceConfig:output_type -> tfplugin6.ValidateDataResourceConfig.Response
	68,  // 159: tfplugin6.Provider.UpgradeResourceState:output_type -> tfplugin6.UpgradeResourceState.Response
	70,  // 160: tfplugin6.Provider.GetResourceIdentitySchemas:output_type -> tfplugin6.GetResourceIdentitySchemas.Response
	73,  // 161: tfplugin6.Provider.UpgradeResourceIdentity:output_type -> tfplugin6.UpgradeResourceIdentity.Response
	81,  // 162: tfplugin6.Provider.ConfigureProvider:output_type -> tfplugin6.ConfigureProvider.Response
	83,  // 163: tfplugin6.Provider.ReadResource:output_type -> tfplugin6.ReadResource.Response
	85,  // 164: tfplugin6.Provider.PlanResourceChange:output_type -> tfplugin6.PlanResourceChange.Response
	87,  // 165: tfplugin6.Provider.ApplyResourceChange:output_type -> tfplugin6.ApplyResourceChange.Response
	90,  // 166: tfplugin6.Provider.ImportResourceState:output_type -> tfplugin6.ImportResourceState.Response
	92,  // 167: tfplugin6.Provider.MoveResourceState:output_type -> tfplugin6.MoveResourceState.Response
	94,  // 168: tfplugin6.Provider.ReadDataSource:output_type -> tfplugin6.ReadDataSource.Response
	79,  // 169: tfplugin6.Provider.ValidateEphemeralResourceConfig:output_type -> tfplugin6.ValidateEphemeralResourceConfig.Response
	96,  // 170: tfplugin6.Provider.OpenEphemeralResource:output_type -> tfplugin6.OpenEphemeralResource.Response
	98,  // 171: tfplugin6.Provider.RenewEphemeralResource:output_type -> tfplugin6.RenewEphemeralResource.Response
	100, // 172: tfplugin6.Provider.CloseEphemeralResource:output_type -> tfplugin6.CloseEphemeralResource.Response
	107, // 173: tfplugin6.Provider.ListResource:output_type -> tfplugin6.ListResource.Event
	110, // 174: tfplugin6.Provider.ValidateListResourceConfig:output_type -> tfplugin6.ValidateListResourceConfig.Response
	102, // 175: tfplugin6.Provider.GetFunctions:output_type -> tfplugin6.GetFunctions.Response
	105, // 176: tfplugin6.Provider.CallFunction:output_type -> tfplugin6.CallFunction.Response
