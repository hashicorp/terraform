...
var file_tfplugin6_proto_rawDesc = string([]byte{
	...
	0x4b, 0x44, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x32, 0xc1, 0x13, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x76,
...
var file_tfplugin6_proto_goTypes = []any{
	...
	(*ListResource_Event)(nil),                       // 106: tfplugin6.ListResource.Event
	(*ListResource_Event_Resource)(nil),              // 107: tfplugin6.ListResource.Event.Resource
...
var file_tfplugin6_proto_depIdxs = []int32{
	...
	107, // 122: tfplugin6.ListResource.Event.resource:type_name -> tfplugin6.ListResource.Event.Resource
	6,   // 123: tfplugin6.ListResource.Event.diagnostic:type_name -> tfplugin6.Diagnostic
	12,  // 124: tfplugin6.ListResource.Event.Resource.identity:type_name -> tfplugin6.ResourceIdentityData
	5,   // 125: tfplugin6.ListResource.Event.Resource.resource_object:type_name -> tfplugin6.DynamicValue
	5,   // 126: tfplugin6.ValidateListResourceConfig.Request.config:type_name -> tfplugin6.DynamicValue
	6,   // 127: tfplugin6.ValidateListResourceConfig.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	52,  // 128: tfplugin6.Provider.GetMetadata:input_type -> tfplugin6.GetMetadata.Request
	58,  // 129: tfplugin6.Provider.GetProviderSchema:input_type -> tfplugin6.GetProviderSchema.Request
	64,  // 130: tfplugin6.Provider.ValidateProviderConfig:input_type -> tfplugin6.ValidateProviderConfig.Request
	73,  // 131: tfplugin6.Provider.ValidateResourceConfig:input_type -> tfplugin6.ValidateResourceConfig.Request
	75,  // 132: tfplugin6.Provider.ValidateDataResourceConfig:input_type -> tfplugin6.ValidateDataResourceConfig.Request
	66,  // 133: tfplugin6.Provider.UpgradeResourceState:input_type -> tfplugin6.UpgradeResourceState.Request
	68,  // 134: tfplugin6.Provider.GetResourceIdentitySchemas:input_type -> tfplugin6.GetResourceIdentitySchemas.Request
	71,  // 135: tfplugin6.Provider.UpgradeResourceIdentity:input_type -> tfplugin6.UpgradeResourceIdentity.Request
	79,  // 136: tfplugin6.Provider.ConfigureProvider:input_type -> tfplugin6.ConfigureProvider.Request
	81,  // 137: tfplugin6.Provider.ReadResource:input_type -> tfplugin6.ReadResource.Request
	83,  // 138: tfplugin6.Provider.PlanResourceChange:input_type -> tfplugin6.PlanResourceChange.Request
	85,  // 139: tfplugin6.Provider.ApplyResourceChange:input_type -> tfplugin6.ApplyResourceChange.Request
	87,  // 140: tfplugin6.Provider.ImportResourceState:input_type -> tfplugin6.ImportResourceState.Request
	90,  // 141: tfplugin6.Provider.MoveResourceState:input_type -> tfplugin6.MoveResourceState.Request
	92,  // 142: tfplugin6.Provider.ReadDataSource:input_type -> tfplugin6.ReadDataSource.Request
	77,  // 143: tfplugin6.Provider.ValidateEphemeralResourceConfig:input_type -> tfplugin6.ValidateEphemeralResourceConfig.Request
	94,  // 144: tfplugin6.Provider.OpenEphemeralResource:input_type -> tfplugin6.OpenEphemeralResource.Request
	96,  // 145: tfplugin6.Provider.RenewEphemeralResource:input_type -> tfplugin6.RenewEphemeralResource.Request
	98,  // 146: tfplugin6.Provider.CloseEphemeralResource:input_type -> tfplugin6.CloseEphemeralResource.Request
	105, // 147: tfplugin6.Provider.ListResource:input_type -> tfplugin6.ListResource.Request
	108, // 148: tfplugin6.Provider.ValidateListResourceConfig:input_type -> tfplugin6.ValidateListResourceConfig.Request
	100, // 149: tfplugin6.Provider.GetFunctions:input_type -> tfplugin6.GetFunctions.Request
	103, // 150: tfplugin6.Provider.CallFunction:input_type -> tfplugin6.CallFunction.Request
	42,  // 151: tfplugin6.Provider.StopProvider:input_type -> tfplugin6.StopProvider.Request
	53,  // 152: tfplugin6.Provider.GetMetadata:output_type -> tfplugin6.GetMetadata.Response
	59,  // 153: tfplugin6.Provider.GetProviderSchema:output_type -> tfplugin6.GetProviderSchema.Response
	65,  // 154: tfplugin6.Provider.ValidateProviderConfig:output_type -> tfplugin6.ValidateProviderConfig.Response
	74,  // 155: tfplugin6.Provider.ValidateResourceConfig:output_type -> tfplugin6.ValidateResourceConfig.Response
	76,  // 156: tfplugin6.Provider.ValidateDataResourceConfig:output_type -> tfplugin6.ValidateDataResourceConfig.Response
	67,  // 157: tfplugin6.Provider.UpgradeResourceState:output_type -> tfplugin6.UpgradeResourceState.Response
	69,  // 158: tfplugin6.Provider.GetResourceIdentitySchemas:output_type -> tfplugin6.GetResourceIdentitySchemas.Response
	72,  // 159: tfplugin6.Provider.UpgradeResourceIdentity:output_type -> tfplugin6.UpgradeResourceIdentity.Response
	80,  // 160: tfplugin6.Provider.ConfigureProvider:output_type -> tfplugin6.ConfigureProvider.Response
	82,  // 161: tfplugin6.Provider.ReadResource:output_type -> tfplugin6.ReadResource.Response
	84,  // 162: tfplugin6.Provider.PlanResourceChange:output_type -> tfplugin6.PlanResourceChange.Response
	86,  // 163: tfplugin6.Provider.ApplyResourceChange:output_type -> tfplugin6.ApplyResourceChange.Response
	89,  // 164: tfplugin6.Provider.ImportResourceState:output_type -> tfplugin6.ImportResourceState.Response
	91,  // 165: tfplugin6.Provider.MoveResourceState:output_type -> tfplugin6.MoveResourceState.Response
	93,  // 166: tfplugin6.Provider.ReadDataSource:output_type -> tfplugin6.ReadDataSource.Response
	78,  // 167: tfplugin6.Provider.ValidateEphemeralResourceConfig:output_type -> tfplugin6.ValidateEphemeralResourceConfig.Response
	95,  // 168: tfplugin6.Provider.OpenEphemeralResource:output_type -> tfplugin6.OpenEphemeralResource.Response
	97,  // 169: tfplugin6.Provider.RenewEphemeralResource:output_type -> tfplugin6.RenewEphemeralResource.Response
	99,  // 170: tfplugin6.Provider.CloseEphemeralResource:output_type -> tfplugin6.CloseEphemeralResource.Response
	106, // 171: tfplugin6.Provider.ListResource:output_type -> tfplugin6.ListResource.Event
	109, // 172: tfplugin6.Provider.ValidateListResourceConfig:output_type -> tfplugin6.ValidateListResourceConfig.Response
	101, // 173: tfplugin6.Provider.GetFunctions:output_type -> tfplugin6.GetFunctions.Response
	104, // 174: tfplugin6.Provider.CallFunction:output_type -> tfplugin6.CallFunction.Response
	43,  // 175: tfplugin6.Provider.StopProvider:output_type -> tfplugin6.StopProvider.Response
