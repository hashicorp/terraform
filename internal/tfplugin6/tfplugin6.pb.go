...
var file_tfplugin6_proto_rawDesc = string([]byte{
	...
	0x22, 0xba, 0x01, 0x0a, 0x1a, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x73,
	...
	0x61, 0x63, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x2a, 0x25, 0x0a, 0x0a, 0x53,
	...
	0x10, 0x01, 0x32, 0xb3, 0x16, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x12,
	...
	0x6e, 0x73, 0x65, 0x12, 0x69, 0x0a, 0x18, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12,
	0x25, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x36, 0x2e, 0x56, 0x61, 0x6c, 0x69,
	...
	0x6e, 0x36, 0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x53, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x66,
	0x0a, 0x13, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x53, 0x74, 0x6f, 0x72, 0x65, 0x12, 0x26, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e,
	0x36, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x53, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x27, 0x2e,
	...
	0x65, 0x6e, 0x74, 0x30, 0x01, 0x12, 0x51, 0x0a, 0x0c, 0x53, 0x74, 0x6f, 0x70, 0x50, 0x72, 0x6f,
...
var file_tfplugin6_proto_goTypes = []any{
	...
	(*AttributePath_Step)(nil),                       // 47: tfplugin6.AttributePath.Step
	(*StopProvider_Request)(nil),                     // 48: tfplugin6.StopProvider.Request
	(*StopProvider_Response)(nil),                    // 49: tfplugin6.StopProvider.Response
	nil,                                              // 50: tfplugin6.RawState.FlatmapEntry
	(*ResourceIdentitySchema_IdentityAttribute)(nil), // 51: tfplugin6.ResourceIdentitySchema.IdentityAttribute
	(*ActionSchema_LinkedResource)(nil),              // 52: tfplugin6.ActionSchema.LinkedResource
	(*ActionSchema_Unlinked)(nil),                    // 53: tfplugin6.ActionSchema.Unlinked
	(*ActionSchema_Lifecycle)(nil),                   // 54: tfplugin6.ActionSchema.Lifecycle
	(*ActionSchema_Linked)(nil),                      // 55: tfplugin6.ActionSchema.Linked
...
var file_tfplugin6_proto_depIdxs = []int32{
	...
	47,  // 2: tfplugin6.AttributePath.steps:type_name -> tfplugin6.AttributePath.Step
	50,  // 3: tfplugin6.RawState.flatmap:type_name -> tfplugin6.RawState.FlatmapEntry
	51,  // 4: tfplugin6.ResourceIdentitySchema.identity_attributes:type_name -> tfplugin6.ResourceIdentitySchema.IdentityAttribute
	...
	53,  // 7: tfplugin6.ActionSchema.unlinked:type_name -> tfplugin6.ActionSchema.Unlinked
	54,  // 8: tfplugin6.ActionSchema.lifecycle:type_name -> tfplugin6.ActionSchema.Lifecycle
	55,  // 9: tfplugin6.ActionSchema.linked:type_name -> tfplugin6.ActionSchema.Linked
	56,  // 10: tfplugin6.Schema.block:type_name -> tfplugin6.Schema.Block
	60,  // 11: tfplugin6.Function.parameters:type_name -> tfplugin6.Function.Parameter
	60,  // 12: tfplugin6.Function.variadic_parameter:type_name -> tfplugin6.Function.Parameter
	61,  // 13: tfplugin6.Function.return:type_name -> tfplugin6.Function.Return
	...
	52,  // 17: tfplugin6.ActionSchema.Lifecycle.linked_resource:type_name -> tfplugin6.ActionSchema.LinkedResource
	52,  // 18: tfplugin6.ActionSchema.Linked.linked_resources:type_name -> tfplugin6.ActionSchema.LinkedResource
	57,  // 19: tfplugin6.Schema.Block.attributes:type_name -> tfplugin6.Schema.Attribute
	58,  // 20: tfplugin6.Schema.Block.block_types:type_name -> tfplugin6.Schema.NestedBlock
	0,   // 21: tfplugin6.Schema.Block.description_kind:type_name -> tfplugin6.StringKind
	59,  // 22: tfplugin6.Schema.Attribute.nested_type:type_name -> tfplugin6.Schema.Object
	0,   // 23: tfplugin6.Schema.Attribute.description_kind:type_name -> tfplugin6.StringKind
	56,  // 24: tfplugin6.Schema.NestedBlock.block:type_name -> tfplugin6.Schema.Block
	3,   // 25: tfplugin6.Schema.NestedBlock.nesting:type_name -> tfplugin6.Schema.NestedBlock.NestingMode
	57,  // 26: tfplugin6.Schema.Object.attributes:type_name -> tfplugin6.Schema.Attribute
	...
	66,  // 31: tfplugin6.GetMetadata.Response.data_sources:type_name -> tfplugin6.GetMetadata.DataSourceMetadata
	67,  // 32: tfplugin6.GetMetadata.Response.resources:type_name -> tfplugin6.GetMetadata.ResourceMetadata
	65,  // 33: tfplugin6.GetMetadata.Response.functions:type_name -> tfplugin6.GetMetadata.FunctionMetadata
	64,  // 34: tfplugin6.GetMetadata.Response.ephemeral_resources:type_name -> tfplugin6.GetMetadata.EphemeralMetadata
	68,  // 35: tfplugin6.GetMetadata.Response.list_resources:type_name -> tfplugin6.GetMetadata.ListResourceMetadata
	69,  // 36: tfplugin6.GetMetadata.Response.state_stores:type_name -> tfplugin6.GetMetadata.StateStoreMetadata
	70,  // 37: tfplugin6.GetMetadata.Response.actions:type_name -> tfplugin6.GetMetadata.ActionMetadata
	15,  // 38: tfplugin6.GetProviderSchema.Response.provider:type_name -> tfplugin6.Schema
	73,  // 39: tfplugin6.GetProviderSchema.Response.resource_schemas:type_name -> tfplugin6.GetProviderSchema.Response.ResourceSchemasEntry
	74,  // 40: tfplugin6.GetProviderSchema.Response.data_source_schemas:type_name -> tfplugin6.GetProviderSchema.Response.DataSourceSchemasEntry
	75,  // 41: tfplugin6.GetProviderSchema.Response.functions:type_name -> tfplugin6.GetProviderSchema.Response.FunctionsEntry
	76,  // 42: tfplugin6.GetProviderSchema.Response.ephemeral_resource_schemas:type_name -> tfplugin6.GetProviderSchema.Response.EphemeralResourceSchemasEntry
	77,  // 43: tfplugin6.GetProviderSchema.Response.list_resource_schemas:type_name -> tfplugin6.GetProviderSchema.Response.ListResourceSchemasEntry
	78,  // 44: tfplugin6.GetProviderSchema.Response.state_store_schemas:type_name -> tfplugin6.GetProviderSchema.Response.StateStoreSchemasEntry
	79,  // 45: tfplugin6.GetProviderSchema.Response.action_schemas:type_name -> tfplugin6.GetProviderSchema.Response.ActionSchemasEntry
	...
	86,  // 61: tfplugin6.GetResourceIdentitySchemas.Response.identity_schemas:type_name -> tfplugin6.GetResourceIdentitySchemas.Response.IdentitySchemasEntry
	...
	104, // 108: tfplugin6.ImportResourceState.Response.imported_resources:type_name -> tfplugin6.ImportResourceState.ImportedResource
	...
	139, // 125: tfplugin6.OpenEphemeralResource.Response.renew_at:type_name -> google.protobuf.Timestamp
	...
	139, // 129: tfplugin6.RenewEphemeralResource.Response.renew_at:type_name -> google.protobuf.Timestamp
	7,   // 130: tfplugin6.CloseEphemeralResource.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	118, // 131: tfplugin6.GetFunctions.Response.functions:type_name -> tfplugin6.GetFunctions.Response.FunctionsEntry
	...
	7,   // 142: tfplugin6.ValidateListResourceConfig.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	6,   // 143: tfplugin6.ValidateStateStore.Request.config:type_name -> tfplugin6.DynamicValue
	7,   // 144: tfplugin6.ValidateStateStore.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	6,   // 145: tfplugin6.ConfigureStateStore.Request.config:type_name -> tfplugin6.DynamicValue
	7,   // 146: tfplugin6.ConfigureStateStore.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	131, // 147: tfplugin6.PlanAction.Request.linked_resources:type_name -> tfplugin6.PlanAction.Request.LinkedResource
	6,   // 148: tfplugin6.PlanAction.Request.config:type_name -> tfplugin6.DynamicValue
	18,  // 149: tfplugin6.PlanAction.Request.client_capabilities:type_name -> tfplugin6.ClientCapabilities
	132, // 150: tfplugin6.PlanAction.Response.linked_resources:type_name -> tfplugin6.PlanAction.Response.LinkedResource
	7,   // 151: tfplugin6.PlanAction.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	19,  // 152: tfplugin6.PlanAction.Response.deferred:type_name -> tfplugin6.Deferred
	6,   // 153: tfplugin6.PlanAction.Request.LinkedResource.prior_state:type_name -> tfplugin6.DynamicValue
	6,   // 154: tfplugin6.PlanAction.Request.LinkedResource.planned_state:type_name -> tfplugin6.DynamicValue
	6,   // 155: tfplugin6.PlanAction.Request.LinkedResource.config:type_name -> tfplugin6.DynamicValue
	13,  // 156: tfplugin6.PlanAction.Request.LinkedResource.prior_identity:type_name -> tfplugin6.ResourceIdentityData
	6,   // 157: tfplugin6.PlanAction.Response.LinkedResource.planned_state:type_name -> tfplugin6.DynamicValue
	13,  // 158: tfplugin6.PlanAction.Response.LinkedResource.planned_identity:type_name -> tfplugin6.ResourceIdentityData
	135, // 159: tfplugin6.InvokeAction.Request.linked_resources:type_name -> tfplugin6.InvokeAction.Request.LinkedResource
	6,   // 160: tfplugin6.InvokeAction.Request.config:type_name -> tfplugin6.DynamicValue
	136, // 161: tfplugin6.InvokeAction.Event.progress:type_name -> tfplugin6.InvokeAction.Event.Progress
	137, // 162: tfplugin6.InvokeAction.Event.completed:type_name -> tfplugin6.InvokeAction.Event.Completed
	6,   // 163: tfplugin6.InvokeAction.Request.LinkedResource.prior_state:type_name -> tfplugin6.DynamicValue
	6,   // 164: tfplugin6.InvokeAction.Request.LinkedResource.planned_state:type_name -> tfplugin6.DynamicValue
	6,   // 165: tfplugin6.InvokeAction.Request.LinkedResource.config:type_name -> tfplugin6.DynamicValue
	13,  // 166: tfplugin6.InvokeAction.Request.LinkedResource.planned_identity:type_name -> tfplugin6.ResourceIdentityData
	138, // 167: tfplugin6.InvokeAction.Event.Completed.linked_resources:type_name -> tfplugin6.InvokeAction.Event.Completed.LinkedResource
	7,   // 168: tfplugin6.InvokeAction.Event.Completed.diagnostics:type_name -> tfplugin6.Diagnostic
	6,   // 169: tfplugin6.InvokeAction.Event.Completed.LinkedResource.new_state:type_name -> tfplugin6.DynamicValue
	13,  // 170: tfplugin6.InvokeAction.Event.Completed.LinkedResource.new_identity:type_name -> tfplugin6.ResourceIdentityData
	62,  // 171: tfplugin6.Provider.GetMetadata:input_type -> tfplugin6.GetMetadata.Request
	71,  // 172: tfplugin6.Provider.GetProviderSchema:input_type -> tfplugin6.GetProviderSchema.Request
	80,  // 173: tfplugin6.Provider.ValidateProviderConfig:input_type -> tfplugin6.ValidateProviderConfig.Request
	89,  // 174: tfplugin6.Provider.ValidateResourceConfig:input_type -> tfplugin6.ValidateResourceConfig.Request
	91,  // 175: tfplugin6.Provider.ValidateDataResourceConfig:input_type -> tfplugin6.ValidateDataResourceConfig.Request
	82,  // 176: tfplugin6.Provider.UpgradeResourceState:input_type -> tfplugin6.UpgradeResourceState.Request
	84,  // 177: tfplugin6.Provider.GetResourceIdentitySchemas:input_type -> tfplugin6.GetResourceIdentitySchemas.Request
	87,  // 178: tfplugin6.Provider.UpgradeResourceIdentity:input_type -> tfplugin6.UpgradeResourceIdentity.Request
	95,  // 179: tfplugin6.Provider.ConfigureProvider:input_type -> tfplugin6.ConfigureProvider.Request
	97,  // 180: tfplugin6.Provider.ReadResource:input_type -> tfplugin6.ReadResource.Request
	99,  // 181: tfplugin6.Provider.PlanResourceChange:input_type -> tfplugin6.PlanResourceChange.Request
	101, // 182: tfplugin6.Provider.ApplyResourceChange:input_type -> tfplugin6.ApplyResourceChange.Request
	103, // 183: tfplugin6.Provider.ImportResourceState:input_type -> tfplugin6.ImportResourceState.Request
	106, // 184: tfplugin6.Provider.MoveResourceState:input_type -> tfplugin6.MoveResourceState.Request
	108, // 185: tfplugin6.Provider.ReadDataSource:input_type -> tfplugin6.ReadDataSource.Request
	93,  // 186: tfplugin6.Provider.ValidateEphemeralResourceConfig:input_type -> tfplugin6.ValidateEphemeralResourceConfig.Request
	110, // 187: tfplugin6.Provider.OpenEphemeralResource:input_type -> tfplugin6.OpenEphemeralResource.Request
	112, // 188: tfplugin6.Provider.RenewEphemeralResource:input_type -> tfplugin6.RenewEphemeralResource.Request
	114, // 189: tfplugin6.Provider.CloseEphemeralResource:input_type -> tfplugin6.CloseEphemeralResource.Request
	121, // 190: tfplugin6.Provider.ListResource:input_type -> tfplugin6.ListResource.Request
	123, // 191: tfplugin6.Provider.ValidateListResourceConfig:input_type -> tfplugin6.ValidateListResourceConfig.Request
	116, // 192: tfplugin6.Provider.GetFunctions:input_type -> tfplugin6.GetFunctions.Request
	119, // 193: tfplugin6.Provider.CallFunction:input_type -> tfplugin6.CallFunction.Request
	125, // 194: tfplugin6.Provider.ValidateStateStoreConfig:input_type -> tfplugin6.ValidateStateStore.Request
	127, // 195: tfplugin6.Provider.ConfigureStateStore:input_type -> tfplugin6.ConfigureStateStore.Request
	129, // 196: tfplugin6.Provider.PlanAction:input_type -> tfplugin6.PlanAction.Request
	133, // 197: tfplugin6.Provider.InvokeAction:input_type -> tfplugin6.InvokeAction.Request
	48,  // 198: tfplugin6.Provider.StopProvider:input_type -> tfplugin6.StopProvider.Request
	63,  // 199: tfplugin6.Provider.GetMetadata:output_type -> tfplugin6.GetMetadata.Response
	72,  // 200: tfplugin6.Provider.GetProviderSchema:output_type -> tfplugin6.GetProviderSchema.Response
	81,  // 201: tfplugin6.Provider.ValidateProviderConfig:output_type -> tfplugin6.ValidateProviderConfig.Response
	90,  // 202: tfplugin6.Provider.ValidateResourceConfig:output_type -> tfplugin6.ValidateResourceConfig.Response
	92,  // 203: tfplugin6.Provider.ValidateDataResourceConfig:output_type -> tfplugin6.ValidateDataResourceConfig.Response
	83,  // 204: tfplugin6.Provider.UpgradeResourceState:output_type -> tfplugin6.UpgradeResourceState.Response
	85,  // 205: tfplugin6.Provider.GetResourceIdentitySchemas:output_type -> tfplugin6.GetResourceIdentitySchemas.Response
	88,  // 206: tfplugin6.Provider.UpgradeResourceIdentity:output_type -> tfplugin6.UpgradeResourceIdentity.Response
	96,  // 207: tfplugin6.Provider.ConfigureProvider:output_type -> tfplugin6.ConfigureProvider.Response
	98,  // 208: tfplugin6.Provider.ReadResource:output_type -> tfplugin6.ReadResource.Response
	100, // 209: tfplugin6.Provider.PlanResourceChange:output_type -> tfplugin6.PlanResourceChange.Response
	102, // 210: tfplugin6.Provider.ApplyResourceChange:output_type -> tfplugin6.ApplyResourceChange.Response
	105, // 211: tfplugin6.Provider.ImportResourceState:output_type -> tfplugin6.ImportResourceState.Response
	107, // 212: tfplugin6.Provider.MoveResourceState:output_type -> tfplugin6.MoveResourceState.Response
	109, // 213: tfplugin6.Provider.ReadDataSource:output_type -> tfplugin6.ReadDataSource.Response
	94,  // 214: tfplugin6.Provider.ValidateEphemeralResourceConfig:output_type -> tfplugin6.ValidateEphemeralResourceConfig.Response
	111, // 215: tfplugin6.Provider.OpenEphemeralResource:output_type -> tfplugin6.OpenEphemeralResource.Response
	113, // 216: tfplugin6.Provider.RenewEphemeralResource:output_type -> tfplugin6.RenewEphemeralResource.Response
	115, // 217: tfplugin6.Provider.CloseEphemeralResource:output_type -> tfplugin6.CloseEphemeralResource.Response
	122, // 218: tfplugin6.Provider.ListResource:output_type -> tfplugin6.ListResource.Event
	124, // 219: tfplugin6.Provider.ValidateListResourceConfig:output_type -> tfplugin6.ValidateListResourceConfig.Response
	117, // 220: tfplugin6.Provider.GetFunctions:output_type -> tfplugin6.GetFunctions.Response
	120, // 221: tfplugin6.Provider.CallFunction:output_type -> tfplugin6.CallFunction.Response
	126, // 222: tfplugin6.Provider.ValidateStateStoreConfig:output_type -> tfplugin6.ValidateStateStore.Response
	128, // 223: tfplugin6.Provider.ConfigureStateStore:output_type -> tfplugin6.ConfigureStateStore.Response
	130, // 224: tfplugin6.Provider.PlanAction:output_type -> tfplugin6.PlanAction.Response
	134, // 225: tfplugin6.Provider.InvokeAction:output_type -> tfplugin6.InvokeAction.Event
	49,  // 226: tfplugin6.Provider.StopProvider:output_type -> tfplugin6.StopProvider.Response
