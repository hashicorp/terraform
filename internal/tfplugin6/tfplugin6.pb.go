...
var file_tfplugin6_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x65, 0x6d, 0x22, 0x9e, 0x03, 0x0a, 0x13, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x52,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x1a, 0x67, 0x0a, 0x07,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0x78, 0x0a, 0x10, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x65,
...
var file_tfplugin6_proto_depIdxs = []int32{
	...
	4,  // 50: tfplugin6.ImportResourceState.Request.config:type_name -> tfplugin6.DynamicValue
	4,  // 51: tfplugin6.ImportResourceState.ImportedResource.state:type_name -> tfplugin6.DynamicValue
	51, // 52: tfplugin6.ImportResourceState.Response.imported_resources:type_name -> tfplugin6.ImportResourceState.ImportedResource
	5,  // 53: tfplugin6.ImportResourceState.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	4,  // 54: tfplugin6.ReadDataSource.Request.config:type_name -> tfplugin6.DynamicValue
	4,  // 55: tfplugin6.ReadDataSource.Request.provider_meta:type_name -> tfplugin6.DynamicValue
	4,  // 56: tfplugin6.ReadDataSource.Response.state:type_name -> tfplugin6.DynamicValue
	5,  // 57: tfplugin6.ReadDataSource.Response.diagnostics:type_name -> tfplugin6.Diagnostic
	29, // 58: tfplugin6.Provider.GetProviderSchema:input_type -> tfplugin6.GetProviderSchema.Request
	34, // 59: tfplugin6.Provider.ValidateProviderConfig:input_type -> tfplugin6.ValidateProviderConfig.Request
	38, // 60: tfplugin6.Provider.ValidateResourceConfig:input_type -> tfplugin6.ValidateResourceConfig.Request
	40, // 61: tfplugin6.Provider.ValidateDataResourceConfig:input_type -> tfplugin6.ValidateDataResourceConfig.Request
	36, // 62: tfplugin6.Provider.UpgradeResourceState:input_type -> tfplugin6.UpgradeResourceState.Request
	42, // 63: tfplugin6.Provider.ConfigureProvider:input_type -> tfplugin6.ConfigureProvider.Request
	44, // 64: tfplugin6.Provider.ReadResource:input_type -> tfplugin6.ReadResource.Request
	46, // 65: tfplugin6.Provider.PlanResourceChange:input_type -> tfplugin6.PlanResourceChange.Request
	48, // 66: tfplugin6.Provider.ApplyResourceChange:input_type -> tfplugin6.ApplyResourceChange.Request
	50, // 67: tfplugin6.Provider.ImportResourceState:input_type -> tfplugin6.ImportResourceState.Request
	53, // 68: tfplugin6.Provider.ReadDataSource:input_type -> tfplugin6.ReadDataSource.Request
	22, // 69: tfplugin6.Provider.StopProvider:input_type -> tfplugin6.StopProvider.Request
	30, // 70: tfplugin6.Provider.GetProviderSchema:output_type -> tfplugin6.GetProviderSchema.Response
	35, // 71: tfplugin6.Provider.ValidateProviderConfig:output_type -> tfplugin6.ValidateProviderConfig.Response
	39, // 72: tfplugin6.Provider.ValidateResourceConfig:output_type -> tfplugin6.ValidateResourceConfig.Response
	41, // 73: tfplugin6.Provider.ValidateDataResourceConfig:output_type -> tfplugin6.ValidateDataResourceConfig.Response
	37, // 74: tfplugin6.Provider.UpgradeResourceState:output_type -> tfplugin6.UpgradeResourceState.Response
	43, // 75: tfplugin6.Provider.ConfigureProvider:output_type -> tfplugin6.ConfigureProvider.Response
	45, // 76: tfplugin6.Provider.ReadResource:output_type -> tfplugin6.ReadResource.Response
	47, // 77: tfplugin6.Provider.PlanResourceChange:output_type -> tfplugin6.PlanResourceChange.Response
	49, // 78: tfplugin6.Provider.ApplyResourceChange:output_type -> tfplugin6.ApplyResourceChange.Response
	52, // 79: tfplugin6.Provider.ImportResourceState:output_type -> tfplugin6.ImportResourceState.Response
	54, // 80: tfplugin6.Provider.ReadDataSource:output_type -> tfplugin6.ReadDataSource.Response
	23, // 81: tfplugin6.Provider.StopProvider:output_type -> tfplugin6.StopProvider.Response
