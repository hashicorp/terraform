...
func file_stacks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_stacks_proto_msgTypes[105].Exporter = func(v any, i int) any {
		...
		file_stacks_proto_msgTypes[106].Exporter = func(v any, i int) any {
		...
		file_stacks_proto_msgTypes[107].Exporter = func(v any, i int) any {
