...
var file_terraform1_proto_rawDesc = []byte{
	...
	0xa0, 0x07, 0x0a, 0x0d, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x64, 0x43, 0x68, 0x61, 0x6e, 0x67,
	...
	0x61, 0x6c, 0x75, 0x65, 0x1a, 0xa4, 0x02, 0x0a, 0x11, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x44,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x69, 0x6d, 0x1a, 0x58, 0x0a,
	...
	0x6e, 0x67, 0x22, 0x93, 0x14, 0x0a, 0x13, 0x53, 0x74, 0x61, 0x63, 0x6b, 0x43, 0x68, 0x61, 0x6e,
	...
	0x10, 0x06, 0x1a, 0xb9, 0x02, 0x0a, 0x16, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49,
	...
	0x07, 0x12, 0x0b, 0x0a, 0x07, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x45, 0x44, 0x10, 0x08, 0x1a, 0xcb,
...
var file_terraform1_proto_depIdxs = []int32{
	...
	0,   // 102: terraform1.AppliedChange.ResourceInstance.resource_mode:type_name -> terraform1.ResourceMode
	37,  // 103: terraform1.AppliedChange.OutputValue.new_value:type_name -> terraform1.DynamicValue
	41,  // 104: terraform1.StackChangeProgress.ComponentInstanceStatus.addr:type_name -> terraform1.ComponentInstanceInStackAddr
	5,   // 105: terraform1.StackChangeProgress.ComponentInstanceStatus.status:type_name -> terraform1.StackChangeProgress.ComponentInstanceStatus.Status
	43,  // 106: terraform1.StackChangeProgress.ResourceInstanceStatus.addr:type_name -> terraform1.ResourceInstanceObjectInStackAddr
	6,   // 107: terraform1.StackChangeProgress.ResourceInstanceStatus.status:type_name -> terraform1.StackChangeProgress.ResourceInstanceStatus.Status
	43,  // 108: terraform1.StackChangeProgress.ResourceInstancePlannedChange.addr:type_name -> terraform1.ResourceInstanceObjectInStackAddr
	2,   // 109: terraform1.StackChangeProgress.ResourceInstancePlannedChange.actions:type_name -> terraform1.ChangeType
	136, // 110: terraform1.StackChangeProgress.ResourceInstancePlannedChange.moved:type_name -> terraform1.StackChangeProgress.ResourceInstancePlannedChange.Moved
	137, // 111: terraform1.StackChangeProgress.ResourceInstancePlannedChange.imported:type_name -> terraform1.StackChangeProgress.ResourceInstancePlannedChange.Imported
	43,  // 112: terraform1.StackChangeProgress.ProvisionerStatus.addr:type_name -> terraform1.ResourceInstanceObjectInStackAddr
	132, // 113: terraform1.StackChangeProgress.ProvisionerStatus.status:type_name -> terraform1.StackChangeProgress.ProvisionerStatus
	43,  // 114: terraform1.StackChangeProgress.ProvisionerOutput.addr:type_name -> terraform1.ResourceInstanceObjectInStackAddr
	41,  // 115: terraform1.StackChangeProgress.ComponentInstanceChanges.addr:type_name -> terraform1.ComponentInstanceInStackAddr
	42,  // 116: terraform1.StackChangeProgress.ResourceInstancePlannedChange.Moved.prev_addr:type_name -> terraform1.ResourceInstanceInStackAddr
	139, // 117: terraform1.Schema.Block.attributes:type_name -> terraform1.Schema.Attribute
	140, // 118: terraform1.Schema.Block.block_types:type_name -> terraform1.Schema.NestedBlock
	142, // 119: terraform1.Schema.Block.description:type_name -> terraform1.Schema.DocString
	141, // 120: terraform1.Schema.Attribute.nested_type:type_name -> terraform1.Schema.Object
	142, // 121: terraform1.Schema.Attribute.description:type_name -> terraform1.Schema.DocString
	138, // 122: terraform1.Schema.NestedBlock.block:type_name -> terraform1.Schema.Block
	9,   // 123: terraform1.Schema.NestedBlock.nesting:type_name -> terraform1.Schema.NestedBlock.NestingMode
	139, // 124: terraform1.Schema.Object.attributes:type_name -> terraform1.Schema.Attribute
	10,  // 125: terraform1.Schema.Object.nesting:type_name -> terraform1.Schema.Object.NestingMode
	11,  // 126: terraform1.Schema.DocString.format:type_name -> terraform1.Schema.DocString.Format
	48,  // 127: terraform1.ProviderPackageVersions.Response.diagnostics:type_name -> terraform1.Diagnostic
	147, // 128: terraform1.FetchProviderPackage.Response.results:type_name -> terraform1.FetchProviderPackage.PlatformResult
	48,  // 129: terraform1.FetchProviderPackage.Response.diagnostics:type_name -> terraform1.Diagnostic
	27,  // 130: terraform1.FetchProviderPackage.PlatformResult.provider:type_name -> terraform1.ProviderPackage
	48,  // 131: terraform1.FetchProviderPackage.PlatformResult.diagnostics:type_name -> terraform1.Diagnostic
	48,  // 132: terraform1.ModulePackageVersions.Response.diagnostics:type_name -> terraform1.Diagnostic
	48,  // 133: terraform1.ModulePackageSourceAddr.Response.diagnostics:type_name -> terraform1.Diagnostic
	48,  // 134: terraform1.FetchModulePackage.Response.diagnostics:type_name -> terraform1.Diagnostic
	57,  // 135: terraform1.Setup.Handshake:input_type -> terraform1.Handshake.Request
	59,  // 136: terraform1.Dependencies.OpenSourceBundle:input_type -> terraform1.OpenSourceBundle.Request
	61,  // 137: terraform1.Dependencies.CloseSourceBundle:input_type -> terraform1.CloseSourceBundle.Request
	63,  // 138: terraform1.Dependencies.OpenDependencyLockFile:input_type -> terraform1.OpenDependencyLockFile.Request
	65,  // 139: terraform1.Dependencies.CreateDependencyLocks:input_type -> terraform1.CreateDependencyLocks.Request
	67,  // 140: terraform1.Dependencies.CloseDependencyLocks:input_type -> terraform1.CloseDependencyLocks.Request
	69,  // 141: terraform1.Dependencies.GetLockedProviderDependencies:input_type -> terraform1.GetLockedProviderDependencies.Request
	71,  // 142: terraform1.Dependencies.BuildProviderPluginCache:input_type -> terraform1.BuildProviderPluginCache.Request
	80,  // 143: terraform1.Dependencies.OpenProviderPluginCache:input_type -> terraform1.OpenProviderPluginCache.Request
	82,  // 144: terraform1.Dependencies.CloseProviderPluginCache:input_type -> terraform1.CloseProviderPluginCache.Request
	84,  // 145: terraform1.Dependencies.GetCachedProviders:input_type -> terraform1.GetCachedProviders.Request
	86,  // 146: terraform1.Dependencies.GetBuiltInProviders:input_type -> terraform1.GetBuiltInProviders.Request
	88,  // 147: terraform1.Dependencies.GetProviderSchema:input_type -> terraform1.GetProviderSchema.Request
	92,  // 148: terraform1.Stacks.OpenStackConfiguration:input_type -> terraform1.OpenStackConfiguration.Request
	94,  // 149: terraform1.Stacks.CloseStackConfiguration:input_type -> terraform1.CloseStackConfiguration.Request
	96,  // 150: terraform1.Stacks.ValidateStackConfiguration:input_type -> terraform1.ValidateStackConfiguration.Request
	98,  // 151: terraform1.Stacks.FindStackConfigurationComponents:input_type -> terraform1.FindStackConfigurationComponents.Request
	105, // 152: terraform1.Stacks.PlanStackChanges:input_type -> terraform1.PlanStackChanges.Request
	109, // 153: terraform1.Stacks.ApplyStackChanges:input_type -> terraform1.ApplyStackChanges.Request
	111, // 154: terraform1.Stacks.OpenStackInspector:input_type -> terraform1.OpenStackInspector.Request
	115, // 155: terraform1.Stacks.InspectExpressionResult:input_type -> terraform1.InspectExpressionResult.Request
	143, // 156: terraform1.Packages.ProviderPackageVersions:input_type -> terraform1.ProviderPackageVersions.Request
	145, // 157: terraform1.Packages.FetchProviderPackage:input_type -> terraform1.FetchProviderPackage.Request
	148, // 158: terraform1.Packages.ModulePackageVersions:input_type -> terraform1.ModulePackageVersions.Request
	150, // 159: terraform1.Packages.ModulePackageSourceAddr:input_type -> terraform1.ModulePackageSourceAddr.Request
	152, // 160: terraform1.Packages.FetchModulePackage:input_type -> terraform1.FetchModulePackage.Request
	58,  // 161: terraform1.Setup.Handshake:output_type -> terraform1.Handshake.Response
	60,  // 162: terraform1.Dependencies.OpenSourceBundle:output_type -> terraform1.OpenSourceBundle.Response
	62,  // 163: terraform1.Dependencies.CloseSourceBundle:output_type -> terraform1.CloseSourceBundle.Response
	64,  // 164: terraform1.Dependencies.OpenDependencyLockFile:output_type -> terraform1.OpenDependencyLockFile.Response
	66,  // 165: terraform1.Dependencies.CreateDependencyLocks:output_type -> terraform1.CreateDependencyLocks.Response
	68,  // 166: terraform1.Dependencies.CloseDependencyLocks:output_type -> terraform1.CloseDependencyLocks.Response
	70,  // 167: terraform1.Dependencies.GetLockedProviderDependencies:output_type -> terraform1.GetLockedProviderDependencies.Response
	72,  // 168: terraform1.Dependencies.BuildProviderPluginCache:output_type -> terraform1.BuildProviderPluginCache.Event
	81,  // 169: terraform1.Dependencies.OpenProviderPluginCache:output_type -> terraform1.OpenProviderPluginCache.Response
	83,  // 170: terraform1.Dependencies.CloseProviderPluginCache:output_type -> terraform1.CloseProviderPluginCache.Response
	85,  // 171: terraform1.Dependencies.GetCachedProviders:output_type -> terraform1.GetCachedProviders.Response
	87,  // 172: terraform1.Dependencies.GetBuiltInProviders:output_type -> terraform1.GetBuiltInProviders.Response
	89,  // 173: terraform1.Dependencies.GetProviderSchema:output_type -> terraform1.GetProviderSchema.Response
	93,  // 174: terraform1.Stacks.OpenStackConfiguration:output_type -> terraform1.OpenStackConfiguration.Response
	95,  // 175: terraform1.Stacks.CloseStackConfiguration:output_type -> terraform1.CloseStackConfiguration.Response
	97,  // 176: terraform1.Stacks.ValidateStackConfiguration:output_type -> terraform1.ValidateStackConfiguration.Response
	99,  // 177: terraform1.Stacks.FindStackConfigurationComponents:output_type -> terraform1.FindStackConfigurationComponents.Response
	106, // 178: terraform1.Stacks.PlanStackChanges:output_type -> terraform1.PlanStackChanges.Event
	110, // 179: terraform1.Stacks.ApplyStackChanges:output_type -> terraform1.ApplyStackChanges.Event
	112, // 180: terraform1.Stacks.OpenStackInspector:output_type -> terraform1.OpenStackInspector.Response
	116, // 181: terraform1.Stacks.InspectExpressionResult:output_type -> terraform1.InspectExpressionResult.Response
	144, // 182: terraform1.Packages.ProviderPackageVersions:output_type -> terraform1.ProviderPackageVersions.Response
	146, // 183: terraform1.Packages.FetchProviderPackage:output_type -> terraform1.FetchProviderPackage.Response
	149, // 184: terraform1.Packages.ModulePackageVersions:output_type -> terraform1.ModulePackageVersions.Response
	151, // 185: terraform1.Packages.ModulePackageSourceAddr:output_type -> terraform1.ModulePackageSourceAddr.Response
	153, // 186: terraform1.Packages.FetchModulePackage:output_type -> terraform1.FetchModulePackage.Response
