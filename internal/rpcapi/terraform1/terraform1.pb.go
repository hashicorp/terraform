...
var file_terraform1_proto_rawDesc = []byte{
	...
	0x22, 0xb1, 0x09, 0x0a, 0x0d, 0x50, 0x6c, 0x61, 0x6e, 0x6e, 0x65, 0x64, 0x43, 0x68, 0x61, 0x6e,
	...
	0x6c, 0x61, 0x6e, 0x6e, 0x65, 0x64, 0x1a, 0x72, 0x0a, 0x11, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e,
	...
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x41, 0x64, 0x64, 0x72, 0x1a, 0xca, 0x03, 0x0a, 0x10, 0x52,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x2a, 0x35, 0x0a,
...
var file_terraform1_proto_depIdxs = []int32{
	...
	17, // 31: terraform1.PlannedChange.ResourceInstance.addr:type_name -> terraform1.ResourceInstanceInStackAddr
	1,  // 32: terraform1.PlannedChange.ResourceInstance.actions:type_name -> terraform1.ChangeType
	15, // 33: terraform1.PlannedChange.ResourceInstance.values:type_name -> terraform1.DynamicValueChange
	49, // 34: terraform1.PlannedChange.ResourceInstance.moved:type_name -> terraform1.PlannedChange.ResourceInstance.Moved
	50, // 35: terraform1.PlannedChange.ResourceInstance.imported:type_name -> terraform1.PlannedChange.ResourceInstance.Imported
	1,  // 36: terraform1.PlannedChange.OutputValue.actions:type_name -> terraform1.ChangeType
	15, // 37: terraform1.PlannedChange.OutputValue.values:type_name -> terraform1.DynamicValueChange
	17, // 38: terraform1.PlannedChange.ResourceInstance.Moved.prev_addr:type_name -> terraform1.ResourceInstanceInStackAddr
	23, // 39: terraform1.Setup.Handshake:input_type -> terraform1.Handshake.Request
	25, // 40: terraform1.Dependencies.OpenSourceBundle:input_type -> terraform1.OpenSourceBundle.Request
	27, // 41: terraform1.Dependencies.CloseSourceBundle:input_type -> terraform1.CloseSourceBundle.Request
	29, // 42: terraform1.Stacks.OpenStackConfiguration:input_type -> terraform1.OpenStackConfiguration.Request
	31, // 43: terraform1.Stacks.CloseStackConfiguration:input_type -> terraform1.CloseStackConfiguration.Request
	40, // 44: terraform1.Stacks.FindStackConfigurationProviders:input_type -> terraform1.FindStackConfigurationProviders.Request
	33, // 45: terraform1.Stacks.FindStackConfigurationComponents:input_type -> terraform1.FindStackConfigurationComponents.Request
	42, // 46: terraform1.Stacks.PlanStackChanges:input_type -> terraform1.PlanStackChanges.Request
	24, // 47: terraform1.Setup.Handshake:output_type -> terraform1.Handshake.Response
	26, // 48: terraform1.Dependencies.OpenSourceBundle:output_type -> terraform1.OpenSourceBundle.Response
	28, // 49: terraform1.Dependencies.CloseSourceBundle:output_type -> terraform1.CloseSourceBundle.Response
	30, // 50: terraform1.Stacks.OpenStackConfiguration:output_type -> terraform1.OpenStackConfiguration.Response
	32, // 51: terraform1.Stacks.CloseStackConfiguration:output_type -> terraform1.CloseStackConfiguration.Response
	41, // 52: terraform1.Stacks.FindStackConfigurationProviders:output_type -> terraform1.FindStackConfigurationProviders.Response
	34, // 53: terraform1.Stacks.FindStackConfigurationComponents:output_type -> terraform1.FindStackConfigurationComponents.Response
	43, // 54: terraform1.Stacks.PlanStackChanges:output_type -> terraform1.PlanStackChanges.Event
