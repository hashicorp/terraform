...
type dependenciesServer struct {
	rawdependencies1.UnimplementedDependenciesServer
...
func (s *dependenciesServer) OpenSourceBundle(ctx context.Context, req *rawdependencies1.OpenSourceBundle_Request) (*rawdependencies1.OpenSourceBundle_Response, error) {
	...
	return &rawdependencies1.OpenSourceBundle_Response{
		SourceBundleHandle: hnd.ForProtobuf(),
	}, err
}

func (s *dependenciesServer) CloseSourceBundle(ctx context.Context, req *rawdependencies1.CloseSourceBundle_Request) (*rawdependencies1.CloseSourceBundle_Response, error) {
	hnd := handle[*sourcebundle.Bundle](req.SourceBundleHandle)
	err := s.handles.CloseSourceBundle(hnd)
	if err != nil {
		return nil, status.Error(codes.InvalidArgument, err.Error())
	}
	return &rawdependencies1.CloseSourceBundle_Response{}, nil
}

func (s *dependenciesServer) OpenDependencyLockFile(ctx context.Context, req *rawdependencies1.OpenDependencyLockFile_Request) (*rawdependencies1.OpenDependencyLockFile_Response, error) {
	...
	if diags.HasErrors() {
		return &rawdependencies1.OpenDependencyLockFile_Response{
...
func (s *dependenciesServer) CreateDependencyLocks(ctx context.Context, req *rawdependencies1.CreateDependencyLocks_Request) (*rawdependencies1.CreateDependencyLocks_Response, error) {
	...
	locksHnd := s.handles.NewDependencyLocks(locks)
	return &rawdependencies1.CreateDependencyLocks_Response{
		DependencyLocksHandle: locksHnd.ForProtobuf(),
	}, nil
}

func (s *dependenciesServer) CloseDependencyLocks(ctx context.Context, req *rawdependencies1.CloseDependencyLocks_Request) (*rawdependencies1.CloseDependencyLocks_Response, error) {
	...
	return &rawdependencies1.CloseDependencyLocks_Response{}, nil
}

func (s *dependenciesServer) GetLockedProviderDependencies(ctx context.Context, req *rawdependencies1.GetLockedProviderDependencies_Request) (*rawdependencies1.GetLockedProviderDependencies_Response, error) {
	hnd := handle[*depsfile.Locks](req.DependencyLocksHandle)
	...
	protoProviders := make([]*rawdependencies1.ProviderPackage, 0, len(providers))
	for _, lock := range providers {
		...
		protoProviders = append(protoProviders, &rawdependencies1.ProviderPackage{
	...
	return &rawdependencies1.GetLockedProviderDependencies_Response{
		SelectedProviders: protoProviders,
	}, nil
}

func (s *dependenciesServer) BuildProviderPluginCache(req *rawdependencies1.BuildProviderPluginCache_Request, evts rawdependencies1.Dependencies_BuildProviderPluginCacheServer) error {
	ctx := evts.Context()
	...
	for _, protoMethod := range req.InstallationMethods {
		...
		case *rawdependencies1.BuildProviderPluginCache_Request_InstallMethod_Direct:
			source = getproviders.NewRegistrySource(s.services)
		case *rawdependencies1.BuildProviderPluginCache_Request_InstallMethod_LocalMirrorDir:
			source = getproviders.NewFilesystemMirrorSource(arg.LocalMirrorDir)
		case *rawdependencies1.BuildProviderPluginCache_Request_InstallMethod_NetworkMirrorUrl:
	...
	instEvts := providercache.InstallerEvents{
		PendingProviders: func(reqs map[addrs.Provider]getproviders.VersionConstraints) {
			...
			// events.
			protoConstraints := make([]*rawdependencies1.BuildProviderPluginCache_Event_ProviderConstraints, 0, len(reqs))
			for addr, constraints := range reqs {
				protoConstraints = append(protoConstraints, &rawdependencies1.BuildProviderPluginCache_Event_ProviderConstraints{
					SourceAddr: addr.ForDisplay(),
					Versions:   getproviders.VersionConstraintsString(constraints),
				})
			}
			evts.Send(&rawdependencies1.BuildProviderPluginCache_Event{
				Event: &rawdependencies1.BuildProviderPluginCache_Event_Pending_{
					Pending: &rawdependencies1.BuildProviderPluginCache_Event_Pending{
		...
		ProviderAlreadyInstalled: func(provider addrs.Provider, selectedVersion getproviders.Version) {
			evts.Send(&rawdependencies1.BuildProviderPluginCache_Event{
				Event: &rawdependencies1.BuildProviderPluginCache_Event_AlreadyInstalled{
					AlreadyInstalled: &rawdependencies1.BuildProviderPluginCache_Event_ProviderVersion{
		...
		BuiltInProviderAvailable: func(provider addrs.Provider) {
			evts.Send(&rawdependencies1.BuildProviderPluginCache_Event{
				Event: &rawdependencies1.BuildProviderPluginCache_Event_BuiltIn{
					BuiltIn: &rawdependencies1.BuildProviderPluginCache_Event_ProviderVersion{
						SourceAddr: provider.ForDisplay(),
					},
				},
			})
		...
		BuiltInProviderFailure: func(provider addrs.Provider, err error) {
			evts.Send(&rawdependencies1.BuildProviderPluginCache_Event{
				Event: &rawdependencies1.BuildProviderPluginCache_Event_Diagnostic{
		...
		QueryPackagesBegin: func(provider addrs.Provider, versionConstraints getproviders.VersionConstraints, locked bool) {
			evts.Send(&rawdependencies1.BuildProviderPluginCache_Event{
				Event: &rawdependencies1.BuildProviderPluginCache_Event_QueryBegin{
					QueryBegin: &rawdependencies1.BuildProviderPluginCache_Event_ProviderConstraints{
						SourceAddr: provider.ForDisplay(),
		...
		QueryPackagesSuccess: func(provider addrs.Provider, selectedVersion getproviders.Version) {
			evts.Send(&rawdependencies1.BuildProviderPluginCache_Event{
				Event: &rawdependencies1.BuildProviderPluginCache_Event_QuerySuccess{
					QuerySuccess: &rawdependencies1.BuildProviderPluginCache_Event_ProviderVersion{
						SourceAddr: provider.ForDisplay(),
						Version:    selectedVersion.String(),
					},
				},
		...
		QueryPackagesWarning: func(provider addrs.Provider, warn []string) {
			evts.Send(&rawdependencies1.BuildProviderPluginCache_Event{
				Event: &rawdependencies1.BuildProviderPluginCache_Event_QueryWarnings{
					QueryWarnings: &rawdependencies1.BuildProviderPluginCache_Event_ProviderWarnings{
						SourceAddr: provider.ForDisplay(),
						Warnings:   warn,
					},
				},
		...
		FetchPackageBegin: func(provider addrs.Provider, version getproviders.Version, location getproviders.PackageLocation) {
			evts.Send(&rawdependencies1.BuildProviderPluginCache_Event{
				Event: &rawdependencies1.BuildProviderPluginCache_Event_FetchBegin_{
					FetchBegin: &rawdependencies1.BuildProviderPluginCache_Event_FetchBegin{
						ProviderVersion: &rawdependencies1.BuildProviderPluginCache_Event_ProviderVersion{
							SourceAddr: provider.ForDisplay(),
		...
		FetchPackageSuccess: func(provider addrs.Provider, version getproviders.Version, localDir string, authResult *getproviders.PackageAuthenticationResult) {
			var protoAuthResult rawdependencies1.BuildProviderPluginCache_Event_FetchComplete_AuthResult
			var keyID string
			if authResult != nil {
				keyID = authResult.KeyID
				switch {
				case authResult.SignedByHashiCorp():
					protoAuthResult = rawdependencies1.BuildProviderPluginCache_Event_FetchComplete_OFFICIAL_SIGNED
				default:
					...
					protoAuthResult = rawdependencies1.BuildProviderPluginCache_Event_FetchComplete_UNKNOWN
				}
			}
			evts.Send(&rawdependencies1.BuildProviderPluginCache_Event{
				Event: &rawdependencies1.BuildProviderPluginCache_Event_FetchComplete_{
					FetchComplete: &rawdependencies1.BuildProviderPluginCache_Event_FetchComplete{
						ProviderVersion: &rawdependencies1.BuildProviderPluginCache_Event_ProviderVersion{
							SourceAddr: provider.ForDisplay(),
							Version:    version.String(),
						},
...
func (s *dependenciesServer) OpenProviderPluginCache(ctx context.Context, req *rawdependencies1.OpenProviderPluginCache_Request) (*rawdependencies1.OpenProviderPluginCache_Response, error) {
	var cacheDir *providercache.Dir
	if req.OverridePlatform == "" {
		cacheDir = providercache.NewDir(req.CacheDir)
	} else {
	...
	return &rawdependencies1.OpenProviderPluginCache_Response{
		ProviderCacheHandle: hnd.ForProtobuf(),
	}, nil
}

func (s *dependenciesServer) CloseProviderPluginCache(ctx context.Context, req *rawdependencies1.CloseProviderPluginCache_Request) (*rawdependencies1.CloseProviderPluginCache_Response, error) {
	...
	return &rawdependencies1.CloseProviderPluginCache_Response{}, nil
}

func (s *dependenciesServer) GetCachedProviders(ctx context.Context, req *rawdependencies1.GetCachedProviders_Request) (*rawdependencies1.GetCachedProviders_Response, error) {
	hnd := handle[*providercache.Dir](req.ProviderCacheHandle)
	...
	ret := make([]*rawdependencies1.ProviderPackage, 0, len(avail))
	for addr, pkgs := range avail {
		for _, pkg := range pkgs {
			...
			ret = append(ret, &rawdependencies1.ProviderPackage{
	...
	return &rawdependencies1.GetCachedProviders_Response{
		AvailableProviders: ret,
	}, nil
}

func (s *dependenciesServer) GetBuiltInProviders(ctx context.Context, req *rawdependencies1.GetBuiltInProviders_Request) (*rawdependencies1.GetBuiltInProviders_Response, error) {
	ret := make([]*rawdependencies1.ProviderPackage, 0, len(builtinProviders))
	...
	return &rawdependencies1.GetBuiltInProviders_Response{
		AvailableProviders: ret,
	}, nil
}

func (s *dependenciesServer) GetProviderSchema(ctx context.Context, req *rawdependencies1.GetProviderSchema_Request) (*rawdependencies1.GetProviderSchema_Response, error) {
	...
	return &rawdependencies1.GetProviderSchema_Response{
		Schema: providerSchemaToProto(schemaResp),
	}, nil
}

func resolveFinalSourceAddr(protoSourceAddr *rawrpc.SourceAddress, sources *sourcebundle.Bundle) (sourceaddrs.FinalSource, error) {
