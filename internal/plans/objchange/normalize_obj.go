...
// NormalizeObjectFromLegacySDK takes an object that may have been generated by
// the legacy Terraform SDK (i.e. returned from a provider with the
...
// block will never itself be unknown or null, instead representing that as a
// non-null value that may contain null/unknown values.
//
...
//
// This is clearly incompatible with computed blocks in protocol v6, so must not
// be called for anything using features from v6 or greater.
