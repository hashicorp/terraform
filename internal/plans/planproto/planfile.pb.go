...
type Plan struct {
	...
	ActionInvocations []*ActionInvocation `protobuf:"bytes,23,rep,name=action_invocations,json=actionInvocations,proto3" json:"action_invocations,omitempty"`
...
func (x *Plan) GetActionInvocations() []*ActionInvocation {
	if x != nil {
...
type ActionInvocation struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The absolute address of the action instancne that will be invoked.
	ActionAddr string `protobuf:"bytes,1,opt,name=action_addr,json=actionAddr,proto3" json:"action_addr,omitempty"`
	// Types that are valid to be assigned to Trigger:
	//
	//	*ActionInvocation_LifecycleTrigger_
	//	*ActionInvocation_CliTrigger_
	Trigger isActionInvocation_Trigger `protobuf_oneof:"trigger"`
	// msgpack-encoded HCL value of the configuration
	Config *DynamicValue `protobuf:"bytes,4,opt,name=config,proto3" json:"config,omitempty"`
	// An unordered set of paths into the config which are marked as
	// sensitive. Values at these paths should be obscured in human-readable
	// output.
	SensitivePaths []*Path `protobuf:"bytes,5,rep,name=sensitive_paths,json=sensitivePaths,proto3" json:"sensitive_paths,omitempty"`
	// Set to true if we are certain this action is going to be invoked.
	// Set to false if we are not sure, e.g. when the condition contains an unknown value.
	Certain       bool `protobuf:"varint,6,opt,name=certain,proto3" json:"certain,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ActionInvocation) GetActionAddr() string {
	if x != nil {
		return x.ActionAddr
	}
	return ""
...
func (x *ActionInvocation) GetTrigger() isActionInvocation_Trigger {
	if x != nil {
		return x.Trigger
	}
	return nil
...
func (x *ActionInvocation) GetLifecycleTrigger() *ActionInvocation_LifecycleTrigger {
	if x != nil {
		if x, ok := x.Trigger.(*ActionInvocation_LifecycleTrigger_); ok {
			return x.LifecycleTrigger
		}
	}
	return nil
}

func (x *ActionInvocation) GetCliTrigger() *ActionInvocation_CliTrigger {
	if x != nil {
		if x, ok := x.Trigger.(*ActionInvocation_CliTrigger_); ok {
			return x.CliTrigger
		}
	}
	return nil
...
func (x *ActionInvocation) GetConfig() *DynamicValue {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *ActionInvocation) GetSensitivePaths() []*Path {
	if x != nil {
...
func (x *ActionInvocation) GetCertain() bool {
	if x != nil {
		return x.Certain
	}
	return false
...
type isActionInvocation_Trigger interface {
	isActionInvocation_Trigger()
}

type ActionInvocation_LifecycleTrigger_ struct {
	// The lifecycle trigger that caused this action to be invoked.
	LifecycleTrigger *ActionInvocation_LifecycleTrigger `protobuf:"bytes,2,opt,name=lifecycle_trigger,json=lifecycleTrigger,proto3,oneof"`
}

type ActionInvocation_CliTrigger_ struct {
	CliTrigger *ActionInvocation_CliTrigger `protobuf:"bytes,3,opt,name=cli_trigger,json=cliTrigger,proto3,oneof"`
}

func (*ActionInvocation_LifecycleTrigger_) isActionInvocation_Trigger() {}

func (*ActionInvocation_CliTrigger_) isActionInvocation_Trigger() {}
...
type ActionInvocation_LifecycleTrigger struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The address of the resource instance that triggered this action.
	ResourceInstanceAddr string `protobuf:"bytes,1,opt,name=resource_instance_addr,json=resourceInstanceAddr,proto3" json:"resource_instance_addr,omitempty"`
...
func (x *ActionInvocation_LifecycleTrigger) Reset() {
	*x = ActionInvocation_LifecycleTrigger{}
	mi := &file_planfile_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActionInvocation_LifecycleTrigger) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActionInvocation_LifecycleTrigger) ProtoMessage() {}

func (x *ActionInvocation_LifecycleTrigger) ProtoReflect() protoreflect.Message {
	mi := &file_planfile_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActionInvocation_LifecycleTrigger.ProtoReflect.Descriptor instead.
func (*ActionInvocation_LifecycleTrigger) Descriptor() ([]byte, []int) {
	return file_planfile_proto_rawDescGZIP(), []int{12, 0}
}

func (x *ActionInvocation_LifecycleTrigger) GetResourceInstanceAddr() string {
	if x != nil {
...
func (x *ActionInvocation_LifecycleTrigger) GetEvent() string {
	if x != nil {
		return x.Event
	}
	return ""
...
type ActionInvocation_CliTrigger struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ActionInvocation_CliTrigger) Reset() {
	*x = ActionInvocation_CliTrigger{}
	mi := &file_planfile_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActionInvocation_CliTrigger) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActionInvocation_CliTrigger) ProtoMessage() {}

func (x *ActionInvocation_CliTrigger) ProtoReflect() protoreflect.Message {
	mi := &file_planfile_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActionInvocation_CliTrigger.ProtoReflect.Descriptor instead.
func (*ActionInvocation_CliTrigger) Descriptor() ([]byte, []int) {
	return file_planfile_proto_rawDescGZIP(), []int{12, 1}
}
...
var file_planfile_proto_rawDesc = string([]byte{
	...
	0x12, 0x06, 0x74, 0x66, 0x70, 0x6c, 0x61, 0x6e, 0x22, 0xac, 0x09, 0x0a, 0x04, 0x50, 0x6c, 0x61,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x12, 0x47, 0x0a, 0x12, 0x61,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x73, 0x18, 0x17, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x61, 0x6e,
	0x2e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x52, 0x11, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x1a, 0x52, 0x0a, 0x0e, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65,
	...
	0x41, 0x52, 0x49, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x04, 0x22, 0x3c, 0x0a, 0x10, 0x46, 0x75, 0x6e,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x61, 0x6c, 0x6c, 0x48, 0x61, 0x73, 0x68, 0x12, 0x10, 0x0a,
	...
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x28, 0x0a, 0x0c, 0x44, 0x79, 0x6e, 0x61, 0x6d,
	...
	,
	...
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x1a, 0x0c, 0x0a, 0x0a, 0x43, 0x6c, 0x69, 0x54, 0x72, 0x69, 0x67,
	0x67, 0x65, 0x72, 0x42, 0x09, 0x0a, 0x07, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x2a, 0x31,
	...
	0x02, 0x2a, 0x94, 0x01, 0x0a, 0x06, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x08, 0x0a, 0x04,
	...
	,
	...
	0x6e, 0x73, 0x2f, 0x70, 0x6c, 0x61, 0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
})
...
var file_planfile_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_planfile_proto_goTypes = []any{
	...
	(*ActionInvocation)(nil),                  // 18: tfplan.ActionInvocation
	nil,                                       // 19: tfplan.Plan.VariablesEntry
	(*PlanResourceAttr)(nil),                  // 20: tfplan.Plan.resource_attr
	(*CheckResults_ObjectResult)(nil),         // 21: tfplan.CheckResults.ObjectResult
	(*Path_Step)(nil),                         // 22: tfplan.Path.Step
	(*ActionInvocation_LifecycleTrigger)(nil), // 23: tfplan.ActionInvocation.LifecycleTrigger
	(*ActionInvocation_CliTrigger)(nil),       // 24: tfplan.ActionInvocation.CliTrigger
}
var file_planfile_proto_depIdxs = []int32{
	0,  // 0: tfplan.Plan.ui_mode:type_name -> tfplan.Mode
	19, // 1: tfplan.Plan.variables:type_name -> tfplan.Plan.VariablesEntry
	...
	20, // 8: tfplan.Plan.relevant_attributes:type_name -> tfplan.Plan.resource_attr
	13, // 9: tfplan.Plan.function_results:type_name -> tfplan.FunctionCallHash
	18, // 10: tfplan.Plan.action_invocations:type_name -> tfplan.ActionInvocation
	14, // 11: tfplan.Backend.config:type_name -> tfplan.DynamicValue
	1,  // 12: tfplan.Change.action:type_name -> tfplan.Action
	14, // 13: tfplan.Change.values:type_name -> tfplan.DynamicValue
	15, // 14: tfplan.Change.before_sensitive_paths:type_name -> tfplan.Path
	15, // 15: tfplan.Change.after_sensitive_paths:type_name -> tfplan.Path
	16, // 16: tfplan.Change.importing:type_name -> tfplan.Importing
	14, // 17: tfplan.Change.before_identity:type_name -> tfplan.DynamicValue
	14, // 18: tfplan.Change.after_identity:type_name -> tfplan.DynamicValue
	8,  // 19: tfplan.ResourceInstanceChange.change:type_name -> tfplan.Change
	15, // 20: tfplan.ResourceInstanceChange.required_replace:type_name -> tfplan.Path
	2,  // 21: tfplan.ResourceInstanceChange.action_reason:type_name -> tfplan.ResourceInstanceActionReason
	17, // 22: tfplan.DeferredResourceInstanceChange.deferred:type_name -> tfplan.Deferred
	9,  // 23: tfplan.DeferredResourceInstanceChange.change:type_name -> tfplan.ResourceInstanceChange
	8,  // 24: tfplan.OutputChange.change:type_name -> tfplan.Change
	5,  // 25: tfplan.CheckResults.kind:type_name -> tfplan.CheckResults.ObjectKind
	4,  // 26: tfplan.CheckResults.status:type_name -> tfplan.CheckResults.Status
	21, // 27: tfplan.CheckResults.objects:type_name -> tfplan.CheckResults.ObjectResult
	22, // 28: tfplan.Path.steps:type_name -> tfplan.Path.Step
	14, // 29: tfplan.Importing.identity:type_name -> tfplan.DynamicValue
	3,  // 30: tfplan.Deferred.reason:type_name -> tfplan.DeferredReason
	23, // 31: tfplan.ActionInvocation.lifecycle_trigger:type_name -> tfplan.ActionInvocation.LifecycleTrigger
	24, // 32: tfplan.ActionInvocation.cli_trigger:type_name -> tfplan.ActionInvocation.CliTrigger
	14, // 33: tfplan.ActionInvocation.config:type_name -> tfplan.DynamicValue
	15, // 34: tfplan.ActionInvocation.sensitive_paths:type_name -> tfplan.Path
	14, // 35: tfplan.Plan.VariablesEntry.value:type_name -> tfplan.DynamicValue
	15, // 36: tfplan.Plan.resource_attr.attr:type_name -> tfplan.Path
	4,  // 37: tfplan.CheckResults.ObjectResult.status:type_name -> tfplan.CheckResults.Status
	14, // 38: tfplan.Path.Step.element_key:type_name -> tfplan.DynamicValue
...
func file_planfile_proto_init() {
	...
	file_planfile_proto_msgTypes[12].OneofWrappers = []any{
		(*ActionInvocation_LifecycleTrigger_)(nil),
		(*ActionInvocation_CliTrigger_)(nil),
	}
	file_planfile_proto_msgTypes[16].OneofWrappers = []any{
