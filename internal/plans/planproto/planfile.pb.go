...
type CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType int32

const (
	CustomActionSequence_Declaration_ResourceInstanceLifecycle_INVALID         CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType = 0
	CustomActionSequence_Declaration_ResourceInstanceLifecycle_WHEN_CREATING   CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType = 1
	CustomActionSequence_Declaration_ResourceInstanceLifecycle_WHEN_UPDATING   CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType = 2
	CustomActionSequence_Declaration_ResourceInstanceLifecycle_WHEN_DESTROYING CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType = 3
)

// Enum value maps for CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType.
var (
	CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType_name = map[int32]string{
		0: "INVALID",
		1: "WHEN_CREATING",
		2: "WHEN_UPDATING",
		3: "WHEN_DESTROYING",
	}
	CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType_value = map[string]int32{
		"INVALID":         0,
		"WHEN_CREATING":   1,
		"WHEN_UPDATING":   2,
		"WHEN_DESTROYING": 3,
...
func (x CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType) Enum() *CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType {
	p := new(CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType)
	*p = x
	return p
}

func (x CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType) Descriptor() protoreflect.EnumDescriptor {
	return file_planfile_proto_enumTypes[4].Descriptor()
}

func (CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType) Type() protoreflect.EnumType {
	return &file_planfile_proto_enumTypes[4]
}

func (x CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType.Descriptor instead.
func (CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType) EnumDescriptor() ([]byte, []int) {
	return file_planfile_proto_rawDescGZIP(), []int{6, 0, 0, 0}
}
...
type Plan struct {
	...
	CustomActionSeqs []*CustomActionSequence `protobuf:"bytes,29,rep,name=custom_action_seqs,json=customActionSeqs,proto3" json:"custom_action_seqs,omitempty"`
...
func (x *Plan) GetCustomActionSeqs() []*CustomActionSequence {
	if x != nil {
		return x.CustomActionSeqs
	}
	return nil
}
...
type ResourceInstanceChange struct {
	...
	CustomActionCount int64 `protobuf:"varint,15,opt,name=custom_action_count,json=customActionCount,proto3" json:"custom_action_count,omitempty"`
...
func (x *ResourceInstanceChange) GetCustomActionCount() int64 {
	if x != nil {
		return x.CustomActionCount
	}
	return 0
}
...
type CustomActionSequence struct {
	...
	Declaration *CustomActionSequence_Declaration `protobuf:"bytes,1,opt,name=declaration,proto3" json:"declaration,omitempty"`
	// The sequence of steps determined by evaluating the sequence of "step"
	// blocks in the configuration.
	Steps []*CustomActionStep `protobuf:"bytes,2,rep,name=steps,proto3" json:"steps,omitempty"`
}

func (x *CustomActionSequence) Reset() {
	*x = CustomActionSequence{}
	if protoimpl.UnsafeEnabled {
...
func (x *CustomActionSequence) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CustomActionSequence) ProtoMessage() {}

func (x *CustomActionSequence) ProtoReflect() protoreflect.Message {
	mi := &file_planfile_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CustomActionSequence.ProtoReflect.Descriptor instead.
func (*CustomActionSequence) Descriptor() ([]byte, []int) {
	return file_planfile_proto_rawDescGZIP(), []int{6}
}

func (x *CustomActionSequence) GetDeclaration() *CustomActionSequence_Declaration {
	if x != nil {
...
func (x *CustomActionSequence) GetSteps() []*CustomActionStep {
	if x != nil {
		return x.Steps
	}
	return nil
...
type CustomActionStep struct {
	...
	//
	//	*CustomActionStep_Invoke
	//	*CustomActionStep_CallSubsequence_
	Op isCustomActionStep_Op `protobuf_oneof:"op"`
}

func (x *CustomActionStep) Reset() {
	*x = CustomActionStep{}
	if protoimpl.UnsafeEnabled {
...
func (x *CustomActionStep) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CustomActionStep) ProtoMessage() {}

func (x *CustomActionStep) ProtoReflect() protoreflect.Message {
	mi := &file_planfile_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CustomActionStep.ProtoReflect.Descriptor instead.
func (*CustomActionStep) Descriptor() ([]byte, []int) {
	return file_planfile_proto_rawDescGZIP(), []int{7}
}

func (m *CustomActionStep) GetOp() isCustomActionStep_Op {
	if m != nil {
		return m.Op
	}
	return nil
...
func (x *CustomActionStep) GetInvoke() *CustomActionStep_InvokeCustomAction {
	if x, ok := x.GetOp().(*CustomActionStep_Invoke); ok {
		return x.Invoke
	}
	return nil
}

func (x *CustomActionStep) GetCallSubsequence() *CustomActionStep_CallSubsequence {
	if x, ok := x.GetOp().(*CustomActionStep_CallSubsequence_); ok {
		return x.CallSubsequence
	}
	return nil
}

type isCustomActionStep_Op interface {
	isCustomActionStep_Op()
}

type CustomActionStep_Invoke struct {
	Invoke *CustomActionStep_InvokeCustomAction `protobuf:"bytes,1,opt,name=invoke,proto3,oneof"`
}

type CustomActionStep_CallSubsequence_ struct {
	CallSubsequence *CustomActionStep_CallSubsequence `protobuf:"bytes,2,opt,name=call_subsequence,json=callSubsequence,proto3,oneof"`
}

func (*CustomActionStep_Invoke) isCustomActionStep_Op() {}

func (*CustomActionStep_CallSubsequence_) isCustomActionStep_Op() {}
...
type CustomActionSequence_Declaration struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*CustomActionSequence_Declaration_ResourceInstanceLifecycle_
	//	*CustomActionSequence_Declaration_ModuleCustomAction_
	Block isCustomActionSequence_Declaration_Block `protobuf_oneof:"block"`
}

func (x *CustomActionSequence_Declaration) Reset() {
	*x = CustomActionSequence_Declaration{}
	if protoimpl.UnsafeEnabled {
...
func (x *CustomActionSequence_Declaration) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CustomActionSequence_Declaration) ProtoMessage() {}

func (x *CustomActionSequence_Declaration) ProtoReflect() protoreflect.Message {
	mi := &file_planfile_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CustomActionSequence_Declaration.ProtoReflect.Descriptor instead.
func (*CustomActionSequence_Declaration) Descriptor() ([]byte, []int) {
	return file_planfile_proto_rawDescGZIP(), []int{6, 0}
}

func (m *CustomActionSequence_Declaration) GetBlock() isCustomActionSequence_Declaration_Block {
	if m != nil {
		return m.Block
	}
	return nil
...
func (x *CustomActionSequence_Declaration) GetResourceInstanceLifecycle() *CustomActionSequence_Declaration_ResourceInstanceLifecycle {
	if x, ok := x.GetBlock().(*CustomActionSequence_Declaration_ResourceInstanceLifecycle_); ok {
		return x.ResourceInstanceLifecycle
	}
	return nil
}

func (x *CustomActionSequence_Declaration) GetModuleCustomAction() *CustomActionSequence_Declaration_ModuleCustomAction {
	if x, ok := x.GetBlock().(*CustomActionSequence_Declaration_ModuleCustomAction_); ok {
		return x.ModuleCustomAction
	}
	return nil
}

type isCustomActionSequence_Declaration_Block interface {
	isCustomActionSequence_Declaration_Block()
}

type CustomActionSequence_Declaration_ResourceInstanceLifecycle_ struct {
	ResourceInstanceLifecycle *CustomActionSequence_Declaration_ResourceInstanceLifecycle `protobuf:"bytes,1,opt,name=resource_instance_lifecycle,json=resourceInstanceLifecycle,proto3,oneof"`
}

type CustomActionSequence_Declaration_ModuleCustomAction_ struct {
	ModuleCustomAction *CustomActionSequence_Declaration_ModuleCustomAction `protobuf:"bytes,2,opt,name=module_custom_action,json=moduleCustomAction,proto3,oneof"`
}

func (*CustomActionSequence_Declaration_ResourceInstanceLifecycle_) isCustomActionSequence_Declaration_Block() {
}

func (*CustomActionSequence_Declaration_ModuleCustomAction_) isCustomActionSequence_Declaration_Block() {
}

type CustomActionSequence_Declaration_ResourceInstanceLifecycle struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The address of the resource block that contains the sequence.
	ResourceAddr string `protobuf:"bytes,1,opt,name=resource_addr,json=resourceAddr,proto3" json:"resource_addr,omitempty"`
	// The hook type implies which of the nested blocks of "lifecycle"
	// this sequence was derived from.
	BaseAction Action `protobuf:"varint,2,opt,name=base_action,json=baseAction,proto3,enum=tfplan.Action" json:"base_action,omitempty"`
}

func (x *CustomActionSequence_Declaration_ResourceInstanceLifecycle) Reset() {
	*x = CustomActionSequence_Declaration_ResourceInstanceLifecycle{}
	if protoimpl.UnsafeEnabled {
...
func (x *CustomActionSequence_Declaration_ResourceInstanceLifecycle) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CustomActionSequence_Declaration_ResourceInstanceLifecycle) ProtoMessage() {}

func (x *CustomActionSequence_Declaration_ResourceInstanceLifecycle) ProtoReflect() protoreflect.Message {
	mi := &file_planfile_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CustomActionSequence_Declaration_ResourceInstanceLifecycle.ProtoReflect.Descriptor instead.
func (*CustomActionSequence_Declaration_ResourceInstanceLifecycle) Descriptor() ([]byte, []int) {
	return file_planfile_proto_rawDescGZIP(), []int{6, 0, 0}
}

func (x *CustomActionSequence_Declaration_ResourceInstanceLifecycle) GetResourceAddr() string {
	if x != nil {
...
func (x *CustomActionSequence_Declaration_ResourceInstanceLifecycle) GetBaseAction() Action {
	if x != nil {
		return x.BaseAction
	}
	return Action_NOOP
...
type CustomActionSequence_Declaration_ModuleCustomAction struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CustomActionSequence_Declaration_ModuleCustomAction) Reset() {
	*x = CustomActionSequence_Declaration_ModuleCustomAction{}
	if protoimpl.UnsafeEnabled {
...
func (x *CustomActionSequence_Declaration_ModuleCustomAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CustomActionSequence_Declaration_ModuleCustomAction) ProtoMessage() {}

func (x *CustomActionSequence_Declaration_ModuleCustomAction) ProtoReflect() protoreflect.Message {
	mi := &file_planfile_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CustomActionSequence_Declaration_ModuleCustomAction.ProtoReflect.Descriptor instead.
func (*CustomActionSequence_Declaration_ModuleCustomAction) Descriptor() ([]byte, []int) {
	return file_planfile_proto_rawDescGZIP(), []int{6, 0, 1}
}

func (x *CustomActionSequence_Declaration_ModuleCustomAction) GetModuleAddr() string {
	if x != nil {
		return x.ModuleAddr
	}
	return ""
...
func (x *CustomActionSequence_Declaration_ModuleCustomAction) GetActionName() string {
	if x != nil {
		return x.ActionName
	}
	return ""
...
type CustomActionStep_InvokeCustomAction struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	ActionTypeName string `protobuf:"bytes,3,opt,name=action_type_name,json=actionTypeName,proto3" json:"action_type_name,omitempty"`
	...
	Arguments map[string]*DynamicValue `protobuf:"bytes,4,rep,name=arguments,proto3" json:"arguments,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	PlannedState *DynamicValue `protobuf:"bytes,5,opt,name=planned_state,json=plannedState,proto3" json:"planned_state,omitempty"`
}

func (x *CustomActionStep_InvokeCustomAction) Reset() {
	*x = CustomActionStep_InvokeCustomAction{}
	if protoimpl.UnsafeEnabled {
...
func (x *CustomActionStep_InvokeCustomAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CustomActionStep_InvokeCustomAction) ProtoMessage() {}

func (x *CustomActionStep_InvokeCustomAction) ProtoReflect() protoreflect.Message {
	mi := &file_planfile_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CustomActionStep_InvokeCustomAction.ProtoReflect.Descriptor instead.
func (*CustomActionStep_InvokeCustomAction) Descriptor() ([]byte, []int) {
	return file_planfile_proto_rawDescGZIP(), []int{7, 0}
}

func (x *CustomActionStep_InvokeCustomAction) GetStepName() string {
	if x != nil {
		return x.StepName
	}
	return ""
...
func (x *CustomActionStep_InvokeCustomAction) GetResourceInstanceAddr() string {
	if x != nil {
...
func (x *CustomActionStep_InvokeCustomAction) GetActionTypeName() string {
	if x != nil {
		return x.ActionTypeName
	}
	return ""
}

func (x *CustomActionStep_InvokeCustomAction) GetArguments() map[string]*DynamicValue {
	if x != nil {
		return x.Arguments
	}
	return nil
...
func (x *CustomActionStep_InvokeCustomAction) GetPlannedState() *DynamicValue {
	if x != nil {
...
type CustomActionStep_CallSubsequence struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	StepName    string                `protobuf:"bytes,1,opt,name=step_name,json=stepName,proto3" json:"step_name,omitempty"`
	Subsequence *CustomActionSequence `protobuf:"bytes,2,opt,name=subsequence,proto3" json:"subsequence,omitempty"`
}

func (x *CustomActionStep_CallSubsequence) Reset() {
	*x = CustomActionStep_CallSubsequence{}
	if protoimpl.UnsafeEnabled {
...
func (x *CustomActionStep_CallSubsequence) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CustomActionStep_CallSubsequence) ProtoMessage() {}

func (x *CustomActionStep_CallSubsequence) ProtoReflect() protoreflect.Message {
	mi := &file_planfile_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CustomActionStep_CallSubsequence.ProtoReflect.Descriptor instead.
func (*CustomActionStep_CallSubsequence) Descriptor() ([]byte, []int) {
	return file_planfile_proto_rawDescGZIP(), []int{7, 1}
}

func (x *CustomActionStep_CallSubsequence) GetStepName() string {
	if x != nil {
		return x.StepName
	}
	return ""
...
func (x *CustomActionStep_CallSubsequence) GetSubsequence() *CustomActionSequence {
	if x != nil {
...
func (x *Path_Step) Reset() {
	*x = Path_Step{}
	if protoimpl.UnsafeEnabled {
		mi := &file_planfile_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_planfile_proto_rawDesc = []byte{
	...
	0x12, 0x06, 0x74, 0x66, 0x70, 0x6c, 0x61, 0x6e, 0x22, 0xc8, 0x09, 0x0a, 0x04, 0x50, 0x6c, 0x61,
	...
	,
	...
	0x70, 0x18, 0x15, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61,
	0x6d, 0x70, 0x12, 0x5c, 0x0a, 0x19, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x5f, 0x66,
	0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x18,
	0x16, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x50,
	0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43,
	0x61, 0x6c, 0x6c, 0x48, 0x61, 0x73, 0x68, 0x52, 0x17, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65,
	0x72, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0xc0,
	0x02, 0x0a, 0x06, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x26, 0x0a, 0x06, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x74, 0x66, 0x70, 0x6c,
	0x61, 0x6e, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x12, 0x2c, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	...
	0x42, 0x0a, 0x16, 0x62, 0x65, 0x66, 0x6f, 0x72, 0x65, 0x5f, 0x73, 0x65, 0x6e, 0x73, 0x69, 0x74,
	0x69, 0x76, 0x65, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x0c, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x50, 0x61, 0x74, 0x68, 0x52, 0x14, 0x62,
	0x65, 0x66, 0x6f, 0x72, 0x65, 0x53, 0x65, 0x6e, 0x73, 0x69, 0x74, 0x69, 0x76, 0x65, 0x50, 0x61,
	0x74, 0x68, 0x73, 0x12, 0x40, 0x0a, 0x15, 0x61, 0x66, 0x74, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x6e,
	0x73, 0x69, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x73, 0x18, 0x04, 0x20, 0x03,
	...
	0x50, 0x61, 0x74, 0x68, 0x73, 0x12, 0x2f, 0x0a, 0x09, 0x69, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x69,
	0x6e, 0x67, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x61,
	0x6e, 0x2e, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x09, 0x69, 0x6d, 0x70,
	0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x29, 0x0a, 0x10, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61,
	0x74, 0x65, 0x64, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0f, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x22, 0x83, 0x03, 0x0a, 0x16, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x6e,
	...
	0x65, 0x52, 0x06, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x2e, 0x0a, 0x13, 0x63, 0x75, 0x73,
	0x74, 0x6f, 0x6d, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x18, 0x0f, 0x20, 0x01, 0x28, 0x03, 0x52, 0x11, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x41, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x72, 0x69,
	...
	0x09, 0x73, 0x65, 0x6e, 0x73, 0x69, 0x74, 0x69, 0x76, 0x65, 0x22, 0xc3, 0x05, 0x0a, 0x14, 0x43,
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x71, 0x75, 0x65,
	0x6e, 0x63, 0x65, 0x12, 0x4a, 0x0a, 0x0b, 0x64, 0x65, 0x63, 0x6c, 0x61, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x61,
	0x6e, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65,
	0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x44, 0x65, 0x63, 0x6c, 0x61, 0x72, 0x61, 0x74, 0x69,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x29, 0x0a, 0x10, 0x66, 0x61, 0x69, 0x6c, 0x75, 0x72,
	0x65, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x0f, 0x66, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x73, 0x22, 0x34, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0b, 0x0a, 0x07, 0x55,
	...
	0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x03, 0x22, 0x5c, 0x0a, 0x0a, 0x4f, 0x62, 0x6a, 0x65, 0x63,
	...
	0x43, 0x45, 0x10, 0x01, 0x12, 0x10, 0x0a, 0x0c, 0x4f, 0x55, 0x54, 0x50, 0x55, 0x54, 0x5f, 0x56,
	0x41, 0x4c, 0x55, 0x45, 0x10, 0x02, 0x12, 0x09, 0x0a, 0x05, 0x43, 0x48, 0x45, 0x43, 0x4b, 0x10,
	0x03, 0x12, 0x12, 0x0a, 0x0e, 0x49, 0x4e, 0x50, 0x55, 0x54, 0x5f, 0x56, 0x41, 0x52, 0x49, 0x41,
	0x42, 0x4c, 0x45, 0x10, 0x04, 0x22, 0x44, 0x0a, 0x18, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65,
	0x72, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x61, 0x6c, 0x6c, 0x48, 0x61, 0x73,
	...
	0x01, 0x28, 0x0c, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x28, 0x0a, 0x0c, 0x44,
	...
	0x67, 0x70, 0x61, 0x63, 0x6b, 0x22, 0xa5, 0x01, 0x0a, 0x04, 0x50, 0x61, 0x74, 0x68, 0x12, 0x27,
	0x0a, 0x05, 0x73, 0x74, 0x65, 0x70, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e,
	0x74, 0x66, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x50, 0x61, 0x74, 0x68, 0x2e, 0x53, 0x74, 0x65, 0x70,
	0x52, 0x05, 0x73, 0x74, 0x65, 0x70, 0x73, 0x1a, 0x74, 0x0a, 0x04, 0x53, 0x74, 0x65, 0x70, 0x12,
	...
	0x62, 0x75, 0x74, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x37, 0x0a, 0x0b, 0x65, 0x6c, 0x65, 0x6d,
	0x65, 0x6e, 0x74, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	0x74, 0x66, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x44, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x48, 0x00, 0x52, 0x0a, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x4b, 0x65,
	0x79, 0x42, 0x0a, 0x0a, 0x08, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x35, 0x0a,
	0x09, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x6e, 0x6f, 0x77, 0x6e, 0x22, 0x3a, 0x0a, 0x08, 0x44, 0x65, 0x66, 0x65, 0x72, 0x72, 0x65, 0x64,
	0x12, 0x2e, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x16, 0x2e, 0x74, 0x66, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x44, 0x65, 0x66, 0x65, 0x72, 0x72,
	...
	0x59, 0x10, 0x02, 0x2a, 0x94, 0x01, 0x0a, 0x06, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x08,
	0x0a, 0x04, 0x4e, 0x4f, 0x4f, 0x50, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x43, 0x52, 0x45, 0x41,
	...
	0x4c, 0x45, 0x54, 0x45, 0x10, 0x05, 0x12, 0x16, 0x0a, 0x12, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45,
	0x5f, 0x54, 0x48, 0x45, 0x4e, 0x5f, 0x43, 0x52, 0x45, 0x41, 0x54, 0x45, 0x10, 0x06, 0x12, 0x16,
	0x0a, 0x12, 0x43, 0x52, 0x45, 0x41, 0x54, 0x45, 0x5f, 0x54, 0x48, 0x45, 0x4e, 0x5f, 0x44, 0x45,
	0x4c, 0x45, 0x54, 0x45, 0x10, 0x07, 0x12, 0x0a, 0x0a, 0x06, 0x46, 0x4f, 0x52, 0x47, 0x45, 0x54,
	0x10, 0x08, 0x12, 0x16, 0x0a, 0x12, 0x43, 0x52, 0x45, 0x41, 0x54, 0x45, 0x5f, 0x54, 0x48, 0x45,
	0x4e, 0x5f, 0x46, 0x4f, 0x52, 0x47, 0x45, 0x54, 0x10, 0x09, 0x2a, 0xc8, 0x03, 0x0a, 0x1c, 0x52,
	...
	,
	...
	0x51, 0x10, 0x05, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	...
	0x6c, 0x61, 0x6e, 0x73, 0x2f, 0x70, 0x6c, 0x61, 0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06,
...
var file_planfile_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_planfile_proto_goTypes = []interface{}{
	...
	(CustomActionSequence_Declaration_ResourceInstanceLifecycle_HookType)(0), // 4: tfplan.CustomActionSequence.Declaration.ResourceInstanceLifecycle.HookType
	...
	(*Change)(nil),                           // 9: tfplan.Change
	(*ResourceInstanceChange)(nil),           // 10: tfplan.ResourceInstanceChange
	(*DeferredResourceInstanceChange)(nil),   // 11: tfplan.DeferredResourceInstanceChange
	(*OutputChange)(nil),                     // 12: tfplan.OutputChange
	(*CustomActionSequence)(nil),             // 13: tfplan.CustomActionSequence
	(*CustomActionStep)(nil),                 // 14: tfplan.CustomActionStep
	(*CheckResults)(nil),                     // 15: tfplan.CheckResults
	(*ProviderFunctionCallHash)(nil),         // 16: tfplan.ProviderFunctionCallHash
	...
	nil,                                      // 21: tfplan.Plan.VariablesEntry
	(*PlanResourceAttr)(nil),                 // 22: tfplan.Plan.resource_attr
	(*CustomActionSequence_Declaration)(nil), // 23: tfplan.CustomActionSequence.Declaration
	(*CustomActionSequence_Declaration_ResourceInstanceLifecycle)(nil), // 24: tfplan.CustomActionSequence.Declaration.ResourceInstanceLifecycle
	(*CustomActionSequence_Declaration_ModuleCustomAction)(nil),        // 25: tfplan.CustomActionSequence.Declaration.ModuleCustomAction
	(*CustomActionStep_InvokeCustomAction)(nil),                        // 26: tfplan.CustomActionStep.InvokeCustomAction
	(*CustomActionStep_CallSubsequence)(nil),                           // 27: tfplan.CustomActionStep.CallSubsequence
	nil,                                                                // 28: tfplan.CustomActionStep.InvokeCustomAction.ArgumentsEntry
...
var file_planfile_proto_depIdxs = []int32{
	...
	21, // 1: tfplan.Plan.variables:type_name -> tfplan.Plan.VariablesEntry
	10, // 2: tfplan.Plan.resource_changes:type_name -> tfplan.ResourceInstanceChange
	10, // 3: tfplan.Plan.resource_drift:type_name -> tfplan.ResourceInstanceChange
	11, // 4: tfplan.Plan.deferred_changes:type_name -> tfplan.DeferredResourceInstanceChange
	12, // 5: tfplan.Plan.output_changes:type_name -> tfplan.OutputChange
	13, // 6: tfplan.Plan.custom_action_seqs:type_name -> tfplan.CustomActionSequence
	15, // 7: tfplan.Plan.check_results:type_name -> tfplan.CheckResults
	8,  // 8: tfplan.Plan.backend:type_name -> tfplan.Backend
	22, // 9: tfplan.Plan.relevant_attributes:type_name -> tfplan.Plan.resource_attr
	16, // 10: tfplan.Plan.provider_function_results:type_name -> tfplan.ProviderFunctionCallHash
	17, // 11: tfplan.Backend.config:type_name -> tfplan.DynamicValue
	1,  // 12: tfplan.Change.action:type_name -> tfplan.Action
	17, // 13: tfplan.Change.values:type_name -> tfplan.DynamicValue
	18, // 14: tfplan.Change.before_sensitive_paths:type_name -> tfplan.Path
	18, // 15: tfplan.Change.after_sensitive_paths:type_name -> tfplan.Path
	19, // 16: tfplan.Change.importing:type_name -> tfplan.Importing
	9,  // 17: tfplan.ResourceInstanceChange.change:type_name -> tfplan.Change
	18, // 18: tfplan.ResourceInstanceChange.required_replace:type_name -> tfplan.Path
	2,  // 19: tfplan.ResourceInstanceChange.action_reason:type_name -> tfplan.ResourceInstanceActionReason
	20, // 20: tfplan.DeferredResourceInstanceChange.deferred:type_name -> tfplan.Deferred
	10, // 21: tfplan.DeferredResourceInstanceChange.change:type_name -> tfplan.ResourceInstanceChange
	9,  // 22: tfplan.OutputChange.change:type_name -> tfplan.Change
	23, // 23: tfplan.CustomActionSequence.declaration:type_name -> tfplan.CustomActionSequence.Declaration
	14, // 24: tfplan.CustomActionSequence.steps:type_name -> tfplan.CustomActionStep
	26, // 25: tfplan.CustomActionStep.invoke:type_name -> tfplan.CustomActionStep.InvokeCustomAction
	27, // 26: tfplan.CustomActionStep.call_subsequence:type_name -> tfplan.CustomActionStep.CallSubsequence
	6,  // 27: tfplan.CheckResults.kind:type_name -> tfplan.CheckResults.ObjectKind
	5,  // 28: tfplan.CheckResults.status:type_name -> tfplan.CheckResults.Status
	29, // 29: tfplan.CheckResults.objects:type_name -> tfplan.CheckResults.ObjectResult
	30, // 30: tfplan.Path.steps:type_name -> tfplan.Path.Step
	3,  // 31: tfplan.Deferred.reason:type_name -> tfplan.DeferredReason
	17, // 32: tfplan.Plan.VariablesEntry.value:type_name -> tfplan.DynamicValue
	18, // 33: tfplan.Plan.resource_attr.attr:type_name -> tfplan.Path
	24, // 34: tfplan.CustomActionSequence.Declaration.resource_instance_lifecycle:type_name -> tfplan.CustomActionSequence.Declaration.ResourceInstanceLifecycle
	25, // 35: tfplan.CustomActionSequence.Declaration.module_custom_action:type_name -> tfplan.CustomActionSequence.Declaration.ModuleCustomAction
	1,  // 36: tfplan.CustomActionSequence.Declaration.ResourceInstanceLifecycle.base_action:type_name -> tfplan.Action
	28, // 37: tfplan.CustomActionStep.InvokeCustomAction.arguments:type_name -> tfplan.CustomActionStep.InvokeCustomAction.ArgumentsEntry
	17, // 38: tfplan.CustomActionStep.InvokeCustomAction.planned_state:type_name -> tfplan.DynamicValue
	13, // 39: tfplan.CustomActionStep.CallSubsequence.subsequence:type_name -> tfplan.CustomActionSequence
	17, // 40: tfplan.CustomActionStep.InvokeCustomAction.ArgumentsEntry.value:type_name -> tfplan.DynamicValue
...
func file_planfile_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_planfile_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CustomActionSequence); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_planfile_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_planfile_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CustomActionSequence_Declaration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_planfile_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CustomActionSequence_Declaration_ResourceInstanceLifecycle); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_planfile_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CustomActionSequence_Declaration_ModuleCustomAction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_planfile_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CustomActionStep_InvokeCustomAction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_planfile_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CustomActionStep_CallSubsequence); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_planfile_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		file_planfile_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
	...
	file_planfile_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*CustomActionStep_Invoke)(nil),
		(*CustomActionStep_CallSubsequence_)(nil),
	}
	file_planfile_proto_msgTypes[16].OneofWrappers = []interface{}{
		(*CustomActionSequence_Declaration_ResourceInstanceLifecycle_)(nil),
		(*CustomActionSequence_Declaration_ModuleCustomAction_)(nil),
	}
	file_planfile_proto_msgTypes[23].OneofWrappers = []interface{}{
