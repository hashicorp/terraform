...
var file_planfile_proto_rawDesc = string([]byte{
	...
	0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0x9b, 0x01, 0x0a, 0x18, 0x41, 0x63, 0x74, 0x69, 0x6f,
...
var file_planfile_proto_goTypes = []any{
	...
	(*ActionInvocationInstance)(nil),       // 20: tfplan.ActionInvocationInstance
...
var file_planfile_proto_depIdxs = []int32{
	...
	20, // 7: tfplan.Plan.action_invocations:type_name -> tfplan.ActionInvocationInstance
	...
	21, // 34: tfplan.ActionInvocationInstance.linked_resources:type_name -> tfplan.ResourceInstanceActionChange
