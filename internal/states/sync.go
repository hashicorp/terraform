...
func (s *SyncState) SetListResourceInstance(addr addrs.AbsResource, key addrs.InstanceKey, val *ResourceInstanceObject) {
	defer s.beginWrite()()
	s.state.SetListResourceInstance(addr, key, val)
}
