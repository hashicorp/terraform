...
const (
	Setup_Handshake_FullMethodName = "/stacksproto1.setup.Setup/Handshake"
	Setup_Stop_FullMethodName      = "/stacksproto1.setup.Setup/Stop"
)
...
var Setup_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "stacksproto1.setup.Setup",
