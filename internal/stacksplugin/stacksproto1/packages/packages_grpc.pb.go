...
const (
	Packages_ProviderPackageVersions_FullMethodName = "/stacksproto1.packages.Packages/ProviderPackageVersions"
	Packages_FetchProviderPackage_FullMethodName    = "/stacksproto1.packages.Packages/FetchProviderPackage"
	Packages_ModulePackageVersions_FullMethodName   = "/stacksproto1.packages.Packages/ModulePackageVersions"
	Packages_ModulePackageSourceAddr_FullMethodName = "/stacksproto1.packages.Packages/ModulePackageSourceAddr"
	Packages_FetchModulePackage_FullMethodName      = "/stacksproto1.packages.Packages/FetchModulePackage"
)
...
var Packages_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "stacksproto1.packages.Packages",
	...
	Metadata: "packages/packages.proto",
}
