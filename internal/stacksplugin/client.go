...
func NewStacksPluginClient(ctx context.Context, serviceURL *url.URL) (*StacksPluginClient, error) {
...
func (c StacksPluginClient) FetchManifest(lastModified time.Time) (*Release, error) {
...
func (c StacksPluginClient) DownloadFile(pathOrURL string, writer io.Writer) error {
...
func (c StacksPluginClient) resolveManifestURL(pathOrURL string) (*url.URL, error) {
