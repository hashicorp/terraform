...
func (p *GRPCProvider) InvokeAction(ctx context.Context, r providers.InvokeActionRequest) (resp providers.InvokeActionResponse) {
	...
	protoReq := &proto6.InvokeAction_Request{
		TypeName:      r.TypeName,
		PlannedConfig: &proto6.DynamicValue{Msgpack: configMP},
	}
	...
	startEventChan := make(chan *proto6.InvokeAction_Event_Started)
	...
	go func() {
		...
		for {
			...
			case *proto6.InvokeAction_Event_Started_:
			...
			case *proto6.InvokeAction_Event_Finished_:
...
func (p *GRPCProvider) CancelAction(r providers.CancelActionRequest) (resp providers.CancelActionResponse) {
	...
	protoReq := &proto6.CancelAction_Request{
		TypeName:          r.TypeName,
