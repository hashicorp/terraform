...
func (m *MockProviderClient) ConfigureStorage(arg0 context.Context, arg1 *tfplugin6.ConfigureStorage_Request, arg2 ...grpc.CallOption) (*tfplugin6.ConfigureStorage_Response, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*tfplugin6.ConfigureStorage_Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockProviderClient) LockState(arg0 context.Context, arg1 *tfplugin6.LockState_Request, arg2 ...grpc.CallOption) (*tfplugin6.LockState_Response, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockProviderClient) ReadState(arg0 context.Context, arg1 *tfplugin6.ReadState_Request, arg2 ...grpc.CallOption) (tfplugin6.Provider_ReadStateClient, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(tfplugin6.Provider_ReadStateClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockProviderClient) UnlockState(arg0 context.Context, arg1 *tfplugin6.UnlockState_Request, arg2 ...grpc.CallOption) (*tfplugin6.UnlockState_Response, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockProviderClient) ValidateStorageConfig(arg0 context.Context, arg1 *tfplugin6.ValidateStorage_Request, arg2 ...grpc.CallOption) (*tfplugin6.ValidateStorage_Response, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*tfplugin6.ValidateStorage_Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockProviderClient) WriteState(arg0 context.Context, arg1 ...grpc.CallOption) (tfplugin6.Provider_WriteStateClient, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(tfplugin6.Provider_WriteStateClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
