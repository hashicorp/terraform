...
func TestContext2Apply_basic(t *testing.T) {
	...
	expected := strings.TrimSpace(testmnptuApplyStr)
	if actual != expected {
...
func TestContext2Apply_stop(t *testing.T) {
	...
	ctx := testContext2(t, &ContextOpts{
		Hooks: []Hook{hook},
		Providers: map[addrs.Provider]providers.Factory{
			addrs.MustParseProviderSourceString("mnptu.io/test/indefinite"): testProviderFuncFixed(p),
		},
	})
	...
	if got, want := atomic.LoadUint32(&applyStopped), uint32(1); got != want {
		...
		// to inadvertently stop mnptu before it reaches te apply phase,
...
func TestContext2Apply_resourceDependsOnModule(t *testing.T) {
	...
	checkStateString(t, state, testmnptuApplyResourceDependsOnModuleStr)
}
...
func TestContext2Apply_resourceDependsOnModuleGrandchild(t *testing.T) {
...

	{
		...
		checkStateString(t, state, testmnptuApplyResourceDependsOnModuleDeepStr)
	}
}
...
func TestContext2Apply_resourceDependsOnModuleInModule(t *testing.T) {
...

	{
		...
		checkStateString(t, state, testmnptuApplyResourceDependsOnModuleInModuleStr)
	}
}
...
func TestContext2Apply_refCount(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyRefCountStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_providerAlias(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyProviderAliasStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_providerAliasConfigure(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyProviderAliasConfigStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_emptyModule(t *testing.T) {
	...
	expected := strings.TrimSpace(testmnptuApplyEmptyModuleStr)
	if actual != expected {
		t.Fatalf("bad: \n%s\nexpect:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_createBeforeDestroy(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyCreateBeforeStr)
	if actual != expected {
		t.Fatalf("expected:\n%s\ngot:\n%s", expected, actual)
	}
}
...
func TestContext2Apply_createBeforeDestroyUpdate(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyCreateBeforeUpdateStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_dataBasic(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyDataBasicStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
...
func TestContext2Apply_destroyData(t *testing.T) {
	...
	root.SetResourceInstanceCurrent(
		...
		mustProviderConfig(`provider["registry.mnptu.io/hashicorp/null"]`),
	)
...
// https://github.com/hashicorp/mnptu/pull/5096
...
func TestContext2Apply_minimal(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyMinimalStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_cancel(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyCancelStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
...
func TestContext2Apply_compute(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyComputeStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_countDecrease(t *testing.T) {
	...
	expected := strings.TrimSpace(testmnptuApplyCountDecStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_countDecreaseToOneX(t *testing.T) {
	...
	actual := strings.TrimSpace(s.String())
	expected := strings.TrimSpace(testmnptuApplyCountDecToOneStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
// that might be considered user error, such as using "mnptu state mv"
...
func TestContext2Apply_countDecreaseToOneCorrupted(t *testing.T) {
	...
	assertNoErrors(t, diags)
	{
		...
		want := strings.TrimSpace(testmnptuApplyCountDecToOneCorruptedPlanStr)
		if got != want {
	...
	actual := strings.TrimSpace(s.String())
	expected := strings.TrimSpace(testmnptuApplyCountDecToOneCorruptedStr)
	if actual != expected {
...
func TestContext2Apply_countVariable(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyCountVariableStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_countVariableRef(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyCountVariableRefStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_provisionerInterpCount(t *testing.T) {
	...
	// walk. https://github.com/hashicorp/mnptu/issues/16840
	...
	// mnptu plan -out=tfplan && mnptu apply tfplan
...
func TestContext2Apply_foreachVariable(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyForEachVariableStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_moduleBasic(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyModuleStr)
	if actual != expected {
...
func TestContext2Apply_moduleDestroyOrder(t *testing.T) {
	...
	{
		actual := strings.TrimSpace(state.String())
		expected := strings.TrimSpace(testmnptuApplyModuleDestroyOrderStr)
		if actual != expected {
...
module.child:
  aws_instance.foo:
    ID = foo
    provider = provider["registry.mnptu.io/hashicorp/aws"].eu
    type = aws_instance
	`)
}
...
func TestContext2Apply_moduleOnlyProvider(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyModuleOnlyProviderStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_moduleProviderAlias(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyModuleProviderAliasStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_moduleVarRefExisting(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyModuleVarRefExistingStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_moduleBool(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyModuleBoolStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_multiProvider(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyMultiProviderStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
// across several different mnptu subsystems. This is here because
// historically there were quirky differences in handling across different
// parts of mnptu and so here we want to assert the expected behavior and
...
// exist yet.
// https://github.com/hashicorp/mnptu/issues/14438
func TestContext2Apply_multiVarMissingState(t *testing.T) {
	...
	// Before the relevant bug was fixed, mnptu would panic during apply.
	if _, diags := ctx.Apply(plan, m); diags.HasErrors() {
...
func TestContext2Apply_outputOrphan(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyOutputOrphanStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_outputOrphanModule(t *testing.T) {
	...
	actual := strings.TrimSpace(s.String())
	expected := strings.TrimSpace(testmnptuApplyOutputOrphanModuleStr)
	if actual != expected {
		t.Fatalf("expected:\n%s\n\ngot:\n%s", expected, actual)
	}
...
func TestContext2Apply_provisionerModule(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyProvisionerModuleStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
...
func TestContext2Apply_Provisioner_compute(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyProvisionerStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
...
func TestContext2Apply_provisionerCreateFail(t *testing.T) {
	...
	got := strings.TrimSpace(state.String())
	want := strings.TrimSpace(testmnptuApplyProvisionerFailCreateStr)
	if got != want {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", got, want)
	}
}
...
func TestContext2Apply_provisionerCreateFailNoId(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyProvisionerFailCreateNoIdStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_provisionerFail(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyProvisionerFailStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_provisionerFail_createBeforeDestroy(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyProvisionerFailCreateBeforeDestroyStr)
	if actual != expected {
		t.Fatalf("expected:\n%s\n:got\n%s", expected, actual)
	}
}
...
func TestContext2Apply_error_createBeforeDestroy(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyErrorCreateBeforeDestroyStr)
	if actual != expected {
		t.Fatalf("wrong final state\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_errorDestroy_createBeforeDestroy(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyErrorDestroyCreateBeforeDestroyStr)
	if actual != expected {
		t.Fatalf("bad: actual:\n%s\n\nexpected:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_provisionerResourceRef(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyProvisionerResourceRefStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
...
func TestContext2Apply_provisionerSelfRef(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyProvisionerSelfRefStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
...
func TestContext2Apply_provisionerMultiSelfRef(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyProvisionerMultiSelfRefStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
...
func TestContext2Apply_provisionerMultiSelfRefSingle(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyProvisionerMultiSelfRefSingleStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
...
func TestContext2Apply_Provisioner_Diff(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyProvisionerDiffStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
...
func TestContext2Apply_destroyX(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyDestroyStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
...
// https://github.com/hashicorp/mnptu/issues/2767
...
// https://github.com/hashicorp/mnptu/issues/5440
...
func TestContext2Apply_error(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyErrorStr)
	if actual != expected {
		t.Fatalf("expected:\n%s\n\ngot:\n%s", expected, actual)
	}
}
...
func TestContext2Apply_errorDestroy(t *testing.T) {
	...
	p.PlanResourceChangeFn = func(req providers.PlanResourceChangeRequest) providers.PlanResourceChangeResponse {
		// Should actually be called for this test, because mnptu Core
...
func TestContext2Apply_errorCreateInvalidNew(t *testing.T) {
	...
	p.ApplyResourceChangeFn = func(req providers.ApplyResourceChangeRequest) providers.ApplyResourceChangeResponse {
		...
		// because we want to test that mnptu ignores the inconsistency
	...
	if got, want := len(diags), 1; got != want {
		// There should be no additional diagnostics generated by mnptu's own eval logic,
...
func TestContext2Apply_errorUpdateNullNew(t *testing.T) {
	...
	p.ApplyResourceChangeFn = func(req providers.ApplyResourceChangeRequest) providers.ApplyResourceChangeResponse {
		...
		// test that mnptu retains the prior state, rather than treating
...
func TestContext2Apply_errorPartial(t *testing.T) {
	...
	actual := strings.TrimSpace(s.String())
	expected := strings.TrimSpace(testmnptuApplyErrorPartialStr)
	if actual != expected {
		t.Fatalf("expected:\n%s\n\ngot:\n%s", expected, actual)
	}
}
...
func TestContext2Apply_outputBasic(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyOutputStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_outputAdd(t *testing.T) {
	...
	actual := strings.TrimSpace(state2.String())
	expected := strings.TrimSpace(testmnptuApplyOutputAddStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_outputList(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyOutputListStr)
	if actual != expected {
		t.Fatalf("expected: \n%s\n\nbad: \n%s", expected, actual)
	}
}
...
func TestContext2Apply_outputMulti(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyOutputMultiStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_outputMultiIndex(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyOutputMultiIndexStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_taintX(t *testing.T) {
	...
	// https://github.com/hashicorp/mnptu/issues/1056
	...
	actual := strings.TrimSpace(s.String())
	expected := strings.TrimSpace(testmnptuApplyTaintStr)
	if actual != expected {
		t.Fatalf("bad:\n%s", actual)
	}
...
func TestContext2Apply_taintDep(t *testing.T) {
	...
	actual := strings.TrimSpace(s.String())
	expected := strings.TrimSpace(testmnptuApplyTaintDepStr)
	if actual != expected {
		t.Fatalf("bad:\n%s", actual)
	}
}
...
func TestContext2Apply_taintDepRequiresNew(t *testing.T) {
	...
	actual := strings.TrimSpace(s.String())
	expected := strings.TrimSpace(testmnptuApplyTaintDepRequireNewStr)
	if actual != expected {
		t.Fatalf("bad:\n%s", actual)
	}
}
...
func TestContext2Apply_targetedDestroy(t *testing.T) {
	...
	// test did not match actual mnptu behavior: the output remains in
	// state.
	//
...
// https://github.com/hashicorp/mnptu/issues/4462
...
func TestContext2Apply_unknownAttribute(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyUnknownAttrStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_vars(t *testing.T) {
	...
	variables := InputValues{
		...
		"bar": &InputValue{
			...
			// has a declared default, which mnptu Core will use instead.
			Value:      cty.NilVal,
			SourceType: ValueFromCaller,
		},
	...
	got := strings.TrimSpace(state.String())
	want := strings.TrimSpace(testmnptuApplyVarsStr)
	if got != want {
...
func TestContext2Apply_varsEnv(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyVarsEnvStr)
	if actual != expected {
		t.Errorf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
}
...
func TestContext2Apply_createBefore_depends(t *testing.T) {
	...
	got := strings.TrimSpace(state.String())
	want := strings.TrimSpace(testmnptuApplyDependsCreateBeforeStr)
	if got != want {
		t.Fatalf("wrong final state\ngot:\n%s\n\nwant:\n%s", got, want)
	}
...
template_file.child:
  ID = foo
  provider = provider["registry.mnptu.io/hashicorp/template"]
...
// https://github.com/hashicorp/mnptu/issues/7378
...
func TestContext2Apply_mnptuWorkspace(t *testing.T) {
	m := testModule(t, "apply-mnptu-workspace")
	p := testProvider("aws")
	p.PlanResourceChangeFn = testDiffFn
...
func TestContext2Apply_destroyWithProviders(t *testing.T) {
	...
	removed.SetResourceInstanceCurrent(
		...
		mustProviderConfig(`provider["registry.mnptu.io/hashicorp/aws"].baz`),
	)
	...
	// correct the state
	state.Modules["module.mod.module.removed"].Resources["aws_instance.child"].ProviderConfig = mustProviderConfig(`provider["registry.mnptu.io/hashicorp/aws"].bar`)
...
func TestContext2Apply_providersFromState(t *testing.T) {
	...
	aliasRoot.SetResourceInstanceCurrent(
		...
		mustProviderConfig(`provider["registry.mnptu.io/hashicorp/aws"].bar`),
	)
	...
	moduleProviderRoot.SetResourceInstanceCurrent(
		...
		mustProviderConfig(`module.child.provider["registry.mnptu.io/hashicorp/aws"]`),
	)
...
func TestContext2Apply_scaleInMultivarRef(t *testing.T) {
	...
	assertNoErrors(t, diags)
	{
		...
		// This test was originally written with mnptu v0.11 and earlier
...
func TestContext2Apply_ProviderMeta_plan_setNoSchema(t *testing.T) {
	...
	for _, diag := range diags {
		if diag.Description().Summary != "Provider registry.mnptu.io/hashicorp/test doesn't support provider_meta" {
...
func TestContext2Apply_provisionerSensitive(t *testing.T) {
	...
	actual := strings.TrimSpace(state.String())
	expected := strings.TrimSpace(testmnptuApplyProvisionerSensitiveStr)
	if actual != expected {
		t.Fatalf("wrong result\n\ngot:\n%s\n\nwant:\n%s", actual, expected)
	}
