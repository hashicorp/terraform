...
func TestContext2Plan_minimal_refresh(t *testing.T) {
...
`,
	...
	p := minimalRefreshPlanTestProvider(0)
...
func TestContext2Plan_minimal_refresh_destroy(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
resource "test_object" "noop" {
  arg = "same"
...
func TestContext2Plan_minimal_refresh_orphans(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
...
func TestContext2Plan_minimal_refresh_deposed(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
...
func TestContext2Plan_minimal_refresh_for_each(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
...
func TestContext2Plan_minimal_refresh_provider_update_will_refresh(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
resource "test_object" "a" {
  arg = "foo"
...
`,
	...
	state := minimalRefreshPlanTestState(t, `{"id":"a","arg":"foo","computed":"old"}`, 0, false)
	...
	if !p.ReadResourceCalled {
		t.Fatal(`Expected a call to ReadResource but received none. The resource in this test should be refreshed with ` +
			`the -minimal-refresh flag as the provider produced a change.`)
	}
...
func TestContext2Plan_minimal_refresh_schema_upgrade_will_refresh(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
resource "test_object" "a" {
  arg = "foo"
...
func TestContext2Plan_minimal_refresh_ignore_changes_noop(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
resource "test_object" "a" {
  arg = "new"
...
`,
	...
	p := minimalRefreshPlanTestProvider(0)
	state := minimalRefreshPlanTestState(t, `{"id":"a","arg":"old","computed":"boop"}`, 0, false)
	...
	if p.ReadResourceCalled {
		t.Fatal(`Unexpected call to ReadResource. The resource in this test should not be refreshed with ` +
			`the -minimal-refresh flag as ignore_changes should make the plan a no-op.`)
	}
...
func TestContext2Plan_minimal_refresh_lifecycle_conditions_noop(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": minimalRefreshPlanConditionsConfig("foo"),
	})
...
func TestContext2Plan_minimal_refresh_lifecycle_conditions_update(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": minimalRefreshPlanConditionsConfig("new"),
	})
...
func TestContext2Plan_minimal_refresh_precondition_error(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": minimalRefreshPlanConditionsConfig("foo"),
	})
...
func TestContext2Plan_minimal_refresh_postcondition_error(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
resource "test_object" "a" {
  arg = "foo"
...
func TestContext2Plan_minimal_refresh_create_before_destroy_no_refresh(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
resource "test_object" "a" {
  arg = "foo"
...
func TestContext2Plan_minimal_refresh_force_replace(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
resource "test_object" "a" {
  arg = "foo"
...
func TestContext2Plan_minimal_refresh_replace_triggered_by(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
resource "test_object" "a" {
  arg = "new"
...
func TestContext2Plan_minimal_refresh_tainted(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
resource "test_object" "a" {
  arg = "foo"
...
`,
	...
	if !p.ReadResourceCalled {
		t.Fatal(`Expected a call to ReadResource but received none. The resource in this test should be refreshed with ` +
			`the -minimal-refresh flag as the resource was tainted.`)
	}
...
func TestContext2Plan_minimal_refresh_no_duplicate_warnings(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
resource "test_object" "a" {
  arg = "new"
...
func TestContext2Plan_minimal_refresh_initial_plan_error(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
resource "test_object" "a" {
  arg = "new"
...
`,
	...
	if p.ReadResourceCalled {
		t.Fatal(`Unexpected call to ReadResource. The resource in this test should not be refreshed with ` +
			`the -minimal-refresh flag as the initial plan should error.`)
	}
}

func TestContext2Plan_minimal_refresh_validation_errors(t *testing.T) {
	m := testModuleInline(t, map[string]string{
		"main.tf": `
resource "test_object" "a" {
  arg = "foo"
...
`,
	...
	testCases := map[string]struct {
		...
		"refresh-only mode": {
			opts:    &PlanOpts{Mode: plans.RefreshOnlyMode, MinimalRefresh: true},
			wantErr: "The -minimal-refresh planning option is only allowed in normal or destroy planning modes, got RefreshOnlyMode. This is a bug in Terraform.",
		},
		"skip refresh": {
			opts:    &PlanOpts{Mode: plans.NormalMode, MinimalRefresh: true, SkipRefresh: true},
			wantErr: "The -minimal-refresh planning option cannot be combined with skipping refresh, because it only affects whether Terraform refreshes. This is a bug in Terraform.",
		},
	}
...
func minimalRefreshPlanConditionsConfig(arg string) string {
	return fmt.Sprintf(`
variable "precond" {
  type    = bool
  default = true
...
func minimalRefreshPlanTestProvider(version uint64) *testing_provider.MockProvider {
...
func minimalRefreshPlanTestState(t *testing.T, attrsJSON string, schemaVersion uint64, createBeforeDestroy bool) *states.State {
	t.Helper()
