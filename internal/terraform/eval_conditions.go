...
func evalCheckRules(typ addrs.CheckRuleType, rules []*definitions.CheckRule, ctx EvalContext, self addrs.Checkable, keyData instances.RepetitionData, diagSeverity tfdiags.Severity) tfdiags.Diagnostics {
...
func validateCheckRule(addr addrs.CheckRule, rule *definitions.CheckRule, ctx EvalContext, keyData instances.RepetitionData) (string, *hcl.EvalContext, tfdiags.Diagnostics) {
	var diags tfdiags.Diagnostics
...
func evalCheckRule(addr addrs.CheckRule, rule *definitions.CheckRule, ctx EvalContext, keyData instances.RepetitionData, severity hcl.DiagnosticSeverity) (checkResult, tfdiags.Diagnostics) {
