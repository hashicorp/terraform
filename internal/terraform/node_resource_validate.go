...
func (n *NodeValidatableResource) validateResource(ctx EvalContext) tfdiags.Diagnostics {
	...
	case addrs.ManagedResourceMode:
		...
		diags = diags.Append(n.validateConfigUsingDeprecatedValues(configVal).InConfigBody(n.Config.Config, n.Addr.String()))
	...
	case addrs.DataResourceMode:
		...
		diags = diags.Append(n.validateConfigUsingDeprecatedValues(configVal))
	...
	case addrs.ListResourceMode:
		...
		diags = diags.Append(n.validateConfigUsingDeprecatedValues(blockVal))
		...
		diags = diags.Append(n.validateConfigUsingDeprecatedValues(limit))
		...
		diags = diags.Append(n.validateConfigUsingDeprecatedValues(includeResource))
...
func (n *NodeValidatableResource) validateConfigUsingDeprecatedValues(config cty.Value) (diags tfdiags.Diagnostics) {
