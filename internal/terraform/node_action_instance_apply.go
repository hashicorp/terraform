...
type nodeActionApplyInstance struct {
	*NodeAbstractAction
...
var (
	_ GraphNodeReferencer       = (*nodeActionApplyInstance)(nil)
	_ GraphNodeProviderConsumer = (*nodeActionApplyInstance)(nil)
	_ GraphNodeModulePath       = (*nodeActionApplyInstance)(nil)
)

func (n *nodeActionApplyInstance) Name() string {
	return n.ActionInvocation.Addr.String() + " (instance)"
}

// the managed resource will call this apply
func (n *nodeActionApplyInstance) apply(ctx EvalContext) (diags tfdiags.Diagnostics) {
	return
}
...
func (n *nodeActionApplyInstance) ProvidedBy() (addr addrs.ProviderConfig, exact bool) {
	return n.ActionInvocation.ProviderAddr, true

}

func (n *nodeActionApplyInstance) Provider() (provider addrs.Provider) {
	return n.ActionInvocation.ProviderAddr.Provider
}

func (n *nodeActionApplyInstance) SetProvider(config addrs.AbsProviderConfig) {
	n.resolvedProvider = config
}

func (n *nodeActionApplyInstance) References() []*addrs.Reference {
...
// GraphNodeReferencer
func (n *nodeActionApplyInstance) ModulePath() addrs.Module {
	return n.ActionInvocation.Addr.Module.Module()
}

// GraphNodeExecutable
func (n *nodeActionApplyInstance) Path() addrs.ModuleInstance {
	return n.ActionInvocation.Addr.Module
}

func (n *nodeActionApplyInstance) AddSubjectToDiagnostics(input tfdiags.Diagnostics) tfdiags.Diagnostics {
	var diags tfdiags.Diagnostics
	if len(input) > 0 {
