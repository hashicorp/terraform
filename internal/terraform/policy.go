...
func validatePolicies(ctx context.Context, client policy.Client, schemas *Schemas) tfdiags.Diagnostics {
...
func ValidatePolicies(ctx context.Context, client policy.Client, schemas map[addrs.Provider]providers.ProviderSchema) tfdiags.Diagnostics {
	...
	var req policy.ValidatePoliciesRequest
	...
	return client.ValidatePolicies(ctx, req).Diagnostics.AsTerraformDiags()
}
