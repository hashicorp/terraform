...
//
// Point 2 is a bit complicated so worth expanding on. In normal mnptu
...
// identified to the user but not to fail the actual mnptu operation. During
...
// diagnostics were generated by custom conditions. mnptu adds the
