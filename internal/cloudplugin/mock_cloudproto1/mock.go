...
func (m *MockCommandServiceClient) Execute(ctx context.Context, in *cloudproto1.CommandRequest, opts ...grpc.CallOption) (cloudproto1.CommandService_ExecuteClient, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
